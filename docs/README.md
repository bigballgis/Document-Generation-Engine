...
| **[Vitest 3.2.6+ security remediation](./behavior/fe-vitest-3-upgrade.md)** | **not-applicable** (2026-07-17) · Task Master **#50** · slice `fe-vitest-3-upgrade` | Dev/tooling only — `vitest` + `@vitest/coverage-v8` **2.1.9 → ≥3.2.6** closes [GHSA-5xrq-8626-4rwp](https://github.com/advisories/GHSA-5xrq-8626-4rwp); acceptance = frontend gates green + advisory remediated + exception closed; **no** product UI journey; formal phase **None**; **not** go-live; do **not** activate CD-3 |
