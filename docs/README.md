...
| **[International Bank Letter Readiness (IBL)](./plan/intl-bank-letter-readiness-program.md)** | **Wave IBL-A In Progress** — TM **#106** registry-only pending + **#107** IBL-A1 **Done** (`f0a2b6fe` / `4bda5f2d`) + **#108** IBL-A2 **Done** (`e3000479` / `89584242`) + **#109–#134** pending; A1+A2 Done / A3–A6 Not Started; sole-active cleared; next **#109** not activated; formal phase **None**; do **not** mark Wave A / program Done |
