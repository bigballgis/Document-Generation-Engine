...
**Active work in this documentation track:** **[LR-C13 Done](./plan/detail/LRP-C-usability-deepening.md)** (2026-07-11 — slice `lrp-c13-frontend-eng-debt`; merge `45addd6`; OPT-G4/G5 closed; coverage floors 80/55/80/80). Wave LR-C remains **In Progress** (partial — C1/C4/C9–C13 Done; C2/C3/C5/C7/C8 Not Started). **[CDP Wave CD-2 Done](./plan/competitiveness-deepening-program.md)** (2026-07-11 — CD-E2E-T01–T13 Done, merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b` / `55a6ab6` / `b16e52a` / `6e3f825` / `f12b193` / `b2b0899`; all matrix manifests PASS; task IDs **`CD-*`** only). **CD-0 Done**. **No sole-active LRP/CDP slice.** Formal phase remains **None**. Recommend next: remaining Wave C items (**C2/C3/C5/C7/C8**) or pause (do not auto-activate). Do **not** mark Wave LR-C Done. Do **not** activate C2/C3/C5/C7/C8/CD-3.
