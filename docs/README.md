...
**Active work in this documentation track:** **[LR-E2 In Progress](./plan/launch-readiness-program.md)** (slice `lrp-e2-launch-checklist`; Task Master #43; **sole-active**; BDD not-applicable — docs-only go/no-go checklist; artifact [launch-readiness-checklist.md](./operations/launch-readiness-checklist.md); overall snapshot **NO-GO** — not a production go-live claim). **[Wave LR-E In Progress](./plan/launch-readiness-program.md)** (partial — E1 Done; E2 **In Progress**; **sole-active**). Formal phase remains **None**. Do **not** claim Wave LR-E Done / production go-live. Do **not** activate CD-3. Do **not** touch `DGE-audit-governance`. **Prior:** **[LR-E1 Done](./behavior/lrp-e1-sse-proxy-e2e.md)** (slice `lrp-e1-sse-proxy-e2e`; merge `575d0aa`; Task Master #42; evidence [LRP-E1-sse-manifest.md](../frontend/e2e/evidence/LRP-E1-sse-manifest.md)). **Prior:** **[Wave LR-D Done](./plan/detail/LRP-D-ops-observability.md)** (2026-07-12 — D1–D7 all Done; merge tip `218dcf1`). **[Wave LR-C Done](./plan/detail/LRP-C-usability-deepening.md)** (2026-07-11 — C1–C13; merge tip `bf9cbeb`). **[CDP Wave CD-2 Done](./plan/competitiveness-deepening-program.md)** (2026-07-11 — T01–T13; merge tip `b2b0899`).
...
| **[Launch readiness checklist (LR-E2)](./operations/launch-readiness-checklist.md)** | **LR-E2** — evidence-linked go/no-go / conditional rows + verdict template; snapshot **NO-GO** (2026-07-12); **not** a production go-live claim; companion [launch-readiness-gate.md](./plan/launch-readiness-gate.md) |
