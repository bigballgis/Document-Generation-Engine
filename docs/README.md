...
| **[Dependency security refresh](./behavior/deps-security-refresh.md)** | **not-applicable** (2026-07-13) · Task Master **#49** · slice **In Progress** (`feat/deps-security-refresh`) | Maven + pnpm CVE/hygiene audit + baseline-safe upgrades (Boot **3.3.x**, ShedLock **6.x**, no major Vue/Vite without ADR); Critical/High remediate or exception; gates green — **no** product actor journey; does **not** close M9-T02; formal phase **None**; **not** go-live; do **not** activate CD-3 |
