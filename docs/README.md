...
| **[PRR Wave A — prod-scale bounded queries](./behavior/prod-scale-bounded-queries.md)** | **ready** (2026-07-17) · Task Master **#98+#99+#100** · slice `prod-scale-bounded-queries` · **sole-active** | **BDD-PRR-A01/A02/A03** — retention Pageable 分批删除（500–2000）+ legal-hold 安全；preview/batch-test 历史 TopN 下推 DB；ContentModule SUBMITTED inbox 有界翻页；**`frontend_ui_in_scope=false`**；Library export (#101) / Wave B/C OOS；formal phase **None**; **not** go-live；do **not** flip **#3b** |
