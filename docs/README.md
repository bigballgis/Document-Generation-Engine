...
| **[CE-K01 release-bundle pinning](./behavior/ce-k01-release-bundle-pinning.md)** | **ready** (2026-07-14) · Task Master **#57** · slice **In Progress** (`feat/ce-k01-release-bundle-pinning`; **not merged**) | **BDD-CE-K01-001…022** — publish pins master revision + SHA-256 + pin metadata; runtime reads pinned storage_key; delete protection 409; Flyway **V57** + backfill `PINNED_RETROACTIVELY`; `mvn verify` **GREEN** 1432/0/0/7; formal phase **None**; **not** go-live |
