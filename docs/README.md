...
| 2a | **[CORE-EXCELLENCE (CE)](./plan/core-excellence-program-2026-07.md)** | **Delivery focus** — **P2 CE continuum**; **sole-active #94** CE-U20 **In Progress** (`ce-u20-clause-create-structured`); **#93** CE-U18 **Done** (`05e9f8e1` / `e05407f2`); **§9.2 next #95** CE-U21 **pending**; **#92** CE-U16 **Done** (`5d683c40` / `1a3d0f20`); **#91** CE-U15 **Done** (`b2968052` / `ed8a15e6`); **#90** CE-U14 **Done** (`05e845e4` / `09e0d251`); **#75** CE-G04 **Done** (`42745ea5` / `b47ea896`); **#81** CE-O01 **Done** (`e081bcfa`); **#79** CE-E02 **Done** (`5bd3611e`); **#78** CE-E01 **Done** (`6ae57974`); **#76** CE-G06 **Done** (`d8636232`); **#71** CE-C06 **Done** (`35f6f47d`); **#89** CE-U13 **Done** (`ccdfacda`); **#74** CE-G03 **Done** (`50c1a524`); **#62** CE-K06 **Done** (a/b/c; tip `76297d08`); **#69/#70/#88 Done**; Wave 0 #61/#86/#87 **Done**; umbrella **#53**; not a formal P-phase |
...
| **[CE-U20 clause create structured + list status](./behavior/ce-u20-clause-create-structured.md)** | **ready** (2026-07-17) · Task Master **#94** · slice `ce-u20-clause-create-structured` | **BDD-CE-U20-CCS-001…010** — create dialog abandons JSON textarea for `ControlledStructuredContentEditor` (reuse CE-U01/version dialog); catalog Status column + server `status` filter on head version; formal phase **None**; **not** go-live; **not** CD-3 |
