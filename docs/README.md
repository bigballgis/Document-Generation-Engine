...
**Active work in this documentation track:** **[LR-C11 Done](./plan/detail/LRP-C-usability-deepening.md)** (2026-07-11 — slice `lrp-c11-api-error-i18n`; merge `44fcf40`; `api.error` **159/159** + parity Vitest). Wave LR-C remains **In Progress** (partial — C1/C4/C9/C10/C11 Done). **[CDP Wave CD-2 Done](./plan/competitiveness-deepening-program.md)** (2026-07-11 — CD-E2E-T01–T13 Done, merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b` / `55a6ab6` / `b16e52a` / `6e3f825` / `f12b193` / `b2b0899`; all matrix manifests PASS; task IDs **`CD-*`** only). **CD-0 Done**. **No sole-active LRP/CDP slice.** Formal phase remains **None**. Recommend next: **LR-C12** or pause (do not auto-activate).
