...
| **[CE-U07 clause outdated bump](./behavior/ce-u07-clause-outdated-bump.md)** | **ready** (2026-07-15) · Task Master **#82** · slice `ce-u07-clause-outdated-bump` | **BDD-CE-U07-COB-001…004** — out-of-date badge + one-click bump + dashboard author todo deep link; E2E **3/3** + UIUX **PASS_WITH_NOTES**; formal phase **None**; **not** go-live |
