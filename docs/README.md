...
| **[CE-G02 SPECIMEN watermark](./behavior/ce-g02-specimen-watermark.md)** | **ready** (2026-07-15) — Task Master **#73** — slice `ce-g02-specimen-watermark` | **BDD-CE-G02-DOCX/PDF/RT/GOLD/X/OUT** — preview/test-generate DOCX header+footer + PDF diagonal `SPECIMEN`; runtime formal path zero watermark; golden `06-specimen-watermark` → ACTIVE; formal phase **None**; **not** go-live |
| **[CE-K02 master style authority](./behavior/ce-k02-master-style-authority.md)** | **ready** (2026-07-15) · Task Master **#58** · slice `ce-k02-master-style-authority` | **BDD-CE-K02-001…018** — parse styles.xml → per-revision catalog; styleRef > master style > docDefaults; no Calibri hardcode; `MASTER_STYLE_FALLBACK`; golden `dual-font-master` ACTIVE; formal phase **None**; **not** go-live |
