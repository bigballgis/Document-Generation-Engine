...
**Delivery focus:** **#109** IBL-A3 → **Done** (MAIN merge `779b1979` / feature tip `f09326ca`; worktree removed; international `SPELL_AMOUNT` en/USD). BDD **ready** [ibl-a3-amount-in-words.md](./behavior/ibl-a3-amount-in-words.md) (**BDD-IBL-A3-001…012**). Batch **solo** closed; Wave **IBL-A** stays **In Progress** (A1–A3 **Done**; A4–A6 Not Started); **sole-active cleared**; **next queue (not activated):** IBL-A4 **#110**. Prior **#108** IBL-A2 → **Done** (`e3000479` / `89584242`). Prior **#107** IBL-A1 → **Done** (`f0a2b6fe` / `4bda5f2d`). Prior **#137** PRR-P2 audit hygiene → **Done** (MAIN merge `baaf16cc` / feature tip `09cf85ce`; worktree removed). Slice `prod-audit-p2-hygiene`. listAll removed; `components/template`→`templates`; knip unused exports **31→0**. BDD **not-applicable** [prod-audit-p2-hygiene.md](./behavior/prod-audit-p2-hygiene.md). Prior **#136** PRR-D01c → **Done** (`a872c15b` / `8c52ee67`); Wave D residuals **D01A+#135+#136** closed; prior **#135** PRR-D01b → **Done** (`6e776232` / `1ada6b41`); prior **#104** PRR-D01a (**D01A**) → **Done** (`f1f79d14`); prior **#103** PRR-C01 → **Done** (`3513ab92` / tip `7a1a1bb1`; Path **X**); ADR-0042/0043 **Accepted**; checklist **#3b** → **CONDITIONAL** (≠ GO); prior **#105** → **Done** (`50448016`); **#102** → **Done** (`40e264e7`); **#101** → **Done** (`5b705f56`); **PRR Wave A** **#98+#99+#100** → **Done** (`4197770f`); do **not** flip **#3b GO** / **#5a GO** (#5a stays **CONDITIONAL**); do **not** mark Wave A / IBL program Done. **CORE-EXCELLENCE (CE)** — **#77** CE-G05 → **Done** (merge `c3f6a288` / feature `744b628a`; worktree removed; BDD **ready** [ce-g05-annual-review-fts.md](./behavior/ce-g05-annual-review-fts.md); FE+E2E); **P3 queue empty** (#96/#97/#80/#77 all Done); umbrella **#53** remains **in-progress** (program registry only — **do not** claim program Done); **#80** CE-E03 → **Done** (merge `f1f02554` / feature `86e4ff10`; worktree removed; BDD **ready** [ce-e03-full-library-export.md](./behavior/ce-e03-full-library-export.md); API-first FE/E2E N/A); **#97** CE-U19 → **Done** (merge `e4679421` / feature `90a9e5cd`; worktree removed); **#96** CE-U17 → **Done** (merge `4fc2dbdb` / feature `d3293db1`; worktree removed) — do **not** claim program Done; **P2 CE continuum complete** — **#95** CE-U21 → **Done** (merge `8d8f6f6d` / feature `292fbc35`; worktree removed); **#94** CE-U20 → **Done** (merge `b9327a11` / feature `b4b0b420`; worktree removed); **#93** CE-U18 → **Done** (merge `05e9f8e1` / feature `e05407f2`; worktree removed); **#92** CE-U16 → **Done** (merge `5d683c40` / feature `1a3d0f20`; worktree removed); **#91** CE-U15 → **Done** (merge `b2968052`; closeout `ed8a15e6`; worktree removed); **#90** CE-U14 → **Done** (merge `05e845e4` / feature `09e0d251`); **#75** CE-G04 → **Done** (merge tip `42745ea5` / feature `b47ea896`; worktree removed); **#81** CE-O01 → **Done** (merge `e081bcfa`; slice `ce-o01-pdfa-output`; worktree removed; ADR-0058 Accepted; FE/E2E out of scope); **#79** CE-E02 → **Done** (merge `5bd3611e`) — do **not** reopen; **#78** CE-E01 → **Done** (merge `6ae57974`) — do **not** reopen; **#76** CE-G06 → **Done** (merge `d8636232`) — do **not** reopen; **#71** CE-C06 → **Done** (`35f6f47d`) — do **not** reopen; **#89** CE-U13 → **Done** (`ccdfacda`); **#74** CE-G03 → **Done** (`50c1a524`); **#62** CE-K06 → **Done** (K06a/`485a7f3e` + K06b/`a689ca87` + K06c tip/`76297d08`); **#69 CE-C04** / **#70 CE-C05** / **#88 CE-U06** → **Done** (`c7be8305` / `405f7cea` / `7734366e`); Wave 0 #61/#86/#87 **Done**; umbrella **#53** remains **in-progress** (program registry only); plan [core-excellence-program-2026-07.md](./plan/core-excellence-program-2026-07.md). Prior waves (#60/#84/#85; #59/#68/#83) **Done**. **Batch 4 remains Done**. Batch 1–3 Done. Formal phase remains **None**; **not** go-live. Overall checklist remains **CONDITIONAL** (**#3b** Path X; #5a/#10 residuals — **not GO**). Do **not** activate CD-3. Do **not** invent a formal P-phase. **#50** Vitest 3.2.7 → **Done** (`6c8fff7d`; GHSA-5xrq-8626-4rwp **CLOSED**).

**Active formal program:** **None** (2026-07-09+). **CODE-QUALITY Done** — CQ-01A…CQ-08. **CORE-FORTRESS Done** — F1–F8. **CDP Wave CD-2 Done** (T01–T13; merge tip `b2b0899`; **no CDP wave In Progress**; CD-3 Not Started). **LRP waves A–E → Done**. **IBL** → Wave **IBL-A In Progress** (A1 **#107 Done** `f0a2b6fe` / `4bda5f2d`; A2 **#108 Done** `e3000479` / `89584242`; A3 **#109 Done** `779b1979` / `f09326ca`; A4–A6 Not Started; sole-active cleared; next **#110** not activated; **#106** registry-only pending). See [CORE-EXCELLENCE](./plan/core-excellence-program-2026-07.md) · [CODE-QUALITY](./plan/code-quality-program.md) · [LRP](./plan/launch-readiness-program.md) · [IBL](./plan/intl-bank-letter-readiness-program.md) · [CDP](./plan/competitiveness-deepening-program.md) · [execution-sync-ledger](./plan/execution-sync-ledger.md).
...
| **[International Bank Letter Readiness (IBL)](./plan/intl-bank-letter-readiness-program.md)** | **Wave IBL-A In Progress** — TM **#106** registry-only pending + **#107** IBL-A1 **Done** (`f0a2b6fe` / `4bda5f2d`) + **#108** IBL-A2 **Done** (`e3000479` / `89584242`) + **#109** IBL-A3 **Done** (`779b1979` / `f09326ca`) + **#110–#134** pending; A1–A3 Done / A4–A6 Not Started; sole-active cleared; next **#110** not activated; formal phase **None**; do **not** mark Wave A / program Done |
...
| **[CE-K08 clause legal metadata](./behavior/ce-k08-clause-legal-metadata.md)** | **ready** (2026-07-15) · Task Master **#63** · slice **Done** (`35f57503`) | **BDD-CE-K08-LM-001…015** — version `jurisdiction`/`effectiveFrom`/`effectiveTo`/`legalReviewRef`; catalog filters; publish gate `CONTENT_MODULE_EFFECTIVE_EXPIRED`; formal phase **None**; **not** go-live |
...
| **[CE-E02 asset library management surface](./behavior/ce-e02-asset-library.md)** | **ready** (2026-07-16) · Task Master **#79** **Done** (merge `5bd3611e`) · slice `ce-e02-asset-library` | **BDD-CE-E02-001…022** — MinIO catalog upload/list/disable; `assetKey` ≡ resolvable object key; `SEAL` upload requires approver/admin; `StructuredContentImageResolver` protocol **unchanged**; admin `/library/assets` + E2E/UIUX shipped; formal phase **None**; **not** go-live |
