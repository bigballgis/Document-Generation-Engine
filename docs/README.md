...
| **[CE-U14 Dashboard template lifecycle todos](./behavior/ce-u14-dashboard-lifecycle-todos.md)** | **ready** (2026-07-16) · Task Master **#90** · slice `ce-u14-dashboard-lifecycle-todos` | **BDD-CE-U14-DLT-001…008** — Tasks Tab TEST/APPROVAL/PENDING_RELEASE partitions + queue-aware deep links to testing/approval/publishReadiness; fail-closed capabilities; formal phase **None**; **not** go-live; **not** CE-U15 |
