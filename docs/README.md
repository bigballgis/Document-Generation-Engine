...
| **[International Bank Letter Readiness (IBL)](./plan/intl-bank-letter-readiness-program.md)** | **Registered in Task Master / Not Started** — TM **#106** (umbrella) + **#107–#134** (**28** leaves, pending); waves not activated; formal phase **None**; Wave D residuals **D01A+#135+#136** closed; audit P2 **#137** → **Done** (`baaf16cc` / `09cf85ce`; sole-active cleared); **next queue head (not activated)** = **IBL-A1** (#107); **#103/#105 Done**; merge `9fc2bc97` |
...
| **[IBL-A1 — runtime fail-closed variable validation](./behavior/ibl-a1-variable-validation.md)** | **ready** (2026-07-18) · Task Master **#107** **in-progress** (sole-active) · slice `ibl-a1-variable-validation` | **BDD-IBL-A1-001…008** — generate missing required / wrong type / wrong enum → **422** `VARIABLE_VALIDATION_FAILED` + `fieldErrors`；无静默 blank；preview **aligned**；publish **scoped**（不校验 generate body）；**`frontend_ui_in_scope=false`**；formal phase **None**; **not** go-live；do **not** flip **#3b GO** / **#5a GO** |
