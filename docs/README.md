...
**Active work in this documentation track:** **[LR-C12 Done](./plan/detail/LRP-C-usability-deepening.md)** (2026-07-11 — slice `lrp-c12-keyboard-a11y`; merge `0357a16`; keyboard a11y & table activation; E2E 10/10). Wave LR-C remains **In Progress** (partial — C1/C4/C9/C10/C11/C12 Done; C2/C3/C5/C7/C8/C13 Not Started). **[CDP Wave CD-2 Done](./plan/competitiveness-deepening-program.md)** (2026-07-11 — CD-E2E-T01–T13 Done, merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b` / `55a6ab6` / `b16e52a` / `6e3f825` / `f12b193` / `b2b0899`; all matrix manifests PASS; task IDs **`CD-*`** only). **CD-0 Done**. **No sole-active LRP/CDP slice.** Formal phase remains **None**. Recommend next: **LR-C13** or pause (do not auto-activate). Do **not** activate C13/C2/C3/CD-3.
