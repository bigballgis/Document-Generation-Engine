...
| **[CE-E02 asset library management surface](./behavior/ce-e02-asset-library.md)** | **ready** (2026-07-16) · Task Master **#79** · slice `ce-e02-asset-library` | **BDD-CE-E02-001…022** — MinIO catalog upload/list/disable; `assetKey` ≡ resolvable object key; `SEAL` upload requires approver/admin; `StructuredContentImageResolver` protocol **unchanged**; admin `/library/assets` + E2E/UIUX **in scope**; formal phase **None**; **not** go-live |
