...
| **[International Bank Letter Readiness (IBL)](./plan/intl-bank-letter-readiness-program.md)** | **Registered in Task Master / Not Started** — TM **#106** (umbrella) + **#107–#134** (**28** leaves, pending); waves not activated; formal phase **None**; deferred after remaining PRR **#103→#104** (**#105 Done**; merge `9fc2bc97`) |
...
| **[PRR-C01 — ADR-0042/0043 closeout (#3b)](./behavior/prod-adr-0042-0043-closeout.md)** | **ready** (2026-07-18) · Task Master **#103** **in-progress** (**sole-active**) · slice `prod-adr-0042-0043-closeout` · `feat/prod-adr-0042-0043-closeout` | **BDD-PRR-C01-001…012** — Accept/implement ADR-0042 metadata-gated 分页 delta 强制（`authorWordPageCount`；warning / PublishGate blocker）；Accept ADR-0043 Decision slice A（OOXML well-formedness；slice B residual）；Word↔LO **Path E** 或 durable **Path X** exemption；**禁止**虚构 Word 页数；**本 Stage 不**将 checklist **#3b → GO**；**`frontend_ui_in_scope=false`**；formal phase **None**; **not** go-live；next after → **#104** |
