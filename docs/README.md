...
| **[CE-C06 DOCX permissions boundary](./behavior/ce-c06-docx-permissions-boundary.md)** | **ready** (2026-07-15) · Task Master **#71** · slice `ce-c06-docx-permissions-boundary` | **BDD-CE-C06-001…012** — `permissions` PDF-only; DOCX+permissions → `DOCX_PERMISSIONS_NOT_APPLIED` warn (not 400); POI write-protect out of scope; E2E N/A; formal phase **None**; **not** go-live |
