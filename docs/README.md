...
| **[International Bank Letter Readiness (IBL)](./plan/intl-bank-letter-readiness-program.md)** | **Wave IBL-A In Progress** — TM **#106** registry-only pending + **#107** IBL-A1 **Done** (`f0a2b6fe` / `4bda5f2d`) + **#108–#134** pending; A1 Done / A2–A6 Not Started; **sole-active cleared**; **next queue (not activated)** = **IBL-A2** (#108); formal phase **None**; do **not** mark Wave A / program Done |
