...
**Active work in this documentation track:** **[CDP Wave CD-2 In Progress](./plan/competitiveness-deepening-program.md)** (**partial** — CD-E2E-T01–T04 **Done**, merge `6821f45`; **CD-E2E-T05 In Progress** `cdp-e2e-t05-publish`; T06–T12 Not Started; task IDs **`CD-*`** only). **CD-0 Done**. Formal phase remains **None**.
