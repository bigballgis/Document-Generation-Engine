...
| **[Spring Boot 4.1.0 + Java 25 platform upgrade](./behavior/boot-4-1-upgrade.md)** | **not-applicable** (2026-07-13) · Task Master **#51** · slice **In Progress** (`feat/boot-4-1-upgrade`) | Platform/ops baseline — Boot parent **3.3.x → 4.1.0** + Java **21 → 25**; amend [ADR-0028](./adr/technology-stack/0028-backend-platform-stack-baseline.md); `mvn verify` + `/healthz`; **no** product UI/API journey; formal phase **None**; **not** go-live; do **not** activate CD-3 |
