...
| **[Paste cleaning ↔ binding / publish fail-closed](./behavior/ops-paste-binding-seam.md)** | **ready** (2026-07-12) · slice `ops-paste-binding-seam` (**In Progress**; Task Master **#47** sole-active) | **BDD-OPS-PASTE-BINDING-001** S1–S6 — checklist **#5b** stays **NO-GO** until Done; CD-HARD-T05 **In Progress** (wire path; ADR-0019 SoT: object + absolute → BLOCKED; residue on Accept; `computeBindingStatus` + PublishGate fail-closed; **no** edit-time-only ADR escape); LR-A4 orthogonal; overall checklist still **NO-GO**; **not** go-live |
