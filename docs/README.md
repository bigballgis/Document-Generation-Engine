...
| **[CE-U21 draft key per anchor + save concurrency hint](./behavior/ce-u21-draft-anchor-concurrency.md)** | **ready** (2026-07-17) · Task Master **#95** · slice `ce-u21-draft-anchor-concurrency` (**BDD authored**; implementation pending) | **BDD-CE-U21-DAC-001…012** — localDraft key includes `anchorId`; legacy key compat; binding upsert `expectedUpdatedAt` / 409 `bindingVersionConflict` + Reload/Keep editing UX; formal phase **None**; **not** go-live; **not** CD-3; **not** CE-U17/U19 |
