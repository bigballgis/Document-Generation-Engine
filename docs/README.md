...
**Active work in this documentation track:** **[Wave LR-D In Progress](./plan/detail/LRP-D-ops-observability.md)** (2026-07-12 — **LR-D1+D2+D3+D5+D6+D7 Done**; **LR-D4 Not Started**; **no sole-active**). **[LR-D3 Done](./plan/detail/LRP-D-ops-observability.md)** (slice `lrp-d3-metrics-alerting`; merge `ba5ea2e`; feature tip `173ab36`; Task Master #40; BDD not-applicable; mvn verify GREEN 1315; architecture PASS_WITH_NOTES; DEPLOY_OK scrape 2026-07-12T03:43:07+08:00; [behavior](./behavior/lrp-d3-metrics-alerting.md); [runbook alerts](./operations/runbook.md#observability); [deploy/observability](../deploy/observability/README.md)). **[LR-D2 Done](./plan/detail/LRP-D-ops-observability.md)** (slice `lrp-d2-backup-restore`; merge `3d78bc5`; Task Master #39; BDD not-applicable; drill PASS RPO≈0.933min RTO≈4.751min; healthz 200; FOL OK; [runbook evidence](./operations/backup-restore-runbook.md#drill-evidence-2026-07-12--executed)). **[LR-D5 Done](./plan/detail/LRP-D-ops-observability.md)** (slice `lrp-d5-nfr-proposals`; merge `5b13476`; Task Master #38; BDD not-applicable; NFR §待确认 proposals authored — **pending confirmation, NOT confirmed SLOs**). **[LR-D6 Done](./plan/detail/LRP-D-ops-observability.md)** (slice `lrp-d6-load-smoke`; merge `56383eb`; Task Master #37; BDD not-applicable; Scenario A n=20 success=12 errorRate=0.4 DEF-LRP-D6-001; Scenario B 5/5 SSE; DEPLOY_OK 2026-07-12T01:26:46+08:00). **[LR-D7 Done](./plan/detail/LRP-D-ops-observability.md)** (slice `lrp-d7-durable-security-audit`; merge `c94a356`; Task Master #36; BDD ready; seam «Security forbidden-route audit» **closed**; mvn verify GREEN 1294; frontend gates GREEN 1144; architecture PASS_WITH_NOTES; DEPLOY_OK 2026-07-11T23:50:03+08:00). **[LR-D1 Done](./plan/detail/LRP-D-ops-observability.md)** (slice `lrp-d1-audit-retention`; merge `20b2a76`; Task Master #35; BDD ready; **ADR-0048 Accepted**; V54; mvn verify GREEN; architecture PASS_WITH_NOTES; DEPLOY_OK 2026-07-11T22:26:31+08:00). **[Wave LR-C Done](./plan/detail/LRP-C-usability-deepening.md)** (2026-07-11 — C1–C13; merge tip `bf9cbeb`). **[CDP Wave CD-2 Done](./plan/competitiveness-deepening-program.md)** (2026-07-11 — CD-E2E-T01–T13 Done, merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b` / `55a6ab6` / `b16e52a` / `6e3f825` / `f12b193` / `b2b0899`; all matrix manifests PASS; task IDs **`CD-*`** only). **CD-0 Done**. Formal phase remains **None**. Do **not** activate D4/LR-E/CD-3. Do **not** touch `DGE-audit-governance`. **Prior:** **[LR-C8 Done](./plan/detail/LRP-C-usability-deepening.md)** (merge `bf9cbeb`; Task Master #34). **Prior:** **[LR-C7 Done](./plan/detail/LRP-C-usability-deepening.md)** (merge `879108c`; Task Master #33).
...
| **[LR-D3 metrics & alerting as code](./behavior/lrp-d3-metrics-alerting.md)** | **not-applicable** (2026-07-12) | Observability instrumentation + Prometheus/Grafana as code; scrape + rule-lint acceptance; draft thresholds from D6/D5 only — no product UI/API behavior; superseded sole-active by **LR-D4 In Progress** |
| **[LR-D4 trace propagation](./behavior/lrp-d4-trace-propagation.md)** | **not-applicable** (2026-07-12) | Internal observability plumbing — request→MDC→async→Kafka→consumer MDC; **[ADR-0049 Accepted](./adr/operations/0049-distributed-trace-propagation.md)**; no UI / no Zipkin-Tempo backend; do not break envelope `traceId`; next: backend gap-close |
