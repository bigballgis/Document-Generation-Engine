...
**Active work in this documentation track:** **[Wave LR-D Done](./plan/detail/LRP-D-ops-observability.md)** (2026-07-12 — D1–D7 all Done; merge tip `218dcf1`; **no sole-active**). **[LR-D4 Done](./plan/detail/LRP-D-ops-observability.md)** (slice `lrp-d4-trace-propagation`; merge `218dcf1`; feature tip `670a683`; Task Master #41; BDD not-applicable; ADR-0049 Accepted; `MdcTaskDecorator` + Kafka `X-Trace-Id`; Scenario A/B; mvn verify GREEN 1321; architecture PASS_WITH_NOTES; DEPLOY_OK 2026-07-12T04:18:13+08:00; [behavior](./behavior/lrp-d4-trace-propagation.md)). **[LR-D3 Done](./plan/detail/LRP-D-ops-observability.md)** (merge `ba5ea2e`; #40). **[LR-D2 Done](./plan/detail/LRP-D-ops-observability.md)** (merge `3d78bc5`; #39). **[LR-D5 Done](./plan/detail/LRP-D-ops-observability.md)** (merge `5b13476`; #38; NFR proposals pending — **not** confirmed SLOs). **[LR-D6 Done](./plan/detail/LRP-D-ops-observability.md)** (merge `56383eb`; #37). **[LR-D7 Done](./plan/detail/LRP-D-ops-observability.md)** (merge `c94a356`; #36; seam closed). **[LR-D1 Done](./plan/detail/LRP-D-ops-observability.md)** (merge `20b2a76`; #35; ADR-0048). **[Wave LR-C Done](./plan/detail/LRP-C-usability-deepening.md)** (2026-07-11 — C1–C13; merge tip `bf9cbeb`). **[CDP Wave CD-2 Done](./plan/competitiveness-deepening-program.md)** (2026-07-11 — T01–T13; merge tip `b2b0899`). Formal phase remains **None**. Recommend next (notes only): **LR-E** or **pause** — do **not** activate LR-E/CD-3. Do **not** touch `DGE-audit-governance`. **Prior:** **[LR-C8 Done](./plan/detail/LRP-C-usability-deepening.md)** (merge `bf9cbeb`; Task Master #34). **Prior:** **[LR-C7 Done](./plan/detail/LRP-C-usability-deepening.md)** (merge `879108c`; Task Master #33).
