...
| **[CE-E03 full-library export](./behavior/ce-e03-full-library-export.md)** | **ready** (2026-07-17) · Task Master **#80** **in-progress** / sole-active · slice `ce-e03-full-library-export` | **BDD-CE-E03-001…017** — library ZIP `template-library-export-v1-zip`: root manifest + nested E01 v2 per-template ZIPs + deduped `masters/`/`clauses/` catalogs; optional `groupId`/`templateIds`; partial success; **FE/E2E out of scope** (API-first, same as E01); library import / asset binaries / G05 / O02 / CD-3 / go-live / #50 OOS; formal phase **None** |
