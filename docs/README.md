...
**Active work in this documentation track:** **[LR-C3 In Progress](./plan/detail/LRP-C-usability-deepening.md)** (2026-07-11 — slice `lrp-c3-editor-undo-redo`; Task Master #30; BDD `ready` — [lrp-c3-editor-undo-redo.md](./behavior/lrp-c3-editor-undo-redo.md); **sole-active LRP slice**). Wave LR-C remains **In Progress** (partial — C1/C4/C9–C13 + **C2** Done; **C3 In Progress**; C5/C7/C8 Not Started). **[CDP Wave CD-2 Done](./plan/competitiveness-deepening-program.md)** (2026-07-11 — CD-E2E-T01–T13 Done, merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b` / `55a6ab6` / `b16e52a` / `6e3f825` / `f12b193` / `b2b0899`; all matrix manifests PASS; task IDs **`CD-*`** only). **CD-0 Done**. Formal phase remains **None**. Do **not** mark Wave LR-C Done. Do **not** activate C5/C7/C8/CD-3. **Prior:** **[LR-C2 Done](./plan/detail/LRP-C-usability-deepening.md)** (merge `12a6a7e`; Task Master #29). **Prior:** **[LR-C13 Done](./plan/detail/LRP-C-usability-deepening.md)** (merge `45addd6`; OPT-G4/G5 closed).
