...
| **[CE-G03 test-data PII governance](./behavior/ce-g03-testdata-pii.md)** | **ready** (2026-07-15) · Task Master **#74** · slice **In Progress** (docs-first SoT synced; worktree `DGE-ce-g03-testdata-pii`) | **BDD-CE-G03-001…017** — VariableSchema `piiCategory`; test-set save `SYNTHETIC` or `EXPLICIT_SENSITIVE`+audit; closes data-storage-view hanging Q (G03-C14); OpenAPI export + contract-outline messageKeys; formal phase **None**; **not** go-live |
