...
| 2a | **[CORE-EXCELLENCE (CE)](./plan/core-excellence-program-2026-07.md)** | **Delivery focus** — **sole-active #92** CE-U16 **In Progress** (`ce-u16-authoring-path-compress`); **#91** CE-U15 **Done** (`b2968052` / `ed8a15e6`); **#90** CE-U14 **Done** (`05e845e4` / `09e0d251`); **#75** CE-G04 **Done** (`42745ea5` / `b47ea896`); **#81** CE-O01 **Done** (`e081bcfa`); **#79** CE-E02 **Done** (`5bd3611e`); **#78** CE-E01 **Done** (`6ae57974`); **#76** CE-G06 **Done** (`d8636232`); **#71** CE-C06 **Done** (`35f6f47d`); **#89** CE-U13 **Done** (`ccdfacda`); **#74** CE-G03 **Done** (`50c1a524`); **#62** CE-K06 **Done** (a/b/c; tip `76297d08`); **#69/#70/#88 Done**; Wave 0 #61/#86/#87 **Done**; umbrella **#53**; not a formal P-phase |
...
| **[CE-U16 authoring path compression](./behavior/ce-u16-authoring-path-compress.md)** | **ready** (2026-07-17) · Task Master **#92** · slice `ce-u16-authoring-path-compress` (**In Progress** / sole-active) | **BDD-CE-U16-APC-001…010** — Design default **Bindings**; post-create **Authoring path** micro-wizard (Master → Bindings → Variables → Preview); not U15 lifecycle Stepper; formal phase **None**; **not** go-live; **not** CD-3 |
