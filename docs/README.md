...
| **[CE-U15 lifecycle Stepper + checklist deep links](./behavior/ce-u15-lifecycle-stepper.md)** | **ready** (2026-07-17) · Task Master **#91** **in-progress** (sole-active) · slice `ce-u15-lifecycle-stepper` | **BDD-CE-U15-LSS-001…010** — dev workspace top-bar lifecycle Stepper (read-only); publish-gate pending **Go fix** deep links to design/testing/approval tabs; deps U14 Done; formal phase **None**; **not** go-live; **not** CE-U16 / CD-3 |
