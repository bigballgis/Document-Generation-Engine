...
| **[CORE-EXCELLENCE (CE)](./plan/core-excellence-program-2026-07.md)** | **Delivery focus** — Wave 1 lane 3 **#69** CE-C04 **In Progress**; Wave 0 #61/#86/#87 **Done**; #62/#88 pending; prior #60/#84/#85 **Done**; Batch 4 remains Done; umbrella **#53**; not a formal P-phase |
...
| **[CE-U06 master anchor visual context](./behavior/ce-u06-master-anchor-context.md)** | **ready** (2026-07-15) · Task Master **#88** · slice `ce-u06-master-anchor-context` (**In Progress**) | **BDD-CE-U06-MAC-001…009** — revision workspace DOCX overview as anchor position highlight list (no full render) + editable `displayLabel`; historical/PENDING_REVIEW read-only; formal phase **None**; **not** go-live |
...
| **[CE-K06 rendering fidelity (K06a shipped · K06b)](./behavior/ce-k06-rendering-fidelity.md)** | **ready** (2026-07-15) · Task Master **#62** · Wave 2 K06b | **BDD-CE-K06a-001…006** shipped (`485a7f3e`); **BDD-CE-K06b-001…009** — ZXing `qrBarcodeRef` PNG embed; `sizePx`/`errorCorrection`/`format`; exit unsupported set; golden `09-qr-barcode`; K06c residual; formal phase **None**; **not** go-live |
...
| **[CE-C05 originalBatchId retry lineage](./behavior/ce-c05-original-batch-id.md)** | **ready** (2026-07-15) · Task Master **#70** · slice `ce-c05-original-batch-id` · **In Progress** | **BDD-CE-C05-001…012** — optional `originalBatchId`; same-credential `BATCH_ROOT` validation; `404 ORIGINAL_BATCH_NOT_FOUND`; response echo + audit association; E2E N/A; formal phase **None**; **not** Done; **not** go-live |
