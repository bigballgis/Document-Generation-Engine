...
**Delivery focus note (2026-07-21):** **#145** SYS-NORM Wave 1 (`sys-norm-shell-fluid-nav`) → **Done** (`7a62be44` / `f1594f2a` / `ce2cb9f0`; sole-active **cleared**; BDD ready **BDD-SYS-NORM-W1-001…016**; FE gates PASS; E2E 7/7; UIUX PASS; arch/CQ PASS; Stage 5+10 DEPLOY_OK; **N18 deferred**; next Wave 2 `sys-norm-hub-ia` Not Started — not activated; TM handoff cited `#144` but `#144` remains PTA; formal phase None; do not flip #3b/#5a GO; do not mark #53 Done; do not claim SYS-NORM program Done). Prior **#144** Published template test artifacts → **Done** (`ac36ecbc` / `6bc74ff1`; remapped from mistaken **#143**). Prior **#143** SYS-NORM Wave 0 → **Done** (`f8e898ad` / `28d4abe1` / `ade18bdb`; program SoT + ADR-0070/0071 Accepted; docs-only gates N/A). Prior **#142** Demo expand Wave B → **Done** (`288ce98f`; Wave B complete; registry 20/20; generate 20/20; `mvn verify` GREEN 2340; docker DEPLOY_OK; arch merge_go; FE E2E N/A; vitest baseline RED unrelated; do not reopen P22/P23; CE-O02 Deferred; no RTL; do not claim go-live). Prior **#141** Demo refresh Wave A → **Done** (`aa88170f` / `5ae9575a`; Wave A complete; import/publish/generate 13/13). Prior **#140** CD-HARD-T06 → **Done** (`b933965c`; Wave CD-3 Done). Prior **#139** PD-7 → **Done** (`b966874a`; OUT of IBL-E; pursue docs ADR-0069 + procurement; docs-only gates; **Accepted ≠ embedding Done**; still cannot ship without licensed assets; #119 Blocked; do not claim embedding / IBL program Done). Prior **#138** PD-6 → **Done** (`73ab03cb`; OUT of IBL-E; F6 opt-in production re-issue; `mvn verify` GREEN 2309; arch PASS_WITH_SUGGESTIONS merge_go; Stage 10 DEPLOY_OK). Prior **#134** IBL-E7 → **Done** (`37239d68` / `68abc7c3`; F15 closed by descope; ADR-0068 Accepted; Wave IBL-E → Done E1–E7).
