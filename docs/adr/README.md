...
| [0006-api-error-model.md](./api/0006-api-error-model.md) | Accepted (amended 2026-07-16 — includes `RENDERING`; **PQH-F7 2026-07-23** additive `RUNTIME` + rate-limit codes) | API error model |
...
| [0031-api-platform-hardening-baseline.md](./api/0031-api-platform-hardening-baseline.md) | Accepted | API platform hardening baseline — follow-up note: PQH-F7 Redis counters when `distributed=true` (default still false) |
...
| [0039-redisson-lock-evaluation.md](./technology-stack/0039-redisson-lock-evaluation.md) | Accepted | Redisson distributed lock evaluation — accepted single-instance risk; mandatory before multi-instance (COR-P05); **appendix:** PQH-F7 shared rate-limit ≠ Redisson locks |
...
| [0041-rendering-font-baseline.md](./rendering-authoring/0041-rendering-font-baseline.md) | Accepted | Rendering font baseline for DOCX→PDF conversion images — Debian jammy CJK + Carlito/Caladea (LR-A5; architecture-reviewer PASS_WITH_NOTES 2026-07-10); **shipped** authority — licensed pursue → [0069](./rendering-authoring/0069-licensed-font-embedding-pursue.md) (does **not** claim Calibri shipped) |
...
| [0044-deployment-topology-v1.md](./operations/0044-deployment-topology-v1.md) | Accepted | v1 deployment topology — **single serving backend replica**; HPA off until scale-out prerequisites; rate-limit row **#3** = PQH-F7 accepted contract (default `distributed=false`; opt-in Redis shared limiter); SSE sticky residual; refines ADR-0039 (LR-B1, 2026-07-04) |
| [0044-multi-instance-correctness-baseline.md](./operations/0044-multi-instance-correctness-baseline.md) | Accepted (honesty residual) | SOR-S07 companion — shared rate-limit **accepted contract** via `docgen.runtime.rate-limit.distributed` (default **false**); PQH-F7 leaf deliverable when enabled & verified; sticky SSE residual; **≠ multi-instance complete** |
...
| [0056-whitelist-variable-compute-dsl-bounds.md](./rendering-authoring/0056-whitelist-variable-compute-dsl-bounds.md) | Accepted | Whitelist compute DSL bounds; forbid Groovy/JS/SpEL; FILTER form; locale default zh-CN; FORMAT_AMOUNT ISO currency; SPELL_AMOUNT ISO+locale language; FORMAT_DATE optional IANA zoneId + UTC unary default (PQH-F8) |
...
| [0060-legal-reproducibility-freeze.md](./rendering-authoring/0060-legal-reproducibility-freeze.md) | Accepted | Legal reproducibility freeze — LO version record, ADR-0041 font set reaffirm, SHA-256 content-hash baseline procedure (IBL-B6 / F16, 2026-07-19); no Word/pixel baselines; does not flip #3b/#5a; licensed pursue (PD-7) → [0069](./rendering-authoring/0069-licensed-font-embedding-pursue.md) does **not** change freeze font authority until re-cut |
...
| [0065-legal-entity-document-brand-variants.md](./template-lifecycle/0065-legal-entity-document-brand-variants.md) | Accepted (product surface **superseded** by [0071](./template-lifecycle/0071-retire-document-brand-legal-entity-surfaces.md) 2026-07-21) | Per-legal-entity document brand variants (IBL-E4 / #131 / F27 document-brand half / PD-9, 2026-07-20). BDD [ibl-e4-entity-document-brands.md](../behavior/ibl-e4-entity-document-brands.md) **ready** (BDD-IBL-E4-001…017 / E4-C*); amends ADR-0013 context whitelist (`legalEntityCode`); DocumentBrand ≠ UI BrandPreset; `frontend_ui_in_scope=true`; impl **Done** (`4d810395` / `212c6be9`); Decision body preserved; ongoing management UX / dual-catalog product requirement → ADR-0071; does not flip #3b/#5a |
...
| [0068-rtl-bidi-out-of-scope-until-market.md](./rendering-authoring/0068-rtl-bidi-out-of-scope-until-market.md) | Accepted | RTL / bidirectional scripts **descope** until market confirmation (IBL-E7 / #134 / F15, 2026-07-20). Evidence [ibl-e7-rtl-bidi-spike/SPIKE-REPORT.md](../plan/evidence/ibl-e7-rtl-bidi-spike/SPIKE-REPORT.md) **DESCOPE**; F15 closed by descope; BDD not-applicable; leaf **Done** (`37239d68` / `68abc7c3`); Wave E Done; does not flip #3b/#5a; PD-6/7 OUT; no Word invent; no product RTL impl |
| [0069-licensed-font-embedding-pursue.md](./rendering-authoring/0069-licensed-font-embedding-pursue.md) | Accepted | Licensed font embedding **pursue** path + procurement gate (PD-7 / slice `pd7-licensed-font-embedding`, 2026-07-20). **Accepted ≠ embedding Done**; shipped baseline remains [0041](./rendering-authoring/0041-rendering-font-baseline.md); freeze [0060](./rendering-authoring/0060-legal-reproducibility-freeze.md) still ADR-0041 fonts; ops [licensed-font-embedding-procurement.md](../operations/licensed-font-embedding-procurement.md); no font binaries in git; does not flip #3b/#5a |
| [0070-role-compression-six-roles.md](./authorization-security/0070-role-compression-six-roles.md) | Accepted | Role compression to **six** management roles (SYS-NORM Wave 0 / 2026-07-21). `TEMPLATE_APPROVER` → `GROUP_ADMIN`; `MASTER_DESIGNER` ∪ `TEMPLATE_AUTHOR` → `DOCUMENT_AUTHOR`; keep tester/legal/audit. **Accepted ≠ Wave 5 impl Done**; matrix rewrite Wave 5; BDD-SYS-NORM-ROLE-*; does not flip #3b/#5a |
| [0071-retire-document-brand-legal-entity-surfaces.md](./template-lifecycle/0071-retire-document-brand-legal-entity-surfaces.md) | Accepted | D1 retire DocumentBrand/LegalEntity **product surfaces** (SYS-NORM Wave 0 / 2026-07-21). Letterhead/logo/seal in Letterhead (master); keep Legal holds; shell REDBC/GREENBC UI-only; no brand/entity pack sidecar. **Supersedes** [0065](./template-lifecycle/0065-legal-entity-document-brand-variants.md) product-surface requirement (Decision body preserved). Runtime Wave 6; nav may Wave 1; BDD-SYS-NORM-D1-*; does not flip #3b/#5a |
...
| --- | --- | --- |
| [0041-rendering-font-baseline.md](./rendering-authoring/0041-rendering-font-baseline.md) | **Accepted** | architecture-reviewer **PASS_WITH_NOTES** 2026-07-10 (slice `lrp-a5-adr-closeout`); also listed in Accepted table above. Licensed **pursue** (PD-7) is [0069](./rendering-authoring/0069-licensed-font-embedding-pursue.md) — does **not** rewrite this Decision to ship Calibri. |
