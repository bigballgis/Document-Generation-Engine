...
Related in-repo hygiene (does **not** close the org SCA gate): Task Master **#49** / slice `deps-security-refresh` — [behavior note](../../behavior/deps-security-refresh.md); critical/high policy in [quality-gate-threshold-baseline.md](../../architecture/quality-gate-threshold-baseline.md).
...
| [deps-security-refresh.md](../../behavior/deps-security-refresh.md) | Task Master #49 ops-hygiene slice (`bdd_readiness: not-applicable`) |
...
| Remediation + re-gates | **Related In Progress** — Task Master **#49** may land baseline-safe bumps / exceptions; regenerating SBOM after upgrades is recommended | Org triage still after upload; #49 does **not** mark M9-T02 Done |
