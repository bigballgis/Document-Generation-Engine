...
**Last synced:** 2026-07-08 (**P23-T03 Done** — shared bank style manifest `deploy/demo-shared/`; `DemoMasterDocxStyleSupport`; credit-limit reference POI assertions; `mvn verify` green)
...
**Active slice:** **P23-T04** (credit-limit pilot rewrite; **P23-T03 Done** 2026-07-08).
