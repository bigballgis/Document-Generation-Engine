...
**Last synced:** 2026-07-08 (**P23-T06 Done** — trade-lc rewrite: LC + guarantee 9 anchors each, 45 catalog variables, rich bindings incl. tableComponentRef/imageRef/sealRef, SQL TRADE-LC-UCP + TRADE-GUARANTEE-URDG v3.0.0, masters regenerated; `TradeLcMasterDocxAssetGeneratorTest` POI assertions; e2e fixture synced; `mvn verify` green)
