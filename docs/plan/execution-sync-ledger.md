...
**Last synced:** 2026-07-04 (**SOR P06/F06 slice** — `cursor/sor-full-implementation-1385`; SOR-P06 Done; SOR-F06 partial; frontend Vitest **664**; see [system-optimization-review-2026-07.md](./system-optimization-review-2026-07.md))
**Authoritative gate snapshot (2026-07-04):** backend Surefire **723** (1 skipped); frontend Vitest **664**; Playwright docker smoke tier **8** specs.
**Completion note (2026-07-04, SOR-P06/F06):** **SOR-P06 Done** — Element Plus on-demand via `unplugin-auto-import` + `unplugin-vue-components`; vendor `manualChunks` (`element-plus`, `element-icons`, `vue-vendor`, `app-vendor`); removed full `element-plus/dist/index.css` import. **SOR-F06 In Progress** — `useRouteScopedAbortController` composable + `LoadErrorPanel` retryable hint. **Gate:** `pnpm -C frontend lint`, `type-check`, `test` (**664**), `build` ✓.
