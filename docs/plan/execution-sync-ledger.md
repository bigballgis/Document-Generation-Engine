...
**Last synced:** 2026-07-03 (**P12-API-PACKAGE-ACCESS-INVOCATION activated → In Progress** — BDD ready; T01–T02 next; no implementation code yet)
**Activation note (2026-07-03):** **P12-API-PACKAGE-ACCESS-INVOCATION activated → In Progress** (single-active-phase selection by `plan-orchestrator`; user prioritized after **P12-TEMPLATE-TESTING-OVERHAUL Done**). **P12 catch-all → In Progress** (sole formal phase `In Progress`). Active slice **P12-API-PACKAGE-ACCESS-INVOCATION** only. **Implementation order:** T01 → T02 (Flyway `api_policy` extensions + lifecycle materialize/gate); T10 doc-only **Done**; T01–T12 task rows remain **Not Started** until implementers land code. BDD **ready** (`docs/behavior/api-package-access-and-invocation-records.md`, BDD-API-PACKAGE-ACCESS-INVOCATION-001). **No gate evidence yet** (activation only). **P21 remains Done** — do not reopen. Traceability: [P12-api-package-access-invocation-records.md](./detail/P12-api-package-access-invocation-records.md), [P12-deferred-enhancements.md](./detail/P12-deferred-enhancements.md) § P12-API-PACKAGE-ACCESS-INVOCATION.
