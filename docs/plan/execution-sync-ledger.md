...
| P21 | In Progress (2026-06-29) | Role-journey frontend redesign — **P21-T08 Done** (2026-06-30; cluster ② B1 Approver journey + AUD-B03 dual-substate; frontend gates green; `TemplateViewMapperTest` **8/8**); next **P21-T09 Not Started** (Team-lead / API management journey) — see [P21 detail](./detail/P21-role-journey-frontend-redesign.md) |

**Active phase:** **P21** (activated 2026-06-29; **T08 Done**; next slice
**P21-T09 Not Started**). All other formal phases P0–P11, P13–P20 **Done** except P12
