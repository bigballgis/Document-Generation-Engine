...
**Last synced:** 2026-07-08 (**P23-T05 Done** — mortgage rewrite: 9 anchors, 34 variables, rich bindings, amortization tableComponentRef, 3 SQL modules, master regenerated; `MortgageMasterDocxAssetGeneratorTest` POI assertions; `mvn verify` green)
...
**Active slice:** **P23-T06** (trade-lc rewrite; **P23-T05 Done** 2026-07-08).
