...
**Last synced:** 2026-07-04 (**SpotBugs EI slice 4 first batch** — `cursor/sor-full-implementation-1385`; domain/authoring DTO defensive copies via `DefensiveCopies.copyBytes`/`copyNestedList`; see [spotbugs-exclusion-ratchet.md](./spotbugs-exclusion-ratchet.md))
**Authoritative gate snapshot (2026-07-04):** backend Surefire **861** (1 skipped); frontend Vitest **763**; Playwright docker smoke tier **8** specs.
