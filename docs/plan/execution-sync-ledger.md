...
| --- | --- | --- | --- |
| Frontend (latest full gates) | `pnpm -C frontend lint`, `type-check`, `test`, `build` | Green — **478** Vitest tests (2026-06-30) | P21-T10 global admin journey + identity L1 sweep |
...
| P21 | In Progress (2026-06-29) | Role-journey frontend redesign — **sub-phase C cluster ③ Done** (T10); **P21-T10 Done** (2026-06-30; 6-step global admin journey + DashboardView gating fix + identity L1 sweep; frontend gates green **478** Vitest; Playwright **4/4**); next **P21-T11 Not Started** (cluster ④ Audit) — see [P21 detail](./detail/P21-role-journey-frontend-redesign.md) |

**Active phase:** **P21** (activated 2026-06-29; **cluster ③ Done**; next slice
**P21-T11 Not Started**). All other formal phases P0–P11, P13–P20 **Done** except P12
