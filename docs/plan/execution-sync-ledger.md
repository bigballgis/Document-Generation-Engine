...
**Last synced:** 2026-07-08 (**P23-T04 Done** — credit-limit pilot rewrite: 9 anchors, 32 variables, rich bindings, EOD SQL module, master regenerated; `CreditLimitMasterDocxAssetGeneratorTest` POI assertions; `mvn verify` green)
...
**Active slice:** **P23-T05** (mortgage rewrite; **P23-T04 Done** 2026-07-08).
