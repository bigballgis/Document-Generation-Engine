...
**Last synced:** 2026-07-08 (**P23-T08 Done** — annual-review rewrite: annual review + renewal 9 anchors each (ARR_* / FRN_*), 36 catalog variables, rich bindings incl. styleRef/conditionBlock/loopBlock/tableComponentRef/contentModuleRef, SQL ANNUAL-REVIEW-STD/COV + FACILITY-RENEWAL-STD v3.0.0, CORP dual-page footer (SECTIONPAGES+NUMPAGES), masters regenerated; `AnnualReviewMasterDocxAssetGeneratorTest` POI assertions; e2e fixture synced; `mvn verify` green)
