...
**Last synced:** 2026-07-04 (**SpotBugs EI slice 2** — `cursor/sor-full-implementation-1385`; persistence entity collection getters hardened; see [spotbugs-exclusion-ratchet.md](./spotbugs-exclusion-ratchet.md))
**Authoritative gate snapshot (2026-07-04):** backend Surefire **831** (1 skipped); frontend Vitest **763**; Playwright docker smoke tier **8** specs.
