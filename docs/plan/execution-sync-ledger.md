...
**Last synced:** 2026-07-03 (**P22-DEMO-EXPANSION activated → In Progress** — BDD ready; P22-T01–T15 Not Started; **P22-T01 next**; plan-orchestrator only — no implementation code)
**Activation note (2026-07-03):** **P22-DEMO-EXPANSION activated → In Progress** (sole formal phase `In Progress`; user prioritized comprehensive demo expansion slice over paused P12 work). **P12 catch-all → Not Started**; slice **P12-API-PACKAGE-ACCESS-INVOCATION paused** (**T01–T09 Done** 2026-07-03 — `8d84001` backend, `22c7ab8`/`917c320` frontend+mgmt API; **T11 In Progress** — `5d08bbb` hub E2E S4/S6/S8 partial; **T12 Not Started**; resume after P22). BDD **ready** (`docs/requirements/demo-expansion-behavior-spec.md`, BDD-DEMO-EXP-001…015). **15 tasks** P22-T01…T15 all **Not Started**. **Implementation order:** T01 → T02 → T03 → T04 → T12 → T05…T11 → T14 → T13 → T15. **P12 partial gate (2026-07-03):** `ManagementInvocationQueryServiceTest` ✓; frontend lint/type-check/test (**646** Vitest) ✓. Traceability: [P22-demo-expansion-rendering-fidelity.md](./detail/P22-demo-expansion-rendering-fidelity.md), [demo-expansion-behavior-spec.md](../requirements/demo-expansion-behavior-spec.md), [P12-api-package-access-invocation-records.md](./detail/P12-api-package-access-invocation-records.md).
