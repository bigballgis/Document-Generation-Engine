...
| COR-T08 | M | Batch test + coverage thresholds | PRD §6.5; P19-T02/T03 Not Started | Multi-sample batch test + threshold blockers | **Partial** (2026-06-25; P19-T01 dataset governance + **P19-T02 batch test Done**; coverage thresholds pending) | P19 |
