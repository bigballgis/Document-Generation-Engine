...
| CE-G04 | Legal hold 最小实现 | P2·M · `In Progress` | hold 实体（模板+时间窗 / invocation 集合）；两个 retention 清理调度器删除前查豁免；GLOBAL_ADMIN 专属管理页。**In Progress (2026-07-16)** — Task Master **#75**; slice `ce-g04-legal-hold`; worktree `D:/working/DGE-ce-g04-legal-hold` · `feat/ce-g04-legal-hold`; BDD **ready** ([ce-g04-legal-hold.md](../behavior/ce-g04-legal-hold.md) `BDD-CE-G04-001…017`)。Formal phase **None**；**not** go-live。 | G03 Done |
...
| 序 | CE-ID | Task # | 级 | 说明 |
| --- | --- | --- | --- | --- |
| **1（sole-active）** | **CE-G04** | **#75** | P2 | Legal hold 最小实现 — **in-progress**（deps G03 #74 **Done**；worktree `DGE-ce-g04-legal-hold` · `feat/ce-g04-legal-hold`；BDD ready） |
| 2 | CE-U14 | #90 | P2 | Dashboard 模板生命周期待办 — **pending**/parked（deps U13 #89 **Done**；U15–U21 链跟其后） |
| 3+ | CE-E03 / U17+ / G05 | #80 / #96… / #77 | P3 | 全库导出、快捷键/依赖只读、年检 FTS — **parked**（P3） |

**已并入 main、勿再并行复开：** CE-O01 (#81) — merge `e081bcfa` on `main`（2026-07-16）；CE-E02 (#79) — merge `5bd3611e` on `main`（2026-07-16）；CE-E01 (#78) — merge `6ae57974` on `main`（2026-07-16）；CE-G06 (#76) — merge `d8636232` on `main`（2026-07-16）；CE-C06 (#71) — merge `35f6f47d` on `main`（2026-07-16）；CE-U13 (#89) — merge `ccdfacda` on `main`（2026-07-16）；CE-G03 (#74) — merge `50c1a524` on `main`（2026-07-16）；CE-K08 (#63) — `35f57503` on `main`。Task Master / 本文件状态应对齐 **Done**。 **Sole-active CE delivery leaf = #75 CE-G04**（umbrella **#53** is program registry, not a delivery leaf）。**Do not start another CE leaf.**
