...
**Sibling (NON-CE):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md)（IBL）— Wave **IBL-D** → **Done** (**#123–#127** D1–D5 **Done** — D5 `6f672271` / `2e56787e`; F23 legalhold half closed; Playwright residual OUT); residual = B7 Blocked OR Wave E BLOCKED (not activated); Wave **IBL-C** → **Done** (**#120–#122** C1–C3 **Done** — C3 `bdfc285d` / `dbfff086`; F19 honesty SYNTHETIC; LO residual → D2/F21); Wave **IBL-B** → **In Progress** (B1–B6 **Done**; B7 Blocked residual); Wave **IBL-A** → **Done** (A1–A6 **#107–#112 Done**; A6 tip `5cacff2a`; prior **#118** Done `8722f4f1` / `8e8c62e6`); **#106** registry-only pending — do not fold into an In Progress CE leaf; do not flip **#3b/#5a GO**; do not invent confirmed NFR SLOs.
...
**Slice:** `ce-k08-clause-legal-metadata` · branch `feat/ce-k08-clause-legal-metadata` · Task Master **#63**.
**Status (2026-07-16):** **Done** — on MAIN at `35f57503` (`feat(CE-K08): add clause legal metadata and publish expiry gate`). Flyway V62 legal metadata; catalog filters; `PublishGateCheckCode.CONTENT_MODULE_EFFECTIVE_EXPIRED`. BDD **ready**/shipped ([ce-k08-clause-legal-metadata.md](../behavior/ce-k08-clause-legal-metadata.md); `BDD-CE-K08-LM-001…015`). Formal phase remains **None**; **not** go-live. Do **not** re-implement.
...
| CE-U13 | 变量重命名联动 + 表达式补全 | P2·M · `Done` | **Done (2026-07-16)** — Task Master **#89**; slice `ce-u13-variable-rename`. BDD **ready** ([ce-u13-variable-rename.md](../behavior/ce-u13-variable-rename.md); **BDD-CE-U13-VRC-001…012**). **Merge:** `ccdfacda` (FF on `main`). rename 传播到 bindings/规则/未锁定测试集 JSON（+ compute 引用）；conditionExpression / visibility 变量补全. **Gates:** FE lint/type-check/test/build **PASS**; arch **PASS_WITH_NOTES**; **DEPLOY_OK** ([ce-u13-stage5-deploy](./evidence/ce-u13-stage5-deploy/)); E2E **9/9** ([ce-u13-stage6-e2e](./evidence/ce-u13-stage6-e2e/)); UIUX **PASS_WITH_NOTES**. Formal phase **None**; **not** go-live. |
| CE-U14 | Dashboard 模板生命周期待办 | P2·S · `Done` | **Done (2026-07-17)** — Task Master **#90**; slice `ce-u14-dashboard-lifecycle-todos`. BDD **ready** ([ce-u14-dashboard-lifecycle-todos.md](../behavior/ce-u14-dashboard-lifecycle-todos.md); **BDD-CE-U14-DLT-001…008**). **Merge:** `05e845e4` / feature `09e0d251` on `main`. Tasks Tab TEST/APPROVAL/PENDING_RELEASE + queue-aware deep links (testing / approval / publishReadiness). **Gates:** FE lint/type-check/test(1429+)/build **GREEN**; E2E functional **6/6** CE-U14 + collaboration-todos **4/4** + CDP-T02 regression; UIUX **PASS** Critical=0 ([CE-U14-uiux-manifest](../../frontend/e2e/evidence/CE-U14-uiux-manifest.md); 24 screenshots); architecture **PASS_WITH_NOTES** Critical=0 (Yellow #1 fixed — no `content[0]` fallback); Stage 5/10 **DEPLOY_OK** (Stage 10 ForceRebuild). Worktree Git-removed (disk dir may linger). Formal phase **None**; **not** go-live；**not** CD-3。 |
| CE-U15 | 生命周期 Stepper + checklist 深链 | P2·M · `Done` | **Done (2026-07-17)** — Task Master **#91**; slice `ce-u15-lifecycle-stepper`. BDD **ready** ([ce-u15-lifecycle-stepper.md](../behavior/ce-u15-lifecycle-stepper.md); **BDD-CE-U15-LSS-001…010**). **Merge:** `b2968052` on `main` (worktree removed). 顶栏生命周期 Stepper（只读）+ publish-gate pending **Go fix** 深链. **Gates:** FE lint/type-check/test(**1448**)/build **GREEN**; E2E **5/5** ([CE-U15-manifest](../../frontend/e2e/evidence/CE-U15-manifest.md); [ce-u15-stage6-e2e](./evidence/ce-u15-stage6-e2e/)); UIUX **PASS** Critical=0 ([CE-U15-uiux-manifest](../../frontend/e2e/evidence/CE-U15-uiux-manifest.md)); architecture **PASS_WITH_NOTES** Critical=0; CQ **PASS_WITH_NOTES** Critical=0; Stage 5/10 **DEPLOY_OK** ([ce-u15-stage5-deploy](./evidence/ce-u15-stage5-deploy/); [ce-u15-stage10-deploy](./evidence/ce-u15-stage10-deploy/) SkipBuild). Formal phase **None**; **not** go-live；**not** CD-3。 |
| CE-U16 | 创作路径压缩 | P2·M · `Done` | **Done (2026-07-17)** — Task Master **#92**; slice `ce-u16-authoring-path-compress`. BDD **ready** ([ce-u16-authoring-path-compress.md](../behavior/ce-u16-authoring-path-compress.md); **BDD-CE-U16-APC-001…010**). **Merge:** `5d683c40` / feature `1a3d0f20` on `main` (worktree removed). design 默认落点 bindings；新建后微向导（Master→Bindings→Variables→Preview）。**Gates:** FE lint/type-check/test/build **GREEN** exit 0; Stage 5 **DEPLOY_OK** ([ce-u16-stage5-deploy](./evidence/ce-u16-stage5-deploy/)); E2E **5/5** ([CE-U16-manifest](../../frontend/e2e/evidence/CE-U16-manifest.md); [ce-u16-stage6-e2e](./evidence/ce-u16-stage6-e2e/)); UIUX **Critical=0** ([CE-U16-uiux-manifest](../../frontend/e2e/evidence/CE-U16-uiux-manifest.md)); architecture **PASS_WITH_NOTES** Critical=0; Stage 10 **DEPLOY_OK** ([ce-u16-stage10-deploy](./evidence/ce-u16-stage10-deploy/)). **Yellow open (not Done):** Master×Stepper sync；Create dialog E2E transitional（`fetchAllMasters` on open — CE-U16-manifest Known gap）. Formal phase **None**; **not** go-live；**not** CD-3。 |
| CE-U18 | 批量测试历史钻取 + 双路径统一 | P2·M · `Done` | **Done (2026-07-17)** — Task Master **#93**; slice `ce-u18-batch-test-history`. BDD **ready** ([ce-u18-batch-test-history.md](../behavior/ce-u18-batch-test-history.md); **BDD-CE-U18-BTH-001…010**). **Merge:** `05e9f8e1` / feature `e05407f2` on `main` (worktree removed). Testing 历史展开消费 `sampleResults`；Open data set 深链；退役 sync `previews/batch-test` UI — 仅异步 `batch-tests/run`。**Gates:** BE `mvn verify` **GREEN**; FE lint/type-check/test/build **GREEN**; Stage 5 **DEPLOY_OK** ([ce-u18-stage5-deploy](./evidence/ce-u18-stage5-deploy/)); E2E **3/3** ([CE-U18-manifest](../../frontend/e2e/evidence/CE-U18-manifest.md); [ce-u18-stage6-e2e](./evidence/ce-u18-stage6-e2e/)); UIUX **Critical=0** ([CE-U18-uiux-manifest](../../frontend/e2e/evidence/CE-U18-uiux-manifest.md)); architecture **PASS_WITH_NOTES** Critical=0; Stage 10 **DEPLOY_OK** ([ce-u18-stage10-deploy](./evidence/ce-u18-stage10-deploy/)). **Yellow open (not Done):** limit clamp；OpenAPI run/SSE；count field alias；errorDetail sanitization。Formal phase **None**；**not** go-live；**not** CD-3。 |
| CE-U20 | 条款创建结构化化 + 列表状态列 | P2·S · `Done` | **Done (2026-07-17)** — Task Master **#94**; slice `ce-u20-clause-create-structured`. BDD **ready** ([ce-u20-clause-create-structured.md](../behavior/ce-u20-clause-create-structured.md); **BDD-CE-U20-CCS-001…010**). **Merge:** `b9327a11` / feature `b4b0b420` on `main` (worktree removed). 创建对话框弃 JSON textarea 改 `ControlledStructuredContentEditor`；目录 Status 列 + 服务端 `status` 筛选. **Gates:** BE `mvn verify` **GREEN**; FE lint/type-check/test(**1481**)/build **GREEN** ([ce-u20-fe-be-gates](./evidence/ce-u20-fe-be-gates/)); Stage 5 **DEPLOY_OK** ([ce-u20-stage5-deploy](./evidence/ce-u20-stage5-deploy/)); E2E **7/7** ([CE-U20-manifest](../../frontend/e2e/evidence/CE-U20-manifest.md); [ce-u20-stage6-e2e](./evidence/ce-u20-stage6-e2e/)); UIUX **PASS** Critical=0 ([CE-U20-uiux-manifest](../../frontend/e2e/evidence/CE-U20-uiux-manifest.md)); architecture **Critical=0**; Stage 10 **DEPLOY_OK** ([ce-u20-stage10-deploy](./evidence/ce-u20-stage10-deploy/)). Formal phase **None**; **not** go-live；**not** CD-3。 |
| CE-U21 | 草稿按锚点分 key + 并发提示 | P2·M · `Done` | **Done (2026-07-17)** — Task Master **#95**; slice `ce-u21-draft-anchor-concurrency`. BDD **ready** ([ce-u21-draft-anchor-concurrency.md](../behavior/ce-u21-draft-anchor-concurrency.md); **BDD-CE-U21-DAC-001…012**). **Merge:** `8d8f6f6d` / feature `292fbc35` on `main` (worktree removed). localDraft key 加 `anchorId`（legacy key 兼容）；binding upsert `expectedUpdatedAt` / 409 `bindingVersionConflict` + Reload/Keep editing UX. **Gates:** BE `mvn verify` **GREEN**; FE lint/type-check/test/build **GREEN**; Stage 5 **DEPLOY_OK** ([ce-u21-stage5-deploy](./evidence/ce-u21-stage5-deploy/)); E2E **4/4** ([CE-U21-manifest](../../frontend/e2e/evidence/CE-U21-manifest.md); [ce-u21-stage6-e2e](./evidence/ce-u21-stage6-e2e/)); UIUX **PASS** Critical=0 ([CE-U21-uiux-manifest](../../frontend/e2e/evidence/CE-U21-uiux-manifest.md)); architecture **Critical=0**; Stage 10 **DEPLOY_OK** ([ce-u21-stage10-deploy](./evidence/ce-u21-stage10-deploy/)). **Post-merge CQ DRY closed** (shared `resolveBindingVersionConflictAndReload`; merge `c8a4b568` / feature `2cb1793a`) — **#95** stays **Done**. **P2 continuum complete** with U21. Formal phase **None**; **not** go-live；**not** CD-3。 |
| CE-U17 | 编辑器快捷键 | P3·S · `Done` | **Done (2026-07-17)** — Task Master **#96**; slice `ce-u17-editor-shortcuts`. BDD **ready** ([ce-u17-editor-shortcuts.md](../behavior/ce-u17-editor-shortcuts.md); **BDD-CE-U17-EKS-001…012**). **Merge:** `4fc2dbdb` / feature `d3293db1` on `main` (worktree removed). Ctrl/Cmd+S 保存绑定 / Ctrl/Cmd+P 刷新预览；命令面板注册作者动作. **Gates:** FE lint/type-check/test(**1509**)/build **PASS**; E2E functional **9/9**; UIUX **PASS_WITH_NOTES** Critical=0 ([CE-U17-uiux-manifest](../../frontend/e2e/evidence/CE-U17-uiux-manifest.md)); architecture **PASS_WITH_NOTES** Critical=0; CQ **PASS** Critical=0; Stage 10 **DEPLOY_OK** (frontend sha256:`27ee0118a3df2f79b92d9f1f773275ecf847232399d8f464d147fb3be41f1440`; healthz **200**; `:4173` **200**). Formal phase **None**；**not** go-live；**not** CD-3。 |
| CE-U19 | 依赖关系只读视图 | P3·M · `Done` | **Done (2026-07-17)** — Task Master **#97**; slice `ce-u19-dependency-readonly-view`. BDD **ready** ([ce-u19-dependency-readonly-view.md](../behavior/ce-u19-dependency-readonly-view.md); **BDD-CE-U19-DRV-001…012**). **Merge:** `e4679421` / feature `90a9e5cd` on `main` (worktree removed). Package Hub **Dependencies** 只读页：母版 revision（发布钉扎优先）/ 锚点 / 条款版本 / release 线；release GET 加法 `masterPin`（U19-D5）. **Gates:** BE `mvn verify` **GREEN**; FE lint/type-check/test/build **PASS**; E2E functional **11/11**; UIUX **PASS** Critical=0 ([CE-U19-uiux-manifest](../../frontend/e2e/evidence/CE-U19-uiux-manifest.md)); architecture Critical=0; CQ Critical=0; Stage 10 **DEPLOY_OK** SkipBuild health **200**. Formal phase **None**；**not** go-live；**not** CD-3；**not** CE-O02。 |
...
| CE-C06 | DOCX permissions 边界声明 | P2·S · `Done` | **Done (2026-07-16)** — Task Master **#71**; slice `ce-c06-docx-permissions-boundary`. BDD **ready** ([ce-c06-docx-permissions-boundary.md](../behavior/ce-c06-docx-permissions-boundary.md); **BDD-CE-C06-001…012**). **Merge:** `35f6f47d` (feat `96c470bc`). 契约明确 permissions 仅 PDF 生效；DOCX+permissions → `DOCX_PERMISSIONS_NOT_APPLIED`（`messageKey=generation.warning.fidelity.docxPermissionsNotApplied`）警告（不 400）；无 POI 写保护。**Gates:** `mvn verify` **GREEN** (**1730**/0/0/8); architecture **PASS_WITH_NOTES**; docker-deploy tip `35f6f47d` healthz/`:4173` **200**; FE/E2E/UIUX N/A. Formal phase **None**; **not** go-live. | 无（软序 C05） |
...
| CE-G04 | Legal hold 最小实现 | P2·M · `Done` | hold 实体（模板+时间窗 / invocation 集合）；两个 retention 清理调度器删除前查豁免；GLOBAL_ADMIN 专属管理页。**Done (2026-07-16)** — Task Master **#75**; slice `ce-g04-legal-hold`; BDD **ready** ([ce-g04-legal-hold.md](../behavior/ce-g04-legal-hold.md) `BDD-CE-G04-001…017`)。**Merge tip:** `42745ea5` (feature `b47ea896` / merge `ed68455c`)；worktree removed。**Gates:** E2E functional **5/5**; UIUX **PASS**; architecture **PASS** Critical=0; Stage 10 **DEPLOY_OK** (`dge-ce-g04-legal-hold-*`; `:8080` healthz 200; `:4173` 200)。Formal phase **None**；**not** go-live。 | G03 Done |
| CE-G06 | 审计可复现最小集 | P2·M · `Done` | invocation 记录发布包快照 ID + bundle hash；管理端"按 invocation 受控再生"API（需权限 + 审计 + SPECIMEN 水印标记再生件）。**Done (2026-07-16)** — Task Master **#76**; slice `ce-g06-audit-reproducible`; BDD **ready** ([ce-g06-audit-reproducible.md](../behavior/ce-g06-audit-reproducible.md); `BDD-CE-G06-001…021`)；FE 再生 UI **out of scope**。[ADR-0057](../adr/authorization-security/0057-invocation-parameters-retention-for-regenerate.md)。**Merge:** `d8636232`；worktree removed。**Gates:** `mvn verify` **GREEN** (**1748** tests); architecture **PASS** (Critical closed via ADR-0057); Stage 10 **DEPLOY_OK** (`:8080` healthz 200; Flyway **V64**; FE `:5173`); FE/E2E/UIUX N/A (G06-C17)。Formal phase **None**；**not** go-live。 | K01 |
| CE-G05 | 模板年检 + 条款正文检索 | P3·M · `Done` | `nextReviewDue` + 到期待办；`content_structure_json` 全文检索（PostgreSQL tsvector）where-used。**Done (2026-07-17)** — Task Master **#77**; slice `ce-g05-annual-review-fts`。BDD **ready** ([ce-g05-annual-review-fts.md](../behavior/ce-g05-annual-review-fts.md) `BDD-CE-G05-001…019`)；`frontend_ui_in_scope=true`。**Merge:** `c3f6a288` / feature `744b628a` on `main` (worktree removed)。**Gates:** BE `mvn verify` **GREEN** (**1908** tests); FE lint/type-check/test/build **PASS**; E2E functional **17/17**; UIUX **PASS** Critical=0; architecture Critical=0; CQ Critical=0; Stage 10 **DEPLOY_OK**; Flyway **V67**。Formal phase **None**；**not** go-live；**not** CD-3；leave **#50** alone。 | 无 |

## 7. Wave CE-E — 环境晋级与资产

| ID | 标题 | 级/量 | 要点 | 依赖 |
| --- | --- | --- | --- | --- |
| CE-E01 | 自包含导出包 v2 + dry-run | P2·L · `Done` | bundle 追加母版 revision 指纹与 DOCX（ZIP 内嵌）、条款正文快照、render profile、资产键清单；导入 dry-run 依赖预检报告。**Done (2026-07-16)** — Task Master **#78**; slice `ce-e01-export-bundle-v2`; BDD **ready** ([ce-e01-export-bundle-v2.md](../behavior/ce-e01-export-bundle-v2.md) `BDD-CE-E01-001…017` shipped; **018** FE non-goal)；FE/E2E **out of scope**（API-first）。**Merge:** `6ae57974`；worktree removed。**Gates:** `mvn verify` **GREEN** (**1759+** tests); architecture **PASS_WITH_NOTES** (Critical #1/#2 fixed); Stage 10 **DEPLOY_OK** (`docker-deploy-queue`; `:8080` healthz UP; actuator/health UP); FE/E2E/UIUX N/A。Formal phase **None**；**not** go-live。Succeeded by **#79** CE-E02（现 **Done**）。 | K01 |
| CE-E02 | 资产库管理面 | P2·M · `Done` | MinIO 资产目录 API（上传/列表/停用）+ 键名约定固化 + 管理页；印章类上传需审批角色；`StructuredContentImageResolver` 协议不变。**Done (2026-07-16)** — Task Master **#79**; slice `ce-e02-asset-library`; BDD **ready** ([ce-e02-asset-library.md](../behavior/ce-e02-asset-library.md) `BDD-CE-E02-001…022`)；FE/E2E **in scope**。**Merge:** `5bd3611e`；worktree removed。**Gates:** `mvn verify` **PASS** (incl Yellow #4 fail-closed); pnpm lint/type-check/test/build **PASS**; E2E functional **4/4** (`ce-e02-asset-library.spec.ts`); UIUX **PASS** (manifest CE-E02-asset-library-uiux); architecture **PASS** (Yellow 1–4 cleared); Stage 10 **DEPLOY_OK** ForceRebuild (`dge-ce-e02-asset-library`; `:8080` UP; `:4173` 200)。Formal phase **None**；**not** go-live；**not** CD-3。Succeeded by **#81** CE-O01（现 **Done**）。 | 软依赖 E01 (#78) Done |
| CE-E03 | 全库导出 | P3·M · `Done` | 基于 per-template bundle + 母版/条款批量导出 + manifest。**Done (2026-07-17)** — Task Master **#80**; slice `ce-e03-full-library-export`。**BDD `ready`** — [ce-e03-full-library-export.md](../behavior/ce-e03-full-library-export.md) `BDD-CE-E03-001…017`；API-first（FE/E2E **out of scope**，同 E01）。**Merge:** `f1f02554` / feature `86e4ff10` on `main` (worktree removed)。**Gates:** BE `mvn verify` **GREEN** (**1887** tests); architecture Critical=0; CQ Critical=0; Stage 10 **DEPLOY_OK** healthz **200**; FE/E2E **N/A**。Formal phase **None**；**not** go-live；**not** CD-3；**not** CE-O02；leave **#50** alone。 | E01 |
...
| 序 | CE-ID | Task # | 级 | 说明 |
| --- | --- | --- | --- | --- |
| *(empty CE)* | — | — | — | **CE P3 queue empty** (#96/#97/#80/#77 all Done). Umbrella **#53** registry only — **do not** claim program Done (CE-O02 deferred per D5). **Host sole-active:** **cleared** (prior NON-CE **#144** `published-template-test-artifacts` Done `ac36ecbc` / `6bc74ff1`; remapped from mistaken **#143**) (prior NON-CE **#143** SYS-NORM Wave 0 Done `f8e898ad` / `28d4abe1` / `ade18bdb`; prior NON-CE **#142** Wave B Done `288ce98f`; prior NON-CE **#141** Wave A Done `aa88170f` / `5ae9575a`; do **not** treat as CE-O02) (prior NON-CE **#140** CD-HARD-T06 Done `b933965c`; Wave CD-3 Done) (prior NON-CE **#139** PD-7 Done `b966874a`; pursue docs ADR-0069 + procurement; **Accepted ≠ embedding Done**) (prior NON-CE **#138** PD-6 Done `73ab03cb`; F6 opt-in re-issue) (prior NON-CE **#134** IBL-E7 Done `37239d68` / `68abc7c3`; Wave E → Done) (prior NON-CE **#133** IBL-E6 Done `dcc42c81` / `0e542c03` / `32b62136` / docs `a2501d48`; F28 closed; prior NON-CE **#132** IBL-E5 Done `688f9e58` / `20ead1ce`; F27 closed; Wave E → Done E1–E7; prior NON-CE **#127** IBL-D5 Done `6f672271` / `2e56787e`; F23 legalhold half closed; Wave IBL-D → Done D1–D5; Playwright residual OUT; prior NON-CE **#126** IBL-D4 Done `94cc8eeb` / `94526674`; F22 closed; prior NON-CE **#125** IBL-D3 Done `6b9b6487` / `0242084e`; F22 load half; prior NON-CE **#124** IBL-D2 Done `21be3a99` / `4fd0c5da`; F21 closed; prior NON-CE **#123** IBL-D1 Done `1a686938` / `f399489c`; F20 closed; prior NON-CE **#122** IBL-C3 Done `bdfc285d` / `dbfff086`; Wave IBL-C → **Done** C1+C2+C3; prior NON-CE **#121** IBL-C2 Done `1d357e4d` / `767b4ceb`+`abf564dc`; prior NON-CE **#120** IBL-C1 Done `55909dd2` / `d2492fc4`+`5d89b606`; Wave IBL-B **In Progress** B1–B6 Done / B7 Blocked residual; prior NON-CE **#118** Done `8722f4f1` / `8e8c62e6`; prior NON-CE **#117** IBL-B5 Done `1666312b` / `d7459405`+`fbb40429`; prior NON-CE **#116** IBL-B4 Done `610eb0fa` / `d6b389d1`+`d2e8a1c9`; prior NON-CE **#115** IBL-B3 → **Done** `3710811a` / `c81054b0`+`e0102ddb`; prior NON-CE **#114** IBL-B2 → **Done** `29d022b6` / `3dd1aa60`+`36a9821c`; prior **#113** Done `a33da272` / `44237c99`). Prior NON-CE **#112** IBL-A6 → **Done** `5cacff2a` (Wave IBL-A → **Done**). Prior NON-CE **#111** IBL-A5 → **Done** `e5217a80` / `99e8c1a7`. Prior NON-CE **#110** IBL-A4 → **Done** `ddf6601c` / `6edb41cd`. Prior NON-CE **#109** IBL-A3 → **Done** (`779b1979` / `f09326ca`). Prior NON-CE **#108** IBL-A2 → **Done** (`e3000479` / `89584242`). Prior NON-CE **#107** IBL-A1 → **Done** (`f0a2b6fe` / `4bda5f2d`). Prior NON-CE **#137** PRR-P2 → **Done** (`baaf16cc` / `09cf85ce`; listAll removed; `components/template`→`templates`; knip unused exports **31→0**). Prior NON-CE **#136** PRR-D01c → **Done** (`a872c15b` / `8c52ee67`). Prior NON-CE **#135** → **Done** (`6e776232` / `1ada6b41`). Prior NON-CE **#104** → **Done** (`f1f79d14`). Wave D residuals **D01A+#135+#136** closed. Prior NON-CE **#103** PRR-C01 → **Done** (`3513ab92` / `6408c210` / tip `7a1a1bb1`; Path X; **#3b** → **CONDITIONAL** ≠ GO — do **not** regress). NON-CE **#105** → **Done** (`50448016`); **#102** → **Done** (`40e264e7`); **#101** → **Done** (`5b705f56`); Wave A → **Done** (`4197770f`) — see [execution-sync-ledger.md](./execution-sync-ledger.md). Do **not** invent a CE delivery leaf without explicit activation. Do **not** flip **#5a GO** / **#3b GO**. |

**已并入 main、勿再并行复开：** CE-G05 (#77) — merge `c3f6a288` / feature `744b628a` on `main`（2026-07-17；worktree removed）；CE-E03 (#80) — merge `f1f02554` / feature `86e4ff10` on `main`（2026-07-17；worktree removed）；CE-U19 (#97) — merge `e4679421` / feature `90a9e5cd` on `main`（2026-07-17；worktree removed）；CE-U17 (#96) — merge `4fc2dbdb` / feature `d3293db1` on `main`（2026-07-17；worktree removed）；CE-U21 (#95) — merge `8d8f6f6d` / feature `292fbc35` on `main`（2026-07-17；worktree removed）；CE-U20 (#94) — merge `b9327a11` / feature `b4b0b420` on `main`（2026-07-17；worktree removed）；CE-U18 (#93) — merge `05e9f8e1` / feature `e05407f2` on `main`（2026-07-17；worktree removed）；CE-U16 (#92) — merge `5d683c40` / feature `1a3d0f20` on `main`（2026-07-17；worktree removed）；CE-U15 (#91) — merge `b2968052` on `main`（2026-07-17；closeout `ed8a15e6`；worktree removed）；CE-U14 (#90) — merge `05e845e4` / feature `09e0d251` on `main`（2026-07-17）；CE-G04 (#75) — merge tip `42745ea5` / feature `b47ea896` on `main`（2026-07-16）；CE-O01 (#81) — merge `e081bcfa` on `main`（2026-07-16）；CE-E02 (#79) — merge `5bd3611e` on `main`（2026-07-16）；CE-E01 (#78) — merge `6ae57974` on `main`（2026-07-16）；CE-G06 (#76) — merge `d8636232` on `main`（2026-07-16）；CE-C06 (#71) — merge `35f6f47d` on `main`（2026-07-16）；CE-U13 (#89) — merge `ccdfacda` on `main`（2026-07-16）；CE-G03 (#74) — merge `50c1a524` on `main`（2026-07-16）；CE-K08 (#63) — `35f57503` on `main`。Task Master / 本文件状态应对齐 **Done**（#77）。 Umbrella **#53** is program registry, not a delivery leaf。**Host sole-active: #126** IBL-D4 (`ibl-d4-lo-pool-chaos`; next after leaf note-only **#127** IBL-D5; prior NON-CE **#125** Done `6b9b6487` / `0242084e`; F22 partial; prior NON-CE **#124** Done；prior NON-CE **#123** Done。Prior NON-CE **#122** IBL-C3 → **Done** `bdfc285d` / `dbfff086`。Prior NON-CE **#121** IBL-C2 → **Done** `1d357e4d` / `767b4ceb`+`abf564dc`。Prior NON-CE **#120** IBL-C1 → **Done** `55909dd2` / `d2492fc4`+`5d89b606`。Wave IBL-B residual B7 Blocked；Wave IBL-A Done。**P2 continuum complete**。**P3 queue empty** (#96/#97/#80/#77 all Done)。Do **not** claim program Done。Do **not** activate CD-3。Do **not** claim go-live。Do **not** flip **#5a GO** / **#3b**。
...
**Task Master registry (2026-07-21):** umbrella **#53** in-progress (program registry only — **do not** claim program Done; **host sole-active:** **cleared** (prior NON-CE **#144** `published-template-test-artifacts` Done `ac36ecbc` / `6bc74ff1`; remapped from mistaken **#143**) — prior NON-CE **#143** SYS-NORM Wave 0 Done `f8e898ad` / `28d4abe1` / `ade18bdb`; prior NON-CE **#142** Wave B Done `288ce98f`; prior NON-CE **#141** Wave A Done `aa88170f` / `5ae9575a`; CE-O02 stays Deferred — prior NON-CE **#140** Done `b933965c`; prior NON-CE **#139** PD-7 → **Done** `b966874a` (pursue docs ADR-0069 + procurement; **Accepted ≠ embedding Done**; OUT of IBL-E; prior #138 PD-6 Done `73ab03cb`; prior #134 Done `37239d68` / `68abc7c3`); next recommend **SYS-NORM Wave 1** `sys-norm-shell-fluid-nav` (not activated) **or** **B3 CE-O02** (Deferred — do not auto-activate)); **Execution model:** **single-lane serial** (§9.2) — NON-CE **#143** Wave 0 → **Done** (`f8e898ad` / `28d4abe1`); prior NON-CE **#139** PD-7 → **Done** (`b966874a`); prior NON-CE **#138** PD-6 → **Done** (`73ab03cb`); prior NON-CE **#133** IBL-E6 → **Done** (`dcc42c81` / `0e542c03` / `32b62136`); prior NON-CE **#132** IBL-E5 → **Done** (`688f9e58` / `20ead1ce` / `65613c4b`); prior NON-CE **#131** IBL-E4 → **Done** (`4d810395` / `212c6be9` / `d9f02036`); prior NON-CE **#127** IBL-D5 → **Done** (`6f672271` / `2e56787e`; Wave IBL-D → Done D1–D5); prior NON-CE **#126** IBL-D4 → **Done** (`94cc8eeb` / `94526674`; F22 closed); prior NON-CE **#125** IBL-D3 → **Done** (`6b9b6487` / `0242084e`; F22 load half); prior NON-CE **#124** IBL-D2 → **Done** (`21be3a99` / `4fd0c5da`; F21 closed); prior NON-CE **#123** IBL-D1 → **Done** (`1a686938` / `f399489c`; F20 closed); prior NON-CE **#122** IBL-C3 → **Done** (`bdfc285d` / `dbfff086`; Wave IBL-C → **Done** C1+C2+C3); prior NON-CE **#121** IBL-C2 → **Done** (`1d357e4d` / `767b4ceb`+`abf564dc`; prior NON-CE **#120** IBL-C1 → **Done** (`55909dd2` / `d2492fc4`+`5d89b606`; Wave IBL-B **In Progress** B1–B6 Done / B7 Blocked residual; prior **#118** Done `8722f4f1` / `8e8c62e6`); prior NON-CE **#117** IBL-B5 → **Done** (`1666312b` / `d7459405`+`fbb40429`); prior NON-CE **#116** IBL-B4 → **Done** (`610eb0fa` / `d6b389d1`+`d2e8a1c9`); prior NON-CE **#115** IBL-B3 → **Done** (`3710811a` / `c81054b0`+`e0102ddb`); prior NON-CE **#114** IBL-B2 → **Done** (29d022b6 / 3dd1aa60+36a9821c); prior NON-CE **#113** IBL-B1 → **Done** (`a33da272` / `44237c99`); prior NON-CE **#112** IBL-A6 → **Done** (tip `5cacff2a`; Wave IBL-A → **Done**); prior NON-CE **#111** IBL-A5 → **Done** (merge `e5217a80` / tip `99e8c1a7`); prior NON-CE **#110** IBL-A4 → **Done** (merge `ddf6601c` / tip `6edb41cd`); prior NON-CE **#109** IBL-A3 → **Done** (merge `779b1979` / tip `f09326ca`); prior NON-CE **#108** IBL-A2 → **Done** (merge `e3000479` / tip `89584242`); prior NON-CE **#107** IBL-A1 → **Done** (merge `f0a2b6fe` / tip `4bda5f2d`); prior NON-CE **#137** PRR-P2 → **Done** (merge `baaf16cc` / tip `09cf85ce`; knip unused exports **31→0**); NON-CE **#136** PRR-D01c → **Done** (merge `a872c15b` / tip `8c52ee67`; Wave D residuals **D01A+#135+#136** closed); NON-CE **#135** PRR-D01b → **Done** (merge `6e776232` / tip `1ada6b41`); NON-CE **#104** PRR-D01a (**D01A**) → **Done** (`f1f79d14`); NON-CE **#103** PRR-C01 → **Done** (merge `3513ab92` / doc-sync `6408c210` / tip `7a1a1bb1`; worktree removed; Path X; checklist **#3b** → **CONDITIONAL** ≠ GO); NON-CE **#105** PRR-B02 LDAP SPI → **Done** (merge `50448016`; worktree removed); NON-CE **#102** PRR-B01 → **Done** (merge `40e264e7`; worktree removed); **#101** PRR-A04 → **Done** (`5b705f56`); Wave A **#98+#99+#100** → **Done** (`4197770f`). **#77** CE-G05 → **Done** (merge `c3f6a288` / feature `744b628a`; worktree removed). **P3 queue empty** (#96/#97/#80/#77 all Done). **#80** CE-E03 → **Done** (merge `f1f02554` / feature `86e4ff10`; worktree removed). **#97** CE-U19 → **Done** (merge `e4679421` / feature `90a9e5cd`; worktree removed). **#96** CE-U17 → **Done** (merge `4fc2dbdb` / feature `d3293db1`; worktree removed). **#95** CE-U21 → **Done** (merge `8d8f6f6d` / feature `292fbc35`; worktree removed). **#94** CE-U20 → **Done** (merge `b9327a11` / feature `b4b0b420`; worktree removed). **#93** CE-U18 → **Done** (merge `05e9f8e1` / feature `e05407f2`; worktree removed). **#92** CE-U16 → **Done** (merge `5d683c40` / feature `1a3d0f20`; worktree removed). **#91** CE-U15 → **Done** (merge `b2968052`; closeout `ed8a15e6`; worktree removed). **#90** CE-U14 → **Done** (merge `05e845e4` / feature `09e0d251`). **P2 CE continuum complete** (U21 last leaf). Leave **#50** alone. **#75** CE-G04 → **Done** (merge tip `42745ea5` / feature `b47ea896`). **#81** CE-O01 → **Done** (merge `e081bcfa`) — do **not** reopen. **#79** CE-E02 → **Done** (merge `5bd3611e`) — do **not** reopen. **#78** CE-E01 → **Done** (merge `6ae57974`) — do **not** reopen. **#76** CE-G06 → **Done** (merge `d8636232`) — do **not** reopen. **#71** CE-C06 → **Done** (merge `35f6f47d`) — do **not** reopen. Leaves **#54–#97** (CE-O02 skipped per D5). **Batch 1–4 Done.** Prior waves closed: **#59**/**#68**/**#83** → **Done**; **#60**/**#84**/**#85** → **Done**. **Wave 0 (K05+U11+U12) closed:** **#61** CE-K05 + **#86** CE-U11 + **#87** CE-U12 → **Done** (merges `51a58f12` / `513d776c` / tip `34353b75`). **#69** CE-C04 → **Done** (`c7be8305`). **#70** CE-C05 → **Done** (`405f7cea`). **#88** CE-U06 → **Done** (`7734366e`). **#62** CE-K06 → **Done** (K06a `485a7f3e` + K06b `a689ca87` + K06c tip `76297d08`). **#63** CE-K08 → **Done** (`35f57503` on main). **#74** CE-G03 → **Done** (`50c1a524`). **#89** CE-U13 → **Done** (`ccdfacda`). Formal phase remains **None**. Do **not** activate CD-3. Do **not** claim go-live. Do **not** activate CE-O02. **Host sole-active cleared** (prior NON-CE **#134** IBL-E7 Done `37239d68` / `68abc7c3`; Wave IBL-E → Done E1–E7). Prior NON-CE **#133** Done; Wave IBL-D → Done; Wave IBL-C → Done; Wave IBL-B residual B7 Blocked; Wave IBL-A Done.

**Last reviewed:** 2026-07-21（post-task-doc-sync — host sole-active **cleared**；NON-CE **#144** `published-template-test-artifacts` → **Done** `ac36ecbc` / `6bc74ff1`；prior NON-CE **#143** SYS-NORM Wave 0 → **Done** `f8e898ad` / `28d4abe1` / `ade18bdb`；next `sys-norm-shell-fluid-nav` not activated；prior **#142** Wave B → **Done** `288ce98f`；prior **#141** Wave A → **Done** `aa88170f` / `5ae9575a`；CE-O02 stays Deferred；do **not** mark #53 Done；do **not** auto-activate CE-O02 / Wave 1；do **not** flip #3b/#5a GO；formal phase None；not go-live；do not claim SYS-NORM / IBL program Done）
