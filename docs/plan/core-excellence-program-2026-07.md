...
| CE-U14 | Dashboard 模板生命周期待办 | P2·S · `In Progress` | 测试裁定/审批/待发布队列进 Tasks Tab。**Activated (2026-07-16)** — Task Master **#90** **in-progress** (sole-active CE delivery leaf; single-lane serial §9.2). Slice `ce-u14-dashboard-lifecycle-todos`; worktree `D:/working/DGE-ce-u14-dashboard-lifecycle-todos` · `feat/ce-u14-dashboard-lifecycle-todos`. BDD **ready** ([ce-u14-dashboard-lifecycle-todos.md](../behavior/ce-u14-dashboard-lifecycle-todos.md); **BDD-CE-U14-DLT-001…008**); `frontend_ui_in_scope=true`. Formal phase **None**; **not** go-live；**not** CD-3。Next after Done: **#91** CE-U15。 |
...
| 序 | CE-ID | Task # | 级 | 说明 |
| --- | --- | --- | --- | --- |
| **1（sole-active / In Progress）** | **CE-U14** | **#90** | P2 | Dashboard 模板生命周期待办 — **in-progress**（deps U13 #89 **Done**；BDD **ready**；worktree `DGE-ce-u14-dashboard-lifecycle-todos`） |
| **2（next after Done）** | **CE-U15** | **#91** | P2 | 生命周期 Stepper + checklist 深链 — **pending**/parked（do **not** auto-start） |
| 3+ | CE-E03 / U17+ / G05 | #80 / #96… / #77 | P3 | 全库导出、快捷键/依赖只读、年检 FTS — **parked**（P3） |

**已并入 main、勿再并行复开：** CE-G04 (#75) — merge tip `42745ea5` / feature `b47ea896` on `main`（2026-07-16）；CE-O01 (#81) — merge `e081bcfa` on `main`（2026-07-16）；CE-E02 (#79) — merge `5bd3611e` on `main`（2026-07-16）；CE-E01 (#78) — merge `6ae57974` on `main`（2026-07-16）；CE-G06 (#76) — merge `d8636232` on `main`（2026-07-16）；CE-C06 (#71) — merge `35f6f47d` on `main`（2026-07-16）；CE-U13 (#89) — merge `ccdfacda` on `main`（2026-07-16）；CE-G03 (#74) — merge `50c1a524` on `main`（2026-07-16）；CE-K08 (#63) — `35f57503` on `main`。Task Master / 本文件状态应对齐 **Done**。 **Sole-active CE delivery leaf = #90 CE-U14**（umbrella **#53** is program registry, not a delivery leaf）。**§9.2 next after U14 Done = #91 CE-U15 (parked).** **Do not start another CE leaf while #90 is In Progress.**
