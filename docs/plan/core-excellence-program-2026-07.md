...
**Sibling (next queue, not activated):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md)（IBL）— Task Master **#106–#134** registered backlog; waves **Not Started**; Wave D residuals **D01A+#135+#136** closed; audit P2 **#137** → **Done** (`baaf16cc` / `09cf85ce`; sole-active cleared); **next head (not activated)** = **IBL-A1** (#107) — do not fold into an In Progress CE/PRR leaf; do not activate without delivery-orchestrator.
