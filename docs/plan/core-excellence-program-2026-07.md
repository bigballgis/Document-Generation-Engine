...
**Sibling (NON-CE):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md)（IBL）— Wave **IBL-A** **In Progress** (A1 **Done** `#107` merge `f0a2b6fe`; A2–A6 Not Started); **sole-active cleared**; **#106** registry-only pending; next queue (not activated) **#108** IBL-A2 — do not fold into an In Progress CE leaf; do not flip **#3b/#5a GO**.
