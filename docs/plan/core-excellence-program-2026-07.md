...
**Sibling (NON-CE):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md)（IBL）— Wave **IBL-B** → **In Progress** (**#113** IBL-B1 **Done** `a33da272` / `44237c99`; **#114** IBL-B2 **Done** `29d022b6` / `3dd1aa60`+`36a9821c`; **#115** IBL-B3 **Done** `3710811a` / `c81054b0`+`e0102ddb`; **#116** IBL-B4 **Done** `610eb0fa` / `d6b389d1`+`d2e8a1c9`; **#117** IBL-B5 **Done** `1666312b` / `d7459405`+`fbb40429`; B6 pending; B7 Blocked; sole-active cleared; next **#118** not activated); Wave **IBL-A** → **Done** (A1–A6 **#107–#112 Done**; A6 tip `5cacff2a`); **#106** registry-only pending — do not fold into an In Progress CE leaf; do not flip **#3b/#5a GO**.
