...
| CE-U17 | 编辑器快捷键 | P3·S · `In Progress` | **In Progress (2026-07-17)** — Task Master **#96**; slice `ce-u17-editor-shortcuts`; **sole-active** delivery leaf (single-lane serial §9.2). P3 activated (user «继续» after P2 Done). BDD **ready** ([ce-u17-editor-shortcuts.md](../behavior/ce-u17-editor-shortcuts.md); **BDD-CE-U17-EKS-001…012**). Worktree `D:/working/DGE-ce-u17-editor-shortcuts` · `feat/ce-u17-editor-shortcuts`. Scope: Ctrl+S 保存绑定 / Ctrl+P 刷新预览；命令面板注册作者动作. Formal phase **None**；**not** go-live；**not** CD-3。 |
