...
**Sibling (NON-CE):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md)（IBL）— Wave **IBL-A** → **Done** (A1–A6 **#107–#112 Done**; A6 tip `5cacff2a`; Wave **IBL-B** **Not Started**; sole-active cleared; next **#113** not activated); **#106** registry-only pending — do not fold into an In Progress CE leaf; do not flip **#3b/#5a GO**.
