...
**Sibling (active NON-CE sole-active):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md)（IBL）— Wave **IBL-A** **In Progress** (A1 only); Task Master **#107** sole-active (`ibl-a1-variable-validation`); **#106** registry-only pending; **#108–#134** pending — do not fold into an In Progress CE leaf; do not flip **#3b/#5a GO**.
