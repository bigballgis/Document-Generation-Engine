...
| CE-U18 | 批量测试历史钻取 + 双路径统一 | P2·M · `In Progress` | **In Progress (2026-07-17)** — Task Master **#93** **sole-active** delivery leaf（§9.2）。Slice `ce-u18-batch-test-history`；worktree `D:/working/DGE-ce-u18-batch-test-history` · `feat/ce-u18-batch-test-history` · base `63985fb9`。Batch recommendation **solo** (`member_task_ids: ["93"]`)。BDD **WITH leaf**（stage 1 same leaf）。`sampleResultsJson` 前端消费（展开明细+跳转）；移除无进度 legacy 同步批量路径。Formal phase **None**；**not** go-live；**not** CD-3。 |
...
| 序 | CE-ID | Task # | 级 | 说明 |
| --- | --- | --- | --- | --- |
| **1（sole-active）** | **CE-U18** | **#93** | P2 | 批量测试历史钻取 — **In Progress**（deps U16 #92 **Done**；worktree active） |
| 2 | CE-U20 | #94 | P2 | 条款创建结构化化 — **pending** |
| 3 | CE-U21 | #95 | P2 | 草稿按锚点分 key — **pending** |
| 4+ | CE-E03 / U17+ / G05 | #80 / #96… / #77 | P3 | 全库导出、快捷键/依赖只读、年检 FTS — **parked**（P3） |

**已并入 main、勿再并行复开：** CE-U16 (#92) — merge `5d683c40` / feature `1a3d0f20` on `main`（2026-07-17；worktree removed）；CE-U15 (#91) — merge `b2968052` on `main`（2026-07-17；closeout `ed8a15e6`；worktree removed）；CE-U14 (#90) — merge `05e845e4` / feature `09e0d251` on `main`（2026-07-17）；CE-G04 (#75) — merge tip `42745ea5` / feature `b47ea896` on `main`（2026-07-16）；CE-O01 (#81) — merge `e081bcfa` on `main`（2026-07-16）；CE-E02 (#79) — merge `5bd3611e` on `main`（2026-07-16）；CE-E01 (#78) — merge `6ae57974` on `main`（2026-07-16）；CE-G06 (#76) — merge `d8636232` on `main`（2026-07-16）；CE-C06 (#71) — merge `35f6f47d` on `main`（2026-07-16）；CE-U13 (#89) — merge `ccdfacda` on `main`（2026-07-16）；CE-G03 (#74) — merge `50c1a524` on `main`（2026-07-16）；CE-K08 (#63) — `35f57503` on `main`。Task Master / 本文件状态应对齐 **Done**。 **Sole-active delivery leaf = #93 CE-U18**（umbrella **#53** is program registry, not a delivery leaf）。#94/#95 **pending**。P3 parked。Do **not** activate CD-3。Do **not** claim go-live。Leave **#50** alone。
