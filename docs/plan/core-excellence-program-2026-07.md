...
**Sibling (NON-CE):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md)（IBL）— Wave **IBL-C** → **In Progress** (**#120** IBL-C1 **Done** `55909dd2` / `d2492fc4`+`5d89b606`; **#121** IBL-C2 **Done** `1d357e4d` / `767b4ceb`+`abf564dc`; C3 pending; sole-active cleared; next **#122** not activated); Wave **IBL-B** → **In Progress** (B1–B6 **Done**; B7 Blocked residual); Wave **IBL-A** → **Done** (A1–A6 **#107–#112 Done**; A6 tip `5cacff2a`; prior **#118** Done `8722f4f1` / `8e8c62e6`); **#106** registry-only pending — do not fold into an In Progress CE leaf; do not flip **#3b/#5a GO**.
