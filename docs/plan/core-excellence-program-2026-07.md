...
**Sibling (NON-CE):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md)（IBL）— Wave **IBL-D** → **In Progress** (**#123** D1 **Done** `1a686938` / `f399489c` — F20 closed; **#124** D2 **Done** `21be3a99` / `4fd0c5da` — F21 closed; **#125** D3 **Done** `6b9b6487` / `0242084e` — F22 partial; D4–D5 Not Started; sole-active cleared; next queue note only **#126**); Wave **IBL-C** → **Done** (**#120–#122** C1–C3 **Done** — C3 `bdfc285d` / `dbfff086`; F19 honesty SYNTHETIC; LO residual → D2/F21); Wave **IBL-B** → **In Progress** (B1–B6 **Done**; B7 Blocked residual); Wave **IBL-A** → **Done** (A1–A6 **#107–#112 Done**; A6 tip `5cacff2a`; prior **#118** Done `8722f4f1` / `8e8c62e6`); **#106** registry-only pending — do not fold into an In Progress CE leaf; do not flip **#3b/#5a GO**; do not invent confirmed NFR SLOs.
