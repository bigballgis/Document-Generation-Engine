...
| 序 | CE-ID | Task # | 级 | 说明 |
| --- | --- | --- | --- | --- |
| **1（next deliver / queue head）** | **CE-G04** | **#75** | P2 | Legal hold 最小实现 — **pending**/parked（deps G03 #74 **Done**；P2 优先于 E03 P3；activate via deliver — sole-active currently **cleared**） |
