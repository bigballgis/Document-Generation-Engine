...
| CE-G05 | 模板年检 + 条款正文检索 | P3·M · `pending` | `nextReviewDue` + 到期待办；`content_structure_json` 全文检索（PostgreSQL tsvector）where-used。**Queue head (2026-07-17)** — Task Master **#77** **pending** only remaining P3 after **#80** Done；**sole-active cleared**；**do not** auto-activate。 | 无 |
...
| 序 | CE-ID | Task # | 级 | 说明 |
| --- | --- | --- | --- | --- |
| **queue head (pending)** | CE-G05 | #77 | P3·M | 年检 + 条款 FTS — **pending**（only remaining P3；**sole-active cleared**；勿自动激活） |
