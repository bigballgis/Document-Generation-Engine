...
| CE-U20 | 条款创建结构化化 + 列表状态列 | P2·S · `In Progress` | **In Progress (2026-07-17)** — Task Master **#94**; slice `ce-u20-clause-create-structured`; worktree `D:/working/DGE-ce-u20-clause-create-structured` · `feat/ce-u20-clause-create-structured` · base `origin/main` (`da7581e8`). **Sole-active** delivery leaf (§9.2). Batch recommendation **solo** (`member_task_ids: ["94"]`). Scope: 创建对话框弃 JSON textarea 改结构化编辑器；目录加状态列/筛选. BDD **ready** ([ce-u20-clause-create-structured.md](../behavior/ce-u20-clause-create-structured.md); **BDD-CE-U20-CCS**). Formal phase **None**; **not** go-live；**not** CD-3。#95 pending；P3 parked；leave #50 alone；#93 stays Done。 |
...
| 序 | CE-ID | Task # | 级 | 说明 |
| --- | --- | --- | --- | --- |
| **1（sole-active）** | **CE-U20** | **#94** | P2 | 条款创建结构化化 — **In Progress**（worktree `DGE-ce-u20-clause-create-structured`；deps U18 #93 **Done**） |
| 2 | CE-U21 | #95 | P2 | 草稿按锚点分 key — **pending**（do **not** auto-activate until U20 merge + MAIN doc-sync） |
| 3+ | CE-E03 / U17+ / G05 | #80 / #96… / #77 | P3 | 全库导出、快捷键/依赖只读、年检 FTS — **parked**（P3） |

**已并入 main、勿再并行复开：** CE-U18 (#93) — merge `05e9f8e1` / feature `e05407f2` on `main`（2026-07-17；worktree removed）；CE-U16 (#92) — merge `5d683c40` / feature `1a3d0f20` on `main`（2026-07-17；worktree removed）；CE-U15 (#91) — merge `b2968052` on `main`（2026-07-17；closeout `ed8a15e6`；worktree removed）；CE-U14 (#90) — merge `05e845e4` / feature `09e0d251` on `main`（2026-07-17）；CE-G04 (#75) — merge tip `42745ea5` / feature `b47ea896` on `main`（2026-07-16）；CE-O01 (#81) — merge `e081bcfa` on `main`（2026-07-16）；CE-E02 (#79) — merge `5bd3611e` on `main`（2026-07-16）；CE-E01 (#78) — merge `6ae57974` on `main`（2026-07-16）；CE-G06 (#76) — merge `d8636232` on `main`（2026-07-16）；CE-C06 (#71) — merge `35f6f47d` on `main`（2026-07-16）；CE-U13 (#89) — merge `ccdfacda` on `main`（2026-07-16）；CE-G03 (#74) — merge `50c1a524` on `main`（2026-07-16）；CE-K08 (#63) — `35f57503` on `main`。Task Master / 本文件状态应对齐 **Done**。 **Sole-active delivery leaf:** **#94** CE-U20（umbrella **#53** is program registry, not a delivery leaf）。**§9.2 next after U20:** **#95** CE-U21 **pending**。P3 parked。Do **not** activate CD-3。Do **not** claim go-live。Leave **#50** alone。
