...
| CE-U15 | 生命周期 Stepper + checklist 深链 | P2·M · `Not Started` | 顶栏状态机 Stepper；发布 gate 每条 pending 项"前往修复"链接。**§9.2 queue head** after U14 Done — Task Master **#91** **pending**/parked（do **not** auto-start）。 |
