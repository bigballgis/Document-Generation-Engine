...
- [ ] LR-C2/C3/C5…C8 shipped with BDD specs, functional Playwright journeys, and UIUX manifests (both brands) *(LR-C2 Done 2026-07-11 merge `12a6a7e`; **LR-C3 Done** 2026-07-11 merge `0cf553b`; C5/C7/C8 Not Started)*
...
- [ ] Ledger § LRP wave row updated with per-task evidence *(LR-C3 completion recorded 2026-07-11 merge `0cf553b`; C1/C4/C9–C13 + C2 + **C3** Done; **no sole-active LRP slice**; wave still partial — C5/C7/C8 Not Started)*
