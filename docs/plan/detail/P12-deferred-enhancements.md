...
> Single-active-phase invariant: **P22-DEMO-EXPANSION In Progress** (sole formal phase; activated 2026-07-03). Slice **P12-API-PACKAGE-ACCESS-INVOCATION Done** (2026-07-03 — T01–T12). Prior slice **P12-TEMPLATE-TESTING-OVERHAUL Done** (2026-07-03).
...
| **P13-EXTERNAL-SERVICES-EXCELLENCE** | External services excellence — IA convergence (single hub edit surface), full management invocation history, cross-package alerts, unified impact preview, OpenAPI completion, BDD S1–S8 + CD-E2E-T07/T13 (28 tasks, groups A–F) | **Not Started** | Gap audit 2026-07-07; plan: [P13-external-services-excellence.md](./P13-external-services-excellence.md); extends P12 BDD + new `management-invocation-history.md`, `api-access-cross-package-alerts.md` |

**Active slice:** **None** (P22-DEMO-EXPANSION is the sole formal phase In Progress). **Last completed:** **P12-API-PACKAGE-ACCESS-INVOCATION** (T01–T12 Done 2026-07-03).
