...
| F6 | Frontend kernel refactor | **Done** (2026-07-09; F6-T08 parity smoke **9/9** green) | [CORE-FORTRESS-f6-frontend-kernel-refactor.md](./CORE-FORTRESS-f6-frontend-kernel-refactor.md) |
