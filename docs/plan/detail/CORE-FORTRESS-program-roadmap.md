...
| F7 | Authoring UX (dirty guard, side-by-side preview) | **In Progress** (2026-07-09) | [CORE-FORTRESS-f7-authoring-ux.md](./CORE-FORTRESS-f7-authoring-ux.md) |
| F8 | Observability, SLO, DR, evidence bundle | Not Started | [CORE-FORTRESS-f8-observability-slo-dr.md](./CORE-FORTRESS-f8-observability-slo-dr.md) |
