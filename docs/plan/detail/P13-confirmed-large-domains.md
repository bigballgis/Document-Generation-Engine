# P13 — Confirmed Large Domains (Detailed Plan)
...
## P13-T01 Clause / content module lifecycle
...
| ID | Task | Status |
| --- | --- | --- |
| P13-T01a | Domain model + Flyway + repository | Not Started |
| P13-T01b | Management REST CRUD + lifecycle transitions | Not Started |
| P13-T01c | Template reference + impact analysis integration | Not Started |
| P13-T01d | Management UI (list, detail, lifecycle) | Not Started |

---

## P13-T02 Collaboration to-dos + timeout escalation
...
| ID | Task | Status |
| --- | --- | --- |
| P13-T02a | To-do entity + query API by role queue | Not Started |
| P13-T02b | Timeout config API (global + group override) | Not Started |
| P13-T02c | Escalation scheduler (no state mutation) | Not Started |
| P13-T02d | UI: to-do panels on workbenches + admin config | Not Started |

---

## P13-T03 Template export / import
...
| ID | Task | Status |
| --- | --- | --- |
| P13-T03a | Export service + management endpoint | Not Started |
| P13-T03b | Import service + validation + DRAFT landing | Not Started |
| P13-T03c | UI export/import on template detail + admin bulk | Not Started |

---

## Exit criteria (phase)

- All P13-T01…T03 tasks Done with real persistence (not in-memory).
