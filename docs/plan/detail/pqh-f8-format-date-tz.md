...
| Leaf status | **Done** |
| Formal phase | **None** |
| Host sole-active | **cleared** (Leaf 1 closed); next queue head TM **#161** N19–N20 (**pending** — not activated) |
| Program | PQH **In Progress** — Leaf 1 **Done**; Leaf 2 N19–N20 / Leaf 3 N22 queued; F7 parked |
...
| TM | Alias | Status |
| --- | --- | --- |
| **#161** | N19–N20 | **pending** (Leaf 2 — **next queue head**; not sole-active) |
