...
| --- | --- | --- |
| LR-A (rendering trust) | **In Progress** — A1–A4 **Done**; **A6 Done** (merge `122d6d1`; OOXML fail-closed); **A7 Done** (Docker PDF corpus; Word delta residual); A5 Partial (0042/0043) | LR-A6 merge `122d6d1`; LR-A4 merge `a523a09`; LR-A3 merge `e62c210`; ADR-0042/0043 Proposed (0041 deferred); CD-HARD-T03 Done executed-by-LR-A6; CD-HARD-T04 Done executed-by-LR-A7; evidence [lrp-a7-pagination](../evidence/lrp-a7-pagination/) |
