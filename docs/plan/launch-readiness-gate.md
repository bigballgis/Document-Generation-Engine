...
| LR-C (usability deepening) | **In Progress** (partial) — C1/C4/C9/C10/C11 **Done**; **C12 In Progress**; C2/C3/C5/C7/C8/C13 Not Started | LR-C12 sole-active (`lrp-c12-keyboard-a11y`; Task Master #27); LR-C11 merge `44fcf40` (parity **159/159**; architecture PASS_WITH_NOTES); LR-C10 merge `bdaf95d` (E2E 4/4; UIUX PASS_WITH_NOTES); LR-C9 merge `0013615`; F7 for C1/C4 |
...
- [ ] LR-C12: keyboard a11y (Enter/Space row activation, skip-link); a11y smoke green. **(In Progress 2026-07-11 — slice `lrp-c12-keyboard-a11y`; Task Master #27)**
