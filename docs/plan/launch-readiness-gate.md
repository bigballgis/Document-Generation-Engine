...
| LR-D (ops + data lifecycle) | **In Progress** (2026-07-12 — partial; **LR-D1+D7 Done**; **LR-D6 → In Progress** **sole-active**) | **LR-D6 In Progress** (`lrp-d6-load-smoke`; Task Master #37). **LR-D7 Done** (`c94a356`; Task Master #36; seam «Security forbidden-route audit» closed); **LR-D1 Done** (`20b2a76`; Task Master #35; ADR-0048 Accepted). D2–D5 Not Started — do not activate. |
