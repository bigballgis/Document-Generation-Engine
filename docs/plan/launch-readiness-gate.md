...
| LR-D (ops + data lifecycle) | **In Progress** (2026-07-12 — partial; **LR-D1+D7+D6 Done**; **no sole-active**) | **LR-D6 Done** (`56383eb`; Task Master #37; A: n=20 success=12 errorRate=0.4 DEF-LRP-D6-001; B: 5/5 SSE; DEPLOY_OK 2026-07-12T01:26:46+08:00). **LR-D7 Done** (`c94a356`; Task Master #36; seam «Security forbidden-route audit» closed); **LR-D1 Done** (`20b2a76`; Task Master #35; ADR-0048 Accepted). D2–D5 Not Started — do not activate. |
