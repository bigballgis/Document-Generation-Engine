...
> **IBL (Wave A In Progress):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (`IBL-*`); Task Master **#106** (umbrella, registry only, `pending`) + **#107–#134** (**28** leaves); **#107** IBL-A1 **`in-progress`** (sole-active); Wave **IBL-A** **In Progress** (A1 only); formal phase **None**; Wave D residuals **D01A+#135+#136** closed; audit P2 **#137** → **Done** (`baaf16cc` / `09cf85ce`). Slice `ibl-a1-variable-validation`. Do **not** invent a P-phase. Do **not** flip checklist **#3b GO** / **#5a GO**.
