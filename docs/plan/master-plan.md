...
> **IBL (proposal):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (`IBL-*`); program **Not Started**; formal phase **None**; do **not** activate without user confirmation.
