...
> **LRP:** [launch-readiness-program.md](./launch-readiness-program.md) — Waves LR-A…LR-E; task prefix **`LR-*`** only; **Wave LR-A Done** (2026-07-10; A1–A7; merge `cc9e5f6`); **LR-A5 Done** (`lrp-a5-adr-closeout`; **ADR-0041 Accepted**; 0042/0043 remain Proposed); Word/XSD/LO24 residuals deferred — do not invent Word numbers; **LR-C6 Done** (`lrp-c6-command-palette`; merge `c0c84aa`; Task Master #32; E2E 8/8); **LR-C5 Done** (`lrp-c5-catalog-pagination`; merge `5543a33`; Task Master #31; OPT-F4 residual closed); **LR-C3 Done** (`lrp-c3-editor-undo-redo`; merge `0cf553b`; Task Master #30); **LR-C2 Done** (`lrp-c2-local-draft-recovery`; merge `12a6a7e`; Task Master #29); **LR-C13 Done** (`lrp-c13-frontend-eng-debt`; merge `45addd6`; Task Master #28; OPT-G4/G5 closed); **LR-C12 Done** (`lrp-c12-keyboard-a11y`; merge `0357a16`; Task Master #27); **LR-C11 Done** (`lrp-c11-api-error-i18n`; merge `44fcf40`; parity **159/159**); **LR-C10 Done** (`lrp-c10-upload-ux`; merge `bdaf95d`); **LR-C9 Done** (`lrp-c9-load-error-panel`; merge `0013615`); **LR-C1/C4 Done** via CORE-FORTRESS F7; Wave LR-C **In Progress** partial (C1/C4/C9–C13 + **C2** + **C3** + **C5** + **C6** Done; C7/C8 Not Started; **no sole-active**). Formal phase remains **None** — do not promote LRP/CDP to a formal phase row. Do **not** activate C7/C8/CD-3. Do **not** mark Wave LR-C Done. Recommend next: **LR-C7** **OR** **LR-C8**.
