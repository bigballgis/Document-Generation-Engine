...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-24):** **#164** slim demo catalog keep bank-letters (`demo-catalog-keep-bank-letters`) → **Done** (MAIN tip/merge `0e6d0bad`; feature `6e8cc8b3`; worktree **REMOVED**; Batch **solo** closed; BDD **ready**/shipped [demo-catalog-keep-bank-letters.md](../behavior/demo-catalog-keep-bank-letters.md) **BDD-DEMO-KEEP-001…014**; `frontend_ui_in_scope=false`; Gates: `mvn verify` SUCCESS; FE lint/type-check/test/build GREEN; `docker-deploy-queue` DEPLOY_OK; cleanup keep-8 PUBLISHED + `purge_absent`; **focused** Stage 6 demos E2E **14/14** (not full suite); arch/CQ **PASS_WITH_NOTES**; evidence [evidence/demo-catalog-keep-bank-letters/](evidence/demo-catalog-keep-bank-letters/); detail [detail/demo-catalog-keep-bank-letters.md](detail/demo-catalog-keep-bank-letters.md); **sole-active cleared**; formal phase **None**; vetoes held: checklist-#3b/#5a / CE-O02 / #53 / #106 / #119; follow-ups: orphan-SQL schema mismatch (BDD-004/005 not fully automated), cleanup-pagination, residual-e2e purged IDs). Prior **#163** PQH-F7 → **Done** (`b739a38f`; PQH program **Done**). Prior **#162** PQH N22 → **Done** (`ef1b505d` / `c5121164`). Prior **#161** PQH N19–N20 → **Done** (`20c67ac9` / `1e023a35`). Prior **#159**+**#160** PQH-CHARTER + PQH-F8 → **Done** (`ab382c02` / `ee0893fe`).
