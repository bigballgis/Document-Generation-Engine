...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-24):** **#165** fix abandoned STOPPED/DEPRECATED blocking Clone (`fix-abandoned-dev-blocks-clone`) → **In Progress** (sole-active; ISOLATED `D:/working/DGE-fix-abandoned-dev-blocks-clone` · `feat/fix-abandoned-dev-blocks-clone`; base_sha `79dfb64b`; Batch **solo** `member_task_ids: ["165"]`; BDD **ready** [fix-abandoned-dev-blocks-clone.md](../behavior/fix-abandoned-dev-blocks-clone.md) **BDD-FIX-ABANDON-CLONE-001…005**; `frontend_ui_in_scope=true`; detail [detail/fix-abandoned-dev-blocks-clone.md](detail/fix-abandoned-dev-blocks-clone.md); formal phase **None**; vetoes held: checklist-#3b/#5a / CE-O02 / #53 / #106 / #119). Prior **#164** slim demo catalog keep bank-letters → **Done** (`0e6d0bad` / `6e8cc8b3`). Prior **#163** PQH-F7 → **Done** (`b739a38f`; PQH program **Done**). Prior **#162** PQH N22 → **Done** (`ef1b505d` / `c5121164`). Prior **#161** PQH N19–N20 → **Done** (`20c67ac9` / `1e023a35`). Prior **#159**+**#160** PQH-CHARTER + PQH-F8 → **Done** (`ab382c02` / `ee0893fe`).
