...
> **LRP:** [launch-readiness-program.md](./launch-readiness-program.md) — Waves LR-A…LR-E; task prefix **`LR-*`** only; **Wave LR-A Done** (2026-07-10; A1–A7; merge `cc9e5f6`); **LR-A5 Done** (`lrp-a5-adr-closeout`; **ADR-0041 Accepted**; 0042/0043 remain Proposed); Word/XSD/LO24 residuals deferred — do not invent Word numbers; **Wave LR-C Done** (2026-07-11 — C1–C13; merge tip `bf9cbeb`); **Wave LR-D → In Progress** — **LR-D5 Done** (`5b13476`; Task Master #38; NFR proposals pending confirmation — **not** confirmed SLOs); **LR-D6 Done** (`56383eb`; Task Master #37); **LR-D7 Done** (`c94a356`; Task Master #36; seam closed); **LR-D1 Done** (`20b2a76`; Task Master #35; ADR-0048 Accepted); **LR-D2 → In Progress** sole-active (`lrp-d2-backup-restore`; Task Master #39; base `362a556`); **D3/D4 Not Started**; LR-E **Not Started**. Formal phase remains **None** — do not promote LRP/CDP to a formal phase row. Do **not** activate D3/D4/LR-E/CD-3.
