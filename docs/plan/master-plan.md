...
**Active formal phase:** **P21** (activated 2026-06-29; **cluster ① journeys Done** T03–T05; next **P21-T06 Not Started**). User sequence P14 → P15 → P18 **complete**.
...
sub-phase A cluster ① Done (T03–T05); next **P21-T06 Not Started**; remaining approval-path closure → P21-T07).
