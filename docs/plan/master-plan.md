...
> **IBL (registered TM backlog):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (`IBL-*`); Task Master **#106** (umbrella, registry only) + **#107–#134** (**28** leaves, all `pending`); program **Registered / Not Started** (waves **not** activated); formal phase **None**; deferred while dashboard Wave D residual remains ahead after **#135** D01B **Done** `6e776232` / `1ada6b41` and **#104** D01A **Done** `f1f79d14` (or explicit user redirect); next IBL head after remaining PRR = **IBL-A1** (#107). Merge `9fc2bc97`. Do **not** invent a P-phase. Do **not** flip checklist **#3b GO**. Do **not** activate IBL while dashboard residual remains ahead.
