...
> **IBL (registered TM backlog):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (`IBL-*`); Task Master **#106** (umbrella, registry only) + **#107–#134** (**28** leaves, all `pending`); program **Registered / Not Started** (waves **not** activated); formal phase **None**; deferred until PRR **#104** Wave D bag completes (now **sole-active** as **D01A** — ResilienceFailureMapper + PDF pool; Wave D **SPLIT**; residual follow-on) or explicit user redirect; next IBL head after PRR = **IBL-A1** (#107). Merge `9fc2bc97`. Do **not** invent a P-phase. Do **not** flip checklist **#3b GO**. Do **not** activate IBL while #104 is sole-active.
