...
>
> **FOS (frontline operability — plan registered 2026-07-26):** [frontline-operability-solidity-program-2026-07.md](./frontline-operability-solidity-program-2026-07.md) — NON-CE remediation (**Not Started**, plan only); TM **#170** umbrella + **#171–#184** leaves **pending**; task prefix **`FOS-*`** / slice ids `fos-*`; **CRCH W4 superseded**; do **not** auto-activate; do **not** invent features; formal phase **None**.
>
