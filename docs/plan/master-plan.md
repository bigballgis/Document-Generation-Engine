...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-26):** **#166** AI-SCALE-G1 governance leaf (`ai-scale-remediation-g1`) → **Done** (MAIN tip/merge `c4f1b0d4`; worktree **REMOVED**; Batch **solo** closed; `delivery_lane: light`; BDD **ready**/shipped [module-map-agent-retrieval.md](../behavior/module-map-agent-retrieval.md) · [lightweight-delivery-lane.md](../behavior/lightweight-delivery-lane.md) · [ai-scale-docs-conventions.md](../behavior/ai-scale-docs-conventions.md); Gates: architecture **PASS**; stages **5–7**/10 **N/A** light lane; program [ai-scale-remediation-program-2026-07.md](ai-scale-remediation-program-2026-07.md) Leaf 1 **Done** / program **In Progress**; detail [detail/ai-scale-remediation-g1.md](detail/ai-scale-remediation-g1.md); **sole-active cleared**; next queue head **#167** **pending** — do **not** auto-activate; queued peels **#167–#169** **pending**; formal phase **None**; vetoes: unrelated-code-peel / file-cap / risk-domain-split / checklist-#3b/#5a / CE-O02 / #53 / #106 / #119). Prior **#165** fix abandoned Clone → **Done** (`c1bb6c77` / `cfefbb55`). Prior **#164** slim demo catalog keep bank-letters → **Done** (`0e6d0bad` / `6e8cc8b3`). Prior **#163** PQH-F7 → **Done** (`b739a38f`; PQH program **Done**). Prior **#162** PQH N22 → **Done** (`ef1b505d` / `c5121164`). Prior **#161** PQH N19–N20 → **Done** (`20c67ac9` / `1e023a35`). Prior **#159**+**#160** PQH-CHARTER + PQH-F8 → **Done** (`ab382c02` / `ee0893fe`).
