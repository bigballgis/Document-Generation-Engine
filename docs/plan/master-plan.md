...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-23):** **#162** PQH N22 Catalog row actions (`pqh-n22-catalog-row-actions`) → **Done** (MAIN tip/merge `e60b488f`; Stage 10 tip `c0cc57a0`; worktree **REMOVED**; Batch **solo** `member_task_ids:["162"]` **closed**; BDD **ready**/shipped [pqh-n22-catalog-row-actions.md](../behavior/pqh-n22-catalog-row-actions.md) **BDD-PQH-N22-001…014**; `frontend_ui_in_scope=true`; `backend_api_contract_change=false`; detail [detail/pqh-n22-catalog-row-actions.md](detail/pqh-n22-catalog-row-actions.md); program [post-queue-hardening-program-2026-07.md](post-queue-hardening-program-2026-07.md) Leaf 3 **Done** / Leaf 1–3 **Done** / program **In Progress** (F7 **#163** parked); Gates: FE lint/type-check/test/build **GREEN**; E2E **7/7**; UIUX **PASS** Critical=0; architecture **PASS_WITH_NOTES** Critical=0 `merge_go=true`; Stage 5+10 **DEPLOY_OK**; **sole-active cleared**; SYS-NORM N22 residual → **Done under PQH**; Waves **0–8** stay **Done**; vetoes: checklist-#3b/#5a / CE-O02 / #53 / #119 / F7-parked; formal phase **None**). Prior **#161** PQH N19–N20 EntityLink → **Done** (`20c67ac9` / `1e023a35`). Prior **#159**+**#160** PQH-CHARTER + PQH-F8 → **Done** (`ab382c02` / `ee0893fe`).
