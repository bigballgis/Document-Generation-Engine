...
> **IBL (Wave A In Progress):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (`IBL-*`); Task Master **#106** (umbrella, registry only, `pending`) + **#107–#134** (**28** leaves); **#107** IBL-A1 → **Done** (`f0a2b6fe` / `4bda5f2d`); **#108** IBL-A2 → **Done** (`e3000479` / `89584242`); **#109** IBL-A3 → **Done** (`779b1979` / `f09326ca`); **#110** IBL-A4 → **Done** (`ddf6601c` / `6edb41cd`); **#111** IBL-A5 → **In Progress** (sole-active; `ibl-a5-pii-retention-redaction`); Wave **IBL-A** **In Progress** (A1–A4 Done; A5 In Progress; A6 Not Started); formal phase **None**; Wave D residuals **D01A+#135+#136** closed; audit P2 **#137** → **Done** (`baaf16cc` / `09cf85ce`). Do **not** invent a P-phase. Do **not** flip checklist **#3b GO** / **#5a GO**. Do **not** mark Wave A / IBL program Done.
