...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-27):** **#167** AI-SCALE Leaf 2 TemplateImport* peel (`ai-scale-peel-template-import`) → **Done** (MAIN tip/merge `d02aa414`; feat `1f55a420`; worktree **REMOVED**; Batch **solo** closed; `delivery_lane: full`; BDD **ready**/shipped [ai-scale-template-import-peel.md](../behavior/ai-scale-template-import-peel.md) **TIP-01…08**; Gates: `mvn verify` exit **0**; Arch **PASS**; CQ **PASS**; stages **5–7**/10 **N/A**; program [ai-scale-remediation-program-2026-07.md](ai-scale-remediation-program-2026-07.md) Leaf 2 **Done** / program **In Progress**; detail [detail/ai-scale-template-import-peel.md](detail/ai-scale-template-import-peel.md); **sole-active cleared**; next queue head **#168** **pending** — do **not** activate; formal phase **None**; vetoes: unrelated-frontend-i18n / mega-test-split / checklist-#3b/#5a / CE-O02 / #53 / #106 / #119). Prior **#166** AI-SCALE-G1 → **Done** (`c4f1b0d4`). Prior **#165** fix abandoned Clone → **Done** (`c1bb6c77` / `cfefbb55`). Prior **#164** slim demo catalog keep bank-letters → **Done** (`0e6d0bad` / `6e8cc8b3`). Prior **#163** PQH-F7 → **Done** (`b739a38f`; PQH program **Done**). Prior **#162** PQH N22 → **Done** (`ef1b505d` / `c5121164`). Prior **#161** PQH N19–N20 → **Done** (`20c67ac9` / `1e023a35`). Prior **#159**+**#160** PQH-CHARTER + PQH-F8 → **Done** (`ab382c02` / `ee0893fe`).
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-26):** **FOS plan on main** — [frontline-operability-solidity-program-2026-07.md](frontline-operability-solidity-program-2026-07.md) (**Not Started**, plan only; TM **#170**+**#171–#185** **pending**). Prior **CRCH W0+W1** → **Done** (`ad7f6d49` / `9d8e1a16`). Next product **#171**. OD-FOS-1…4 / CRCH OD-1/OD-2 **resolved**. Prior **#167** → **Done** (`d02aa414`). Prior **#166** → **Done** (`c4f1b0d4`). Formal phase **None**; vetoes: checklist-#3b/#5a / CE-O02 / #53 / #106 / #119 / no-new-features.
...
>
> **FOS (frontline operability — plan on main 2026-07-26):** [frontline-operability-solidity-program-2026-07.md](./frontline-operability-solidity-program-2026-07.md) — NON-CE remediation (**Not Started**, plan only); TM **#170**+**#171–#185** **pending**; **CRCH W4 superseded**; next product **#171**; do **not** invent features; formal phase **None**.
>
> **CDP (delivery focus):** [competitiveness-deepening-program.md](./competitiveness-deepening-program.md) — Wave **CD-0 Done**; Wave **CD-2 Done** (2026-07-11; T01–T13, merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b` / `55a6ab6` / `b16e52a` / `6e3f825` / `f12b193` / `b2b0899`); Wave **CD-3 Done** (2026-07-20; CD-HARD-T01–T06; **#140** merge `b933965c`; sole-active **cleared**; **not** go-live); task prefix **`CD-*`** only.
> **IBL (Wave E Done + D Done + C Done + B residual):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (IBL-*); Task Master **#106** (umbrella, registry only, pending) + **#107–#134** (**28** leaves); **#107–#112** IBL-A1–A6 → **Done**; **#113–#118** IBL-B1–B6 → **Done**; **#119** IBL-B7 **Blocked**; **#120–#127** IBL-C1–C3 + IBL-D1–D5 → **Done**; **#128** IBL-E1 → **Done** (`4c712b03` / `9decf19c`; F24 closed; PD-4…PD-9 confirmed 2026-07-19); **#129** IBL-E2 → **Done** (`81a1ca29` / `6a96e9ab`; F25 closed); **#130** IBL-E3 → **Done** (`233342d3` / `e81a6bac` / `3bd2cd87`; F26 closed); **#131** IBL-E4 → **Done** (`4d810395` / `212c6be9` / `d9f02036`; F27 document-brand half closed); **#132** IBL-E5 → **Done** (`688f9e58` / `20ead1ce` / `65613c4b`; F27 closed); **#133** IBL-E6 → **Done** (`dcc42c81` / `0e542c03` / `32b62136` / docs `a2501d48`; F28 closed); **#134** IBL-E7 → **Done** (`37239d68` / `68abc7c3`; F15 descope); Wave **IBL-E** → **Done** (E1–E7); dedicated **PD-6 `#138` → Done** (`73ab03cb`; F6 opt-in re-issue); dedicated **PD-7 `#139` → Done** (`b966874a`; pursue docs ADR-0069 + procurement; **Accepted ≠ embedding Done**; OUT of IBL-E); Wave **IBL-D** / **IBL-C** / **IBL-A** → **Done**; Wave **IBL-B** → **In Progress** (B7 Blocked residual); CDP sole-active **cleared** (#140 Done; not IBL); formal phase **None**; do **not** invent fonts; do **not** invent a P-phase; do **not** flip checklist **#3b GO** / **#5a GO**; do **not** invent confirmed NFR SLOs; do **not** claim embedding / Wave B / IBL program Done.
> **LRP:** [launch-readiness-program.md](./launch-readiness-program.md) — Waves LR-A…LR-E; task prefix **`LR-*`** only; **Wave LR-A Done** (2026-07-10; A1–A7; merge `cc9e5f6`); **LR-A5 Done** (`lrp-a5-adr-closeout`; **ADR-0041 Accepted**; **0042/0043 Accepted** 2026-07-18 PRR-C01 #103 with Path X / slice B residuals); Word Path E / XSD/LO24 residuals remain — do not invent Word numbers; **Wave LR-C Done** (2026-07-11 — C1–C13; merge tip `bf9cbeb`); **Wave LR-D Done** (2026-07-12 — D1–D7; merge tip `218dcf1`); **Wave LR-E Done** (2026-07-12 — E1 merge `575d0aa` #42; E2 merge `ae39fbb` #43; docs gate; checklist overall **CONDITIONAL** 2026-07-18 — **not** production go-live); **LRP planned waves → Done**; **no sole-active LRP wave**; **OPS-PASTE-BINDING-SEAM → Done** (Task Master **#47**; merge `f1f00da`; checklist #5b → **GO**; CD-HARD-T05 Done — not an LRP wave). **LR-D4 Done** (`218dcf1`; feature tip `670a683`; Task Master #41; ADR-0049 Accepted; mvn verify GREEN 1321; DEPLOY_OK 2026-07-12T04:18:13+08:00). **LR-D3 Done** (`ba5ea2e`; #40); **LR-D5 Done** (`5b13476`; #38; NFR proposals pending — **not** confirmed SLOs); **LR-D6 Done** (`56383eb`; #37); **LR-D7 Done** (`c94a356`; #36); **LR-D1 Done** (`20b2a76`; #35); **LR-D2 Done** (`3d78bc5`; #39). Do **not** claim production go-live. Sibling CDP: Wave **CD-3 Done** (**#140** `b933965c`; sole-active cleared). Do **not** touch `DGE-audit-governance`.
