...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-27):** **#168** AI-SCALE Leaf 3 i18n locale domain split (`ai-scale-peel-i18n`) → **Done** (MAIN tip/merge `ce47186a` / feat `0a5e928e`; worktree **REMOVED**; Batch **solo** closed; `delivery_lane: light`; BDD **ready**/shipped [ai-scale-i18n-locale-split.md](../behavior/ai-scale-i18n-locale-split.md) **I18N-01…09**; Gates: FE lint/type-check/test/build **PASS**; `localeDomainSplit.test.ts` **5/5**; Arch **PASS**; CQ **PASS**; stages **5–7**/10 **N/A**; program [ai-scale-remediation-program-2026-07.md](ai-scale-remediation-program-2026-07.md) Leaf 3 **Done** / program **In Progress**; detail [detail/ai-scale-i18n-locale-split.md](detail/ai-scale-i18n-locale-split.md); **sole-active cleared**; next **#169** **pending** — do **not** activate/fold). **FOS** **In Progress** — **#171–#180** → **Done** (`8dfdb0ba`…`89ff4d95` / `3c0bae0e`); next FOS **#181** `fos-policy-impact-troubleshoot`. Prior **CRCH W0+W1** → **Done** (`ad7f6d49`). OD-FOS-1…4 / CRCH OD-1/OD-2 **resolved**. Formal phase **None**; vetoes: mega-test-split / backend-domain / checklist-#3b/#5a / CE-O02 / #53 / #106 / #119 / no-new-features.
...
>
> **FOS (frontline operability — 2026-07-26):** [frontline-operability-solidity-program-2026-07.md](./frontline-operability-solidity-program-2026-07.md) — NON-CE remediation (**In Progress**); **#171** → **Done**; next **#172**; **CRCH W4 superseded**; do **not** invent features; formal phase **None**.
>
