...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-27):** **#168** AI-SCALE Leaf 3 i18n locale domain split (`ai-scale-peel-i18n`) → **In Progress** / **sole-active** (worktree `D:/working/DGE-ai-scale-peel-i18n` · `feat/ai-scale-peel-i18n`; Batch **solo** open; `delivery_lane: light`; BDD **ready** [ai-scale-i18n-locale-split.md](../behavior/ai-scale-i18n-locale-split.md) **I18N-01…09**; stages **5–7**/10 **N/A**; program [ai-scale-remediation-program-2026-07.md](ai-scale-remediation-program-2026-07.md) Leaf 3 **In Progress**; detail [detail/ai-scale-i18n-locale-split.md](detail/ai-scale-i18n-locale-split.md); next **#169** **pending** — do **not** activate/fold). **FOS** **In Progress** — **#171–#175** → **Done** (`8dfdb0ba`…`19f4f917`); next FOS **#176** `fos-lifecycle-cannot-corrupt` queued. Prior **CRCH W0+W1** → **Done** (`ad7f6d49`). OD-FOS-1…4 / CRCH OD-1/OD-2 **resolved**. Formal phase **None**; vetoes: mega-test-split / backend-domain / checklist-#3b/#5a / CE-O02 / #53 / #106 / #119 / no-new-features.
