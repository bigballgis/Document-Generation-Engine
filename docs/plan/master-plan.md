...
> **IBL (Wave D Done + C Done + B In Progress):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (`IBL-*`); Task Master **#106** (umbrella, registry only, `pending`) + **#107–#134** (**28** leaves); **#107–#112** IBL-A1–A6 → **Done** (A6 tip `5cacff2a`); **#113** IBL-B1 → **Done** (`a33da272` / `44237c99`); **#114** IBL-B2 → **Done** (`29d022b6` / `3dd1aa60`+`36a9821c`); **#115** IBL-B3 → **Done** (`3710811a` / `c81054b0`+`e0102ddb`); **#116** IBL-B4 → **Done** (`610eb0fa` / `d6b389d1`+`d2e8a1c9`); **#117** IBL-B5 → **Done** (`1666312b` / `d7459405`+`fbb40429`); **#118** IBL-B6 → **Done** (`8722f4f1` / `8e8c62e6`); **#120** IBL-C1 → **Done** (`55909dd2` / `d2492fc4`+`5d89b606`); **#121** IBL-C2 → **Done** (`1d357e4d` / `767b4ceb`+`abf564dc`); **#122** IBL-C3 → **Done** (`bdfc285d` / `dbfff086`; F19 honesty SYNTHETIC; LO residual → D2/F21); **#123** IBL-D1 → **Done** (`1a686938` / `f399489c`; F20 closed — opt-in TC+Flyway; default H2 retained); **#124** IBL-D2 → **Done** (`21be3a99` / `4fd0c5da`; F21 closed — opt-in `-Plibreoffice-ci` fail-not-skip; default optional skip retained); **#125** IBL-D3 → **Done** (`6b9b6487` / `0242084e`; F22 load half — dry-run residual); **#126** IBL-D4 → **Done** (`94cc8eeb` / `94526674`; F22 closed with D3); Wave **IBL-A** → **Done**; Wave **IBL-C** → **Done** (C1+C2+C3); Wave **IBL-B** → **In Progress** (B1–B6 Done; B7 Blocked residual); **#127** IBL-D5 → **Done** (6f672271 / 2e56787e; F23 legalhold half closed; Playwright residual OUT); Wave **IBL-D** → **Done** (D1–D5); sole-active cleared; residual = B7 Blocked OR Wave E BLOCKED (not activated); formal phase **None**; do **not** invent a P-phase; do **not** flip checklist **#3b GO** / **#5a GO**; do **not** invent confirmed NFR SLOs; do **not** claim Wave B / IBL program Done.
> **LRP:** [launch-readiness-program.md](./launch-readiness-program.md) — Waves LR-A…LR-E; task prefix **`LR-*`** only; **Wave LR-A Done** (2026-07-10; A1–A7; merge `cc9e5f6`); **LR-A5 Done** (`lrp-a5-adr-closeout`; **ADR-0041 Accepted**; **0042/0043 Accepted** 2026-07-18 PRR-C01 #103 with Path X / slice B residuals); Word Path E / XSD/LO24 residuals remain — do not invent Word numbers; **Wave LR-C Done** (2026-07-11 — C1–C13; merge tip `bf9cbeb`); **Wave LR-D Done** (2026-07-12 — D1–D7; merge tip `218dcf1`); **Wave LR-E Done** (2026-07-12 — E1 merge `575d0aa` #42; E2 merge `ae39fbb` #43; docs gate; checklist overall **CONDITIONAL** 2026-07-18 — **not** production go-live); **LRP planned waves → Done**; **no sole-active LRP wave**; **OPS-PASTE-BINDING-SEAM → Done** (Task Master **#47**; merge `f1f00da`; checklist #5b → **GO**; CD-HARD-T05 Done — not an LRP wave; **no sole-active**). **LR-D4 Done** (`218dcf1`; feature tip `670a683`; Task Master #41; ADR-0049 Accepted; mvn verify GREEN 1321; DEPLOY_OK 2026-07-12T04:18:13+08:00). **LR-D3 Done** (`ba5ea2e`; #40); **LR-D5 Done** (`5b13476`; #38; NFR proposals pending — **not** confirmed SLOs); **LR-D6 Done** (`56383eb`; #37); **LR-D7 Done** (`c94a356`; #36); **LR-D1 Done** (`20b2a76`; #35); **LR-D2 Done** (`3d78bc5`; #39). Do **not** claim production go-live. Do **not** activate CD-3. Do **not** touch `DGE-audit-governance`.
