...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-24):** **#164** slim demo catalog keep bank-letters (`demo-catalog-keep-bank-letters`) → **In Progress** (**sole-active** NON-CE ops-demo leaf; Batch **solo**; BDD **ready** [demo-catalog-keep-bank-letters.md](../behavior/demo-catalog-keep-bank-letters.md) **BDD-DEMO-KEEP-001…014**; `frontend_ui_in_scope=false`; placement **ISOLATED** `D:/working/DGE-demo-catalog-keep-bank-letters` · `feat/demo-catalog-keep-bank-letters`; base MAIN tip `719538b9`; detail [detail/demo-catalog-keep-bank-letters.md](detail/demo-catalog-keep-bank-letters.md); formal phase **None**; vetoes held: checklist-#3b/#5a / CE-O02 / #53 / #106 / no-frontend-unless-empty-state). Prior **#163** PQH-F7 → **Done** (`b739a38f`; PQH program **Done**; sole-active cleared before this leaf). Prior **#162** PQH N22 → **Done** (`ef1b505d` / `c5121164`). Prior **#161** PQH N19–N20 → **Done** (`20c67ac9` / `1e023a35`). Prior **#159**+**#160** PQH-CHARTER + PQH-F8 → **Done** (`ab382c02` / `ee0893fe`).
