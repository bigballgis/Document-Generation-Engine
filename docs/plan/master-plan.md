...
**Active formal phase:** **P21** (activated 2026-06-29; **P21-T08 Done** 2026-06-30; next **P21-T09 Not Started** — Team-lead / API management journey). User sequence P14 → P15 → P18 **complete**.
...
sub-phase A cluster ① Done (T03–T05); **P21-T07 Done**; **P21-T08 Done** (cluster ② B1 Approver journey + AUD-B03); next **P21-T09 Not Started** (Team-lead / API management journey).
