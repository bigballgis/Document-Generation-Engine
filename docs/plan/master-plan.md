...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-24):** **#165** fix abandoned STOPPED/DEPRECATED blocking Clone (`fix-abandoned-dev-blocks-clone`) → **Done** (MAIN tip/merge `c1bb6c77`; feature `cfefbb55`; worktree **REMOVED**; Batch **solo** closed; BDD **ready**/shipped [fix-abandoned-dev-blocks-clone.md](../behavior/fix-abandoned-dev-blocks-clone.md) **BDD-FIX-ABANDON-CLONE-001…005**; Gates: `mvn verify` **GREEN 2406**; Docker version-lines evidence `DEMO-COVENANT-WAIVER` PUBLISHED `1.0.0` `cloneable=true` + abandoned `STOPPED` honest; E2E/UIUX **N/A** (FE untouched); evidence [evidence/fix-abandoned-dev-blocks-clone/](evidence/fix-abandoned-dev-blocks-clone/); detail [detail/fix-abandoned-dev-blocks-clone.md](detail/fix-abandoned-dev-blocks-clone.md); **sole-active cleared**; formal phase **None**; vetoes held: checklist-#3b/#5a / CE-O02 / #53 / #106 / #119). Prior **#164** slim demo catalog keep bank-letters → **Done** (`0e6d0bad` / `6e8cc8b3`). Prior **#163** PQH-F7 → **Done** (`b739a38f`; PQH program **Done**). Prior **#162** PQH N22 → **Done** (`ef1b505d` / `c5121164`). Prior **#161** PQH N19–N20 → **Done** (`20c67ac9` / `1e023a35`). Prior **#159**+**#160** PQH-CHARTER + PQH-F8 → **Done** (`ab382c02` / `ee0893fe`).
