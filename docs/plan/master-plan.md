...
**Active formal phase:** **P21** (activated 2026-06-29; **P21-T09a Done** 2026-06-30; next **P21-T09b Not Started** — reminder timing config). User sequence P14 → P15 → P18 **complete**.
...
sub-phase A cluster ① Done (T03–T05); **P21-T07 Done**; **P21-T08 Done** (cluster ② B1 Approver journey + AUD-B03); **P21-T09 Done** (cluster ② B2 Team-lead go-live journey); **P21-T09a Done** (API management L1 copy); next **P21-T09b Not Started** (reminder timing config).
