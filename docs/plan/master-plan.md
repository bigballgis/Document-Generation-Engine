...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-27):** **#167** AI-SCALE Leaf 2 TemplateImport* peel (`ai-scale-peel-template-import`) → **In Progress** sole-active (ISOLATED `D:/working/DGE-ai-scale-peel-template-import` · `feat/ai-scale-peel-template-import`; Batch **solo**; `delivery_lane: full`; BDD **ready** [ai-scale-template-import-peel.md](../behavior/ai-scale-template-import-peel.md) **TIP-01…08**; program [ai-scale-remediation-program-2026-07.md](ai-scale-remediation-program-2026-07.md) Leaf 2 **In Progress** / program **In Progress**; detail [detail/ai-scale-template-import-peel.md](detail/ai-scale-template-import-peel.md); stages **5–7**/10 **N/A-eligible** if zero FE + zero OpenAPI/runtime contract change; queued **#168–#169** **pending** — do **not** activate; formal phase **None**; vetoes: unrelated-frontend-i18n / mega-test-split / checklist-#3b/#5a / CE-O02 / #53 / #106 / #119). Prior **#166** AI-SCALE-G1 → **Done** (`c4f1b0d4`). Prior **#165** fix abandoned Clone → **Done** (`c1bb6c77` / `cfefbb55`). Prior **#164** slim demo catalog keep bank-letters → **Done** (`0e6d0bad` / `6e8cc8b3`). Prior **#163** PQH-F7 → **Done** (`b739a38f`; PQH program **Done**). Prior **#162** PQH N22 → **Done** (`ef1b505d` / `c5121164`). Prior **#161** PQH N19–N20 → **Done** (`20c67ac9` / `1e023a35`). Prior **#159**+**#160** PQH-CHARTER + PQH-F8 → **Done** (`ab382c02` / `ee0893fe`).
