...
**Active formal phase / program:** **None** (2026-07-09+). **Delivery focus note (2026-07-26):** **FOS plan registered** — [frontline-operability-solidity-program-2026-07.md](frontline-operability-solidity-program-2026-07.md) (**Not Started**, plan only; TM **#170** umbrella + **#171–#185** leaves **pending**; **sole-active cleared** — do **not** auto-activate). Absorbs **CRCH W4** (authoring IA). Upstream preferred next product leaf remains **CRCH W0+W1** `render-p0-preview-dedupe` when scheduled; then FOS Leaf 1 `fos-screens-tell-truth` (**#171**). **OD-FOS-1…4 / CRCH OD-1/OD-2 resolved** (2026-07-26): inline seals; PDF stamp default OFF; no PENDING_RELEASE→DRAFT; credential rotation grace **28 days** (ADR-0009 amended). Prior **#166** AI-SCALE-G1 → **Done** (`c4f1b0d4`; program **In Progress**; peels **#167–#169** **pending** — do **not** auto-activate). Prior **#165** fix abandoned Clone → **Done** (`c1bb6c77` / `cfefbb55`). Prior **#164** slim demo catalog → **Done** (`0e6d0bad`). Prior **#163** PQH-F7 → **Done** (`b739a38f`; PQH **Done**). Formal phase **None**; vetoes held: checklist-#3b/#5a / CE-O02 / #53 / #106 / #119 / invent-P-phase / no-new-features.
...
>
> **FOS (frontline operability — plan registered 2026-07-26):** [frontline-operability-solidity-program-2026-07.md](./frontline-operability-solidity-program-2026-07.md) — NON-CE remediation (**Not Started**, plan only); TM **#170** umbrella + **#171–#185** leaves **pending**; task prefix **`FOS-*`** / slice ids `fos-*`; **CRCH W4 superseded**; do **not** auto-activate; do **not** invent features; formal phase **None**.
>
