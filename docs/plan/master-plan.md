...
> **IBL (Wave C + B In Progress):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (`IBL-*`); Task Master **#106** (umbrella, registry only, `pending`) + **#107–#134** (**28** leaves); **#107–#112** IBL-A1–A6 → **Done** (A6 tip `5cacff2a`); **#113** IBL-B1 → **Done** (`a33da272` / `44237c99`); **#114** IBL-B2 → **Done** (`29d022b6` / `3dd1aa60`+`36a9821c`); **#115** IBL-B3 → **Done** (`3710811a` / `c81054b0`+`e0102ddb`); **#116** IBL-B4 → **Done** (`610eb0fa` / `d6b389d1`+`d2e8a1c9`); **#117** IBL-B5 → **Done** (`1666312b` / `d7459405`+`fbb40429`); **#118** IBL-B6 → **Done** (`8722f4f1` / `8e8c62e6`); **#120** IBL-C1 → **Done** (`55909dd2` / `d2492fc4`+`5d89b606`); Wave **IBL-A** → **Done**; Wave **IBL-C** → **In Progress** (C1 Done; C2/C3 pending; sole-active cleared; next **#121** not activated); Wave **IBL-B** → **In Progress** (B1–B6 Done; B7 Blocked residual); formal phase **None**; do **not** invent a P-phase; do **not** flip checklist **#3b GO** / **#5a GO**; do **not** claim IBL program Done.
