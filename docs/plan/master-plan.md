...
> **IBL (Wave B In Progress):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (`IBL-*`); Task Master **#106** (umbrella, registry only, `pending`) + **#107–#134** (**28** leaves); **#107–#112** IBL-A1–A6 → **Done** (A6 tip `5cacff2a`); Wave **IBL-A** → **Done**; Wave **IBL-B** → **In Progress**; **sole-active #113** IBL-B1 (`ibl-b1-direct-format-spacing`); formal phase **None**; do **not** invent a P-phase; do **not** flip checklist **#3b GO** / **#5a GO**; do **not** claim IBL program Done.
