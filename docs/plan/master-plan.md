...
> **IBL (Wave E In Progress + D Done + C Done + B residual):** [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) — international bank letter readiness (IBL-*); Task Master **#106** (umbrella, registry only, pending) + **#107–#134** (**28** leaves); **#107–#112** IBL-A1–A6 → **Done**; **#113–#118** IBL-B1–B6 → **Done**; **#119** IBL-B7 **Blocked**; **#120–#127** IBL-C1–C3 + IBL-D1–D5 → **Done**; **#128** IBL-E1 → **Done** (`4c712b03` / `9decf19c`; F24 closed; PD-4…PD-9 confirmed 2026-07-19); **#129** IBL-E2 → **Done** (`81a1ca29` / `6a96e9ab`; F25 closed); **#130–#134** pending (PD-unblocked, not activated); Wave **IBL-E** → **In Progress** (E1+E2 Done); Wave **IBL-D** / **IBL-C** / **IBL-A** → **Done**; Wave **IBL-B** → **In Progress** (B7 Blocked residual); sole-active **cleared**; formal phase **None**; do **not** invent a P-phase; do **not** flip checklist **#3b GO** / **#5a GO**; do **not** invent confirmed NFR SLOs; do **not** claim Wave B / Wave E / IBL program Done.
