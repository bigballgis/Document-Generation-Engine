...
| M9-T02/T03 intranet SCA; M10–M11 security closure | [m9-task-sheet.md](../architecture/m9-task-sheet.md) and m10/m11 siblings | SOR-C05 SBOM wiring **feeds** M9-T02; Task Master **#49** (`deps-security-refresh`) is related in-repo remediation hygiene — **does not** close M9-T02 or reopen SOR-C05 |
