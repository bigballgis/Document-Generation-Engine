...
| **CDP** (CD-DOC/CD-BDD/CD-E2E/CD-HARD, `CD-*`) | **Active sibling focus** — Wave CD-2 **In Progress** (**partial** — T01–T11 Done; T12/T13 Not Started; no sole-active) — track via [CDP program](./competitiveness-deepening-program.md) | **Nothing in LRP.** Do not execute `CD-*` from LRP session. LRP references CD-2/CD-3 as sibling waves only. |
...
**Next action (2026-07-11):** **LR-C10 Done** — no LRP task currently `In Progress`. Formal phase remains **None**. Wave LR-A **Done** (A1–A7); Word/XSD residuals remain deferred. Wave LR-C remains **In Progress** (partial — C1/C4/C9/C10 Done; C2/C3/C5/C7/C8/C11–C13 **Not Started**). Do **not** mark Wave LR-C Done. **Sibling CDP:** Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; **no sole-active CDP E2E slice** — do not execute from LRP). **Recommend next:** **LR-C11** (i18n `api.error` closure) or **LR-C12** (keyboard a11y) or **CD-3** (production pitfall hardening) — do **not** auto-activate any. LR-B residual follow-ups: browser-level SSE incremental proof → **LR-E1**; JWT_SECRET default-fallback guard → **LR-E2** launch checklist prerequisite.
