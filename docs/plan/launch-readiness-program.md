...
**Program ID:** `LRP`  
**Created:** 2026-07-03  
**Status:** **In Progress** (Wave LR-B **Done** 2026-07-04; Wave LR-A activated 2026-07-04; Wave LR-C partial — LR-C1/C4 **Done** via CORE-FORTRESS F7 2026-07-09). **Formal phase / program:** **None**. **Delivery focus note (2026-07-10):** **LR-A6 In Progress** (`lrp-a6-ooxml-gate`; OOXML output validation gate; executes CD-HARD-T03) — see [LRP-A detail](./detail/LRP-A-rendering-trust-hardening.md). **LR-A7 Done** (`lrp-a7-pagination-measure`; Docker PDF corpus; Word delta residual). **LR-A3/A4 Done** (`e62c210` / `a523a09`). Wave LR-A remains **In Progress** (A5 Partial; **A6 In Progress**). **Sibling:** CDP Wave CD-2 **partial** (T01/T01b Done, merge `1930842`; T02–T12 Not Started). **CODE-QUALITY Done** (2026-07-09); see [code-quality-program.md](./code-quality-program.md).  
...
| **LRP** (`LR-*` — production hardening + usability deepening) | **This program** — Wave LR-A **In Progress**; **LR-A6 In Progress** (OOXML gate); **LR-A7 Done** (Word delta residual) | LR-A…LR-E per §2 wave map; **LR-A3/A4/A7 Done**; A5 Partial; **A6 In Progress**. |
...
**Current wave:** **LR-A** (`In Progress`, activated 2026-07-04 after LR-B closure). **LR-A7 Done** (2026-07-10 — Docker PDF corpus; Word delta residual under ADR-0042). **LR-A4 Done** (2026-07-10 — merge `a523a09`). **LR-A3 Done** (2026-07-10 — merge `e62c210`). Remaining in wave: A5 Partial; A6 Not Started. **LR-B Done** (2026-07-04). Program status: **In Progress**. **Sibling:** CDP Wave CD-2 **partial** (T01/T01b Done; T02–T12 Not Started).
...
| LR-A6 | backend-engineer | OOXML output validation gate (executes CD-HARD-T03) | P22-T01 Done | not-applicable | CD-PIT-03 | **In Progress** (2026-07-10 — `lrp-a6-ooxml-gate`) |
...
**Next action (2026-07-10):** **LR-A6 In Progress** (`lrp-a6-ooxml-gate` — OOXML/output validation gate; executes CD-HARD-T03). Wave LR-A remains **In Progress** (A5 Partial; A6 In Progress). Do **not** start LR-C9 or expand A5 Word residual in this slice. **LR-A7 Done** (Docker PDF corpus; Word-vs-LO residual under ADR-0042 / LR-A5 — not a new In Progress task). Optional arch follow-up: pinned-module deep scan. **Sibling:** CDP CD-E2E-T01/T01b **Done** (merge `1930842`); CD-2 matrix T02–T12 continues when scheduled. Post-A6 candidates when scheduled: **LR-C9** or A5 Word residual on Word-equipped host. LR-B residual follow-ups: browser-level SSE incremental proof → **LR-E1**; JWT_SECRET default-fallback guard → **LR-E2** launch checklist prerequisite; zh-CN key backlog → **LR-C11**.
