...
**Next action (2026-07-12):** **OPS-AD-GROUP-STUB-CLOSE → In Progress** (Task Master **#46** **sole-active**; slice `ops-ad-group-stub-close`; base `ba0f1e1`). Next pipeline: **behavior-spec-author** (BDD required) → implement fail-closed / honest-bound AD Group stub + ADR → gates → doc-keeper updates checklist **#5a** only after evidence. Do **not** flip #5a at activation. Do **not** invent LDAP/AD. Prior: **OPS-KAFKA-COMPANY-REGISTRY → Done** (merge `e54d03c`; #45); checklist **#10** **CONDITIONAL**; **#9 JWT_SECRET → GO** (#44). LRP planned waves A–E **Done**. Formal phase remains **None**. Overall checklist remains **NO-GO**. Do **not** claim Done / production go-live. Do **not** activate CD-3. Do **not** touch `DGE-audit-governance`. NFR proposals remain pending confirmation — **not** confirmed SLOs. **Sibling CDP:** Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; CD-3 **Not Started**). Remaining blocking **NO-GO** items: **#3b** ADR-0042/0043+Word; **#5a** AD Group stub (this slice); **#5b** paste↔binding.
