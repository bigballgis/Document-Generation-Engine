...
| **LRP** (`LR-*` — production hardening + usability deepening) | **This program** — Wave LR-A **Done** (2026-07-10); **Wave LR-C Done** (2026-07-11 — C1–C13; merge tip `bf9cbeb`); **Wave LR-D Done** (2026-07-12 — D1–D7; merge tip `218dcf1`; Task Master #41 for D4); **Wave LR-E In Progress** (partial — **LR-E1 In Progress** sole-active Task Master #42; **LR-E2 Not Started**) | LR-A…LR-E per §2 wave map; A1–A7 Done; Word/XSD/LO24/0042-Accepted/0043-Accepted residuals deferred post-wave (0041 Accepted residual closed). |
...
- **Depends:** LR-B3.
- **Status:** **In Progress** (2026-07-12 — slice `lrp-e1-sse-proxy-e2e`; Task Master #42; **sole-active**; BDD **not-applicable**; scaffold `frontend/e2e/LRP-E1-sse-incremental-progress.spec.ts`; behavior note [lrp-e1-sse-proxy-e2e.md](../behavior/lrp-e1-sse-proxy-e2e.md); do **not** activate LR-E2)
...
- **Status:** Not Started (checklist artifact not yet authored; **LR-D2 drill input ready**; Wave LR-D **Done** — do **not** treat launch as Done)
