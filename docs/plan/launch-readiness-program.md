...
| **LRP** (`LR-*` — production hardening + usability deepening) | **This program** — Wave LR-A **Done** (2026-07-10); **Wave LR-C Done** (2026-07-11 — C1–C13; merge tip `bf9cbeb`); **Wave LR-D → In Progress** (partial — **LR-D1 Done** merge `20b2a76`; **LR-D7 Done** merge `c94a356`; **LR-D6 Done** merge `56383eb`; **LR-D5 Done** merge `5b13476`; **LR-D2 In Progress** sole-active Task Master #39; **D3/D4 Not Started**); LR-E **Not Started** | LR-A…LR-E per §2 wave map; A1–A7 Done; Word/XSD/LO24/0042-Accepted/0043-Accepted residuals deferred post-wave (0041 Accepted residual closed). |
...
| LR-D2 | deploy-engineer + doc-keeper | Backup/restore runbook + drill (pg, MinIO, Flyway forward-only) | — | not-applicable | ADR-0030 RPO≤15min/RTO≤30min | **In Progress** (2026-07-12 — slice `lrp-d2-backup-restore`; Task Master #39; sole-active; base `362a556`; F8 partial: runbook § DR + `artifacts/dr-drill/` convention Done 2026-07-09; annual drill still open) |
...
**Next action (2026-07-12):** **LR-D2 sole-active** — execute backup/restore runbook + timed drill via **doc-keeper** + **deploy-engineer** (Task Master #39; slice `lrp-d2-backup-restore`). Formal phase remains **None**. **Wave LR-D → In Progress** (partial — **LR-D1 Done** merge `20b2a76`; **LR-D7 Done** merge `c94a356`; **LR-D6 Done** merge `56383eb`; **LR-D5 Done** merge `5b13476`; **LR-D2 In Progress**; **D3/D4 Not Started**). NFR proposals authored as pending — **not** confirmed SLOs. Do **not** activate D3/D4/LR-E/CD-3. Do **not** touch `DGE-audit-governance`. **Sibling CDP:** Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; **no sole-active CDP E2E slice** — do not execute from LRP). LR-B residual follow-ups (later): browser-level SSE incremental proof → **LR-E1**; JWT_SECRET default-fallback guard → **LR-E2** launch checklist prerequisite.
