...
**Program ID:** `LRP`  
**Created:** 2026-07-03  
**Status:** **In Progress** (Wave LR-B **Done** 2026-07-04; Wave LR-A **Done** 2026-07-10 — A1–A7; merge `cc9e5f6`; Wave LR-C **In Progress** partial — LR-C1/C4 **Done** via CORE-FORTRESS F7 2026-07-09; **LR-C9 Done** 2026-07-10 — merge `0013615`; **LR-C10 Done** 2026-07-11 — merge `bdaf95d`; **LR-C11 Done** 2026-07-11 — merge `44fcf40`; **LR-C12 Done** 2026-07-11 — merge `0357a16`; **LR-C13 Done** 2026-07-11 — merge `45addd6`; **LR-C2 Done** 2026-07-11 — merge `12a6a7e`; **LR-C3 Done** 2026-07-11 — merge `0cf553b`; **LR-C5 Done** 2026-07-11 — merge `5543a33`; **LR-C6 Done** 2026-07-11 — merge `c0c84aa`; **LR-C7 Done** 2026-07-11 — merge `879108c`; **LR-C8 In Progress** sole-active). **Formal phase / program:** **None**. **Delivery focus note (2026-07-11):** **LR-C8 → In Progress** (`lrp-c8-role-onboarding-tour`; Task Master #34; BDD `ready`; FE-only role onboarding tour); see [LRP-C detail](./detail/LRP-C-usability-deepening.md). Formal phase remains **None**. Wave LR-C remains **In Progress** (partial — C1/C4/C9–C13 + **C2** + **C3** + **C5** + **C6** + **C7** Done; **C8 In Progress** sole-active). Do **not** mark Wave LR-C Done. Do **not** activate CD-3. **Prior:** **LR-C7 → Done** (`lrp-c7-notification-center`; merge `879108c`; Task Master #33; E2E 5/5; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES). **Prior:** **LR-C6 → Done** (`lrp-c6-command-palette`; merge `c0c84aa`; feature `406bba1`; Task Master #32; E2E 8/8; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES). **Prior:** **LR-C5 → Done** (`lrp-c5-catalog-pagination`; merge `5543a33`; feature `cfab79e`; Task Master #31; E2E 6/6; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES; OPT-F4 residual closed). **Prior:** **LR-C3 → Done** (`lrp-c3-editor-undo-redo`; merge `0cf553b`; Task Master #30; E2E 7/7; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES). **Prior:** **LR-C2 → Done** (`lrp-c2-local-draft-recovery`; merge `12a6a7e`; Task Master #29; E2E 4/4; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES). **Prior:** **LR-C13 → Done** (`lrp-c13-frontend-eng-debt`; merge `45addd6`; Task Master #28; OPT-G4/G5 closed). **Prior:** **LR-C12 → Done** (`lrp-c12-keyboard-a11y`; merge `0357a16`; Task Master #27). **Prior:** **LR-C11 → Done** (`lrp-c11-api-error-i18n`; merge `44fcf40`; `api.error` **159/159** + parity Vitest). **Prior:** **LR-C10 → Done** (`lrp-c10-upload-ux`; merge `bdaf95d`). **Prior:** **LR-C9 → Done** (`lrp-c9-load-error-panel`; merge `0013615`). **Prior:** Wave LR-A **Done** (A1–A7; merge `cc9e5f6`; **ADR-0041 Accepted**; 0042/0043 remain Proposed; Word/XSD/LO24 residuals deferred). **Sibling:** CDP Wave CD-2 **Done** (T01–T13; merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b` / `55a6ab6` / `b16e52a` / `6e3f825` / `f12b193` / `b2b0899`; **no sole-active CDP E2E slice**). **CODE-QUALITY Done** (2026-07-09); see [code-quality-program.md](./code-quality-program.md).
...
| **LRP** (`LR-*` — production hardening + usability deepening) | **This program** — Wave LR-A **Done** (2026-07-10); Wave LR-C **In Progress** (partial — C1/C4/C9–C13 + **C2** + **C3** + **C5** + **C6** + **C7** Done; **C8 In Progress** sole-active); LR-D/E when scheduled | LR-A…LR-E per §2 wave map; A1–A7 Done; Word/XSD/LO24/0042-Accepted/0043-Accepted residuals deferred post-wave (0041 Accepted residual closed). |
...
**Current wave:** **LR-C** **In Progress** (partial — **sole-active = LR-C8**) — **LR-A Done** (2026-07-10); **LR-B Done** (2026-07-04); **LR-C** remains **In Progress** (partial — C1/C4/C9–C13 + **C2** + **C3** + **C5** + **C6** + **C7** Done; **C8 In Progress**). **LR-C8 In Progress** (`lrp-c8-role-onboarding-tour`; Task Master #34; BDD `ready`; FE-only role onboarding tour). **LR-C7 Done** (`lrp-c7-notification-center`; merge `879108c`; Task Master #33; E2E 5/5; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES). **LR-C6 Done** (`lrp-c6-command-palette`; merge `c0c84aa`; Task Master #32; E2E 8/8; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES). **LR-C5 Done** (`lrp-c5-catalog-pagination`; merge `5543a33`; Task Master #31; E2E 6/6; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES; OPT-F4 residual closed). **LR-C3 Done** (`lrp-c3-editor-undo-redo`; merge `0cf553b`; Task Master #30; E2E 7/7; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES). **LR-C2 Done** (`lrp-c2-local-draft-recovery`; merge `12a6a7e`; Task Master #29; E2E 4/4; UIUX PASS_WITH_NOTES; architecture PASS_WITH_NOTES). **LR-C13 Done** (`lrp-c13-frontend-eng-debt`; merge `45addd6`; Task Master #28; OPT-G4/G5 closed). **LR-C12 Done** (`lrp-c12-keyboard-a11y`; merge `0357a16`; Task Master #27). **LR-C11 Done** (`lrp-c11-api-error-i18n`; merge `44fcf40`). Word-vs-LO / ADR-0042 Accepted + ADR-0043 slice B **deferred out of Wave LR-A exit**; ADR-0041 Accepted residual **closed** (architecture-reviewer 2026-07-10). Program status: **In Progress** (other waves remain). Do **not** activate CD-3. Do **not** mark Wave LR-C Done. **Sibling:** CDP Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; **no sole-active CDP E2E slice**).
...
| LR-C8 | frontend-engineer | Role onboarding tour (`el-tour`, no new dependency) | — | **required** ([ready](../behavior/lrp-c8-role-onboarding-tour.md)) | RoleJourneyTimeline (P21) | **In Progress** (2026-07-11 — sole-active; slice `lrp-c8-role-onboarding-tour`; Task Master #34; BDD **ready**) |
...
**Next action (2026-07-11):** **LR-C8 → In Progress** (slice `lrp-c8-role-onboarding-tour`; Task Master #34; sole-active; BDD `ready`). Formal phase remains **None**. Wave LR-A **Done** (A1–A7); Word/XSD residuals remain deferred. Wave LR-C remains **In Progress** (partial — C1/C4/C9–C13 + **C2** + **C3** + **C5** + **C6** + **C7** Done; **C8 In Progress** sole-active). Do **not** mark Wave LR-C Done. Do **not** activate CD-3. **Sibling CDP:** Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; **no sole-active CDP E2E slice** — do not execute from LRP). LR-B residual follow-ups: browser-level SSE incremental proof → **LR-E1**; JWT_SECRET default-fallback guard → **LR-E2** launch checklist prerequisite.
