...
**Program ID:** `LRP`  
**Created:** 2026-07-03  
**Status:** **In Progress** (Wave LR-B **Done** 2026-07-04; Wave LR-A **Done** 2026-07-10 — A1–A7; merge `cc9e5f6`; Wave LR-C **In Progress** partial — LR-C1/C4 **Done** via CORE-FORTRESS F7 2026-07-09; **LR-C9 Done** 2026-07-10 — merge `0013615`; **LR-C10 Done** 2026-07-11 — merge `bdaf95d`; **LR-C11 Done** 2026-07-11 — merge `44fcf40`; **LR-C12 Done** 2026-07-11 — merge `0357a16`; **LR-C13 In Progress** — slice `lrp-c13-frontend-eng-debt`). **Formal phase / program:** **None**. **Delivery focus note (2026-07-11):** **LR-C13 → In Progress** (`lrp-c13-frontend-eng-debt`; sole-active LRP; BDD `not-applicable`; Task Master #28; placement ISOLATED `D:/working/DGE-lrp-c13-frontend-eng-debt` · `feat/lrp-c13-frontend-eng-debt` · base `51838da`); see [LRP-C detail](./detail/LRP-C-usability-deepening.md). Formal phase remains **None**. Wave LR-C remains **In Progress** (partial — C1/C4/C9/C10/C11/C12 Done; **C13 In Progress**; C2/C3/C5/C7/C8 Not Started). Do **not** mark Wave LR-C Done. Do **not** activate C2/C3/C5/C7/C8/CD-3. **Prior:** **LR-C12 → Done** (`lrp-c12-keyboard-a11y`; merge `0357a16`; Task Master #27). **Prior:** **LR-C11 → Done** (`lrp-c11-api-error-i18n`; merge `44fcf40`; `api.error` **159/159** + parity Vitest). **Prior:** **LR-C10 → Done** (`lrp-c10-upload-ux`; merge `bdaf95d`). **Prior:** **LR-C9 → Done** (`lrp-c9-load-error-panel`; merge `0013615`). **Prior:** Wave LR-A **Done** (A1–A7; merge `cc9e5f6`; **ADR-0041 Accepted**; 0042/0043 remain Proposed; Word/XSD/LO24 residuals deferred). **Sibling:** CDP Wave CD-2 **Done** (T01–T13; merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b` / `55a6ab6` / `b16e52a` / `6e3f825` / `f12b193` / `b2b0899`; **no sole-active CDP E2E slice**). **CODE-QUALITY Done** (2026-07-09); see [code-quality-program.md](./code-quality-program.md).
...
| **LRP** (`LR-*` — production hardening + usability deepening) | **This program** — Wave LR-A **Done** (2026-07-10); Wave LR-C **In Progress** (partial — C1/C4/C9/C10/C11/C12 Done; **C13 sole-active**); LR-D/E when scheduled | LR-A…LR-E per §2 wave map; A1–A7 Done; Word/XSD/LO24/0042-Accepted/0043-Accepted residuals deferred post-wave (0041 Accepted residual closed). |
...
**Current wave:** **LR-C** **In Progress** (partial — **C13 sole-active**) — **LR-A Done** (2026-07-10); **LR-B Done** (2026-07-04); **LR-C** remains **In Progress** (partial — C1/C4/C9/C10/C11/C12 Done; **C13 In Progress**; C2/C3/C5/C7/C8 Not Started). **LR-C13 In Progress** (`lrp-c13-frontend-eng-debt`; Task Master #28). **LR-C12 Done** (`lrp-c12-keyboard-a11y`; merge `0357a16`; Task Master #27). **LR-C11 Done** (`lrp-c11-api-error-i18n`; merge `44fcf40`). Word-vs-LO / ADR-0042 Accepted + ADR-0043 slice B **deferred out of Wave LR-A exit**; ADR-0041 Accepted residual **closed** (architecture-reviewer 2026-07-10). Program status: **In Progress** (other waves remain). **Sibling:** CDP Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; **no sole-active CDP E2E slice**).
...
| LR-C13 | frontend-engineer | Frontend engineering debt (shared `unwrap`, route guards, `manualChunks`, coverage ratchet) | — | not-applicable (refactor + build config, behavior unchanged) | OPT-G4/G5 | **In Progress** (2026-07-11 — slice `lrp-c13-frontend-eng-debt`; sole-active; Task Master #28) |
...
| [optimization-plan.md](./optimization-plan.md) residuals | OPT-E9 → LR-B7; OPT-F4 residual → LR-C5; OPT-G4/G5 → LR-C13; OPT-G6 locale/catalog residual + G7 → **LR-C11 Done** (aria-label sweep remains on OPT-G6); OPT-D5/D6 **not absorbed** — remain OPT backlog |
...
**Next action (2026-07-11):** **LR-C13 → In Progress** (slice `lrp-c13-frontend-eng-debt`; sole-active LRP; Task Master #28; BDD `not-applicable`). Formal phase remains **None**. Wave LR-A **Done** (A1–A7); Word/XSD residuals remain deferred. Wave LR-C remains **In Progress** (partial — C1/C4/C9/C10/C11/C12 Done; **C13 In Progress**; C2/C3/C5/C7/C8 **Not Started**). Do **not** mark Wave LR-C Done. Do **not** activate C2/C3/C5/C7/C8/CD-3. **Sibling CDP:** Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; **no sole-active CDP E2E slice** — do not execute from LRP). LR-B residual follow-ups: browser-level SSE incremental proof → **LR-E1**; JWT_SECRET default-fallback guard → **LR-E2** launch checklist prerequisite.
