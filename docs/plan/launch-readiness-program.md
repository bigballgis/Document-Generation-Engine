...
**Program ID:** `LRP`  
**Created:** 2026-07-03  
**Status:** **In Progress** (Wave LR-B **Done** 2026-07-04; Wave LR-A **Done** 2026-07-10 — A1–A7; merge `cc9e5f6`; Wave LR-C **In Progress** partial — LR-C1/C4 **Done** via CORE-FORTRESS F7 2026-07-09; **LR-C9 Done** 2026-07-10 — merge `0013615`; **LR-C10 Done** 2026-07-11 — merge `bdaf95d`; **LR-C11 In Progress** 2026-07-11 — slice `lrp-c11-api-error-i18n`). **Formal phase / program:** **None**. **Delivery focus note (2026-07-11):** **LR-C11 → In Progress** (`lrp-c11-api-error-i18n`; sole-active LRP slice — `api.error` catalog parity + locale formatters); see [LRP-C detail](./detail/LRP-C-usability-deepening.md). Formal phase remains **None**. **Prior:** **LR-C10 → Done** (`lrp-c10-upload-ux`; merge `bdaf95d`). **Prior:** **LR-C9 → Done** (`lrp-c9-load-error-panel`; merge `0013615`). **Prior:** Wave LR-A **Done** (A1–A7; merge `cc9e5f6`; **ADR-0041 Accepted**; 0042/0043 remain Proposed; Word/XSD/LO24 residuals deferred). **Sibling:** CDP Wave CD-2 **Done** (T01–T13; merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b` / `55a6ab6` / `b16e52a` / `6e3f825` / `f12b193` / `b2b0899`; **no sole-active CDP E2E slice**). **CODE-QUALITY Done** (2026-07-09); see [code-quality-program.md](./code-quality-program.md).
...
| **LRP** (`LR-*` — production hardening + usability deepening) | **This program** — Wave LR-A **Done** (2026-07-10); Wave LR-C **In Progress** (sole-active **LR-C11**); LR-D/E when scheduled | LR-A…LR-E per §2 wave map; A1–A7 Done; Word/XSD/LO24/0042-Accepted/0043-Accepted residuals deferred post-wave (0041 Accepted residual closed). |
...
| LR-C11 | frontend-engineer | i18n closure — `api.error` N/N + parity test + raw dates (live backend **159** at activation; historically 145) | — | not-applicable (catalog completion per i18n constitution) | OPT-G7 + OPT-G6 residual | **In Progress** (2026-07-11 — slice `lrp-c11-api-error-i18n`; Task Master #26) |
...
| `api.error` zh-CN/en catalog coverage | **158/159** leaves (activation 2026-07-11; plan historically **94/145**) | **N/N** + backend parity test (LR-C11; N = live backend count) |
...
**Next action (2026-07-11):** **LR-C11 → In Progress** (slice `lrp-c11-api-error-i18n`; sole-active LRP slice; Task Master #26). Formal phase remains **None**. Wave LR-A **Done** (A1–A7); Word/XSD residuals remain deferred. Wave LR-C remains **In Progress** (partial — C1/C4/C9/C10 Done; **C11 In Progress**; C2/C3/C5/C7/C8/C12/C13 **Not Started**). Do **not** mark Wave LR-C Done. **Sibling CDP:** Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; **no sole-active CDP E2E slice** — do not execute from LRP). Do **not** activate LR-C12 or CD-3 while C11 is sole-active. LR-B residual follow-ups: browser-level SSE incremental proof → **LR-E1**; JWT_SECRET default-fallback guard → **LR-E2** launch checklist prerequisite.
