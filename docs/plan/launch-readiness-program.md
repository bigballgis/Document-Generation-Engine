...
**Program ID:** `LRP`  
**Created:** 2026-07-03  
**Status:** **In Progress** (Wave LR-B **Done** 2026-07-04; Wave LR-A **Done** 2026-07-10 — A1–A7; merge `cc9e5f6`; Wave LR-C partial — LR-C1/C4 **Done** via CORE-FORTRESS F7 2026-07-09). **Formal phase / program:** **None**. **Delivery focus note (2026-07-10):** **LR-A5 Done** (`lrp-a5-adr-closeout`; merge `cc9e5f6`; **ADR-0041 Accepted** via architecture-reviewer PASS_WITH_NOTES; 0042/0043 remain Proposed) — Wave LR-A closed with Word/XSD/LO24/0042-Accepted/0043-Accepted residuals deferred out of wave exit (0041 Accepted residual **closed**) — see [LRP-A detail](./detail/LRP-A-rendering-trust-hardening.md). **Prior Done:** LR-A3/A4/A6/A7 (`e62c210` / `a523a09` / `122d6d1` / `abf2048`). Do **not** start LR-C9 for deferred residuals. **Sibling:** CDP Wave CD-2 **partial** (T01/T01b Done, merge `1930842`; T02–T12 Not Started). **CODE-QUALITY Done** (2026-07-09); see [code-quality-program.md](./code-quality-program.md).  
