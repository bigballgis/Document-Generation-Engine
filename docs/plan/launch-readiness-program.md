...
| **LRP** (`LR-*` — production hardening + usability deepening) | **This program** — Wave LR-A **Done** (2026-07-10); Wave LR-C **In Progress** (partial — **sole-active** **LR-C12**); LR-D/E when scheduled | LR-A…LR-E per §2 wave map; A1–A7 Done; Word/XSD/LO24/0042-Accepted/0043-Accepted residuals deferred post-wave (0041 Accepted residual closed). |
...
**Current wave:** **LR-C** **In Progress** (partial — **sole-active** **LR-C12**) — **LR-A Done** (2026-07-10); **LR-B Done** (2026-07-04); **LR-C** remains **In Progress** (partial — C1/C4/C9/C10/C11 Done; **C12 In Progress**; C2/C3/C5/C7/C8/C13 Not Started). **LR-C12 In Progress** (`lrp-c12-keyboard-a11y`; Task Master #27). **LR-C11 Done** (`lrp-c11-api-error-i18n`; merge `44fcf40`). Word-vs-LO / ADR-0042 Accepted + ADR-0043 slice B **deferred out of Wave LR-A exit**; ADR-0041 Accepted residual **closed** (architecture-reviewer 2026-07-10). Program status: **In Progress** (other waves remain). **Sibling:** CDP Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; **no sole-active CDP E2E slice**).
...
| LR-C12 | frontend-engineer | Keyboard a11y & table activation (Enter/Space, skip-link, focus audit) | — | not-applicable (a11y baseline hardening) | COR-F21 residual | **In Progress** (2026-07-11 — slice `lrp-c12-keyboard-a11y`; Task Master #27) |
...
**Next action (2026-07-11):** **LR-C12 → In Progress** (slice `lrp-c12-keyboard-a11y`; sole-active LRP slice; Task Master #27; worktree `D:/working/DGE-lrp-c12-keyboard-a11y` · `feat/lrp-c12-keyboard-a11y` · base `ee1435d`). Formal phase remains **None**. Wave LR-A **Done** (A1–A7); Word/XSD residuals remain deferred. Wave LR-C remains **In Progress** (partial — C1/C4/C9/C10/C11 Done; **C12 In Progress**; C2/C3/C5/C7/C8/C13 **Not Started**). Do **not** mark Wave LR-C Done. Do **not** activate C2/C3/CD-3. **Sibling CDP:** Wave CD-2 **Done** (T01–T13; merge tip `b2b0899`; **no sole-active CDP E2E slice** — do not execute from LRP). LR-B residual follow-ups: browser-level SSE incremental proof → **LR-E1**; JWT_SECRET default-fallback guard → **LR-E2** launch checklist prerequisite.
