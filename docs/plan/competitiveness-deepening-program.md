...
**Program ID:** `CDP`  
**Created:** 2026-07-04  
**Status:** **In Progress** (Wave **CD-2** — **partial**; golden-path T01/T01b **Done**; CD-0 **Done**)  
...
| [launch-readiness-program.md](./launch-readiness-program.md) | **Sibling program (LRP)** — **LR-A3 Done** (2026-07-10); Wave LR-A remains In Progress (A4–A7); do **not** start LR-A4 from this CDP closeout; do not execute `LR-*` from CDP session |
...
| **CDP** (doc truth, BDD, E2E, pitfall specs, CD-HARD) | **Active delivery focus** (2026-07-10) — Wave **CD-2** partial (T01/T01b Done) | CD-0 **Done** → CD-2 **In Progress** (T01/T01b **Done**; T02–T12 Not Started) → CD-3 later. |
...
**Repo phase accounting:** `master-plan.md` formal phase is **None** (2026-07-09+). Current delivery focus is **CDP Wave CD-2** (partial — golden-path T01/T01b Done; matrix continues). LRP Wave LR-A remains **In Progress** as a sibling program (A4 not started in this slice). CDP is a **parallel program** — not a phase replacement.
...
**Current wave (this session):** **CD-2** — **In Progress** (2026-07-10; **partial progress**). **CD-0 Done**. **CD-E2E-T01** + **CD-E2E-T01b** → **Done** (merge `1930842`). T02–T12 + T13 remain `Not Started` (deferred this slice; T07 not re-run). Do **not** mark full CD-2 Done until remaining matrix green.
...
**Next wave (this session):** **CD-2 In Progress** — golden-path **T01/T01b Done** (2026-07-10). Next matrix: CD-E2E-T02… from [CDP-e2e detail](./detail/CDP-e2e-full-chain-evidence.md). T07/T13 deferred this slice.
...
**Next action (this session):** CD-E2E-T01/T01b **Done**. Continue CD-2 matrix (**T02+**) when scheduled. Do **not** mark CD-2 Done; do **not** start LR-A4, virus scan, or audit-governance from this closeout.
