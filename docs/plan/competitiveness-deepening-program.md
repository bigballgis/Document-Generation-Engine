...
**Program ID:** `CDP`  
**Created:** 2026-07-04  
**Status:** **In Progress** (Wave **CD-2** — **partial**; T01/T01b + T02/T03/T04 + T05 + T06 + **T08 Done** (merges `6821f45` / `895f16e` / `3aed175` / `c62b1a1`); **T07 In Progress** (sole active CDP E2E slice); T09–T12 + T13 Not Started; CD-0 **Done**)  
...
| **CDP** (doc truth, BDD, E2E, pitfall specs, CD-HARD) | **Sibling program** — Wave **CD-2** partial (T01–T08 Done; **T07 In Progress**; T09–T12 + T13 Not Started) | CD-0 **Done** → CD-2 **In Progress** (T01–T08 Done; **T07 In Progress** sole active; T09–T12 + T13 Not Started) → CD-3 later. |
...
**Repo phase accounting:** `master-plan.md` formal phase is **None** (2026-07-09+). **Wave LR-A Done** (2026-07-10; A1–A7; merge `cc9e5f6`; **ADR-0041 Accepted**; 0042/0043 Proposed; Word/XSD/LO24 deferred). CDP Wave CD-2 remains **In Progress** as a sibling program (partial — T01–T08 Done, merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1`; **T07 In Progress** sole active CDP E2E slice; T09–T12 + T13 Not Started). LRP program remains **In Progress** (**LR-C9 Done** 2026-07-10 — merge `0013615`; Wave LR-C partial; Wave LR-A Done — Word/XSD residuals deferred separately). CDP is a **parallel program** — not a phase replacement.
...
**Next action (this session):** **CD-E2E-T07 → In Progress** (2026-07-10; slice `cdp-e2e-t07-api-policy`; ISOLATED `D:/working/DGE-cdp-e2e-t07-api-policy` · `feat/cdp-e2e-t07-api-policy` · base `71ee0b8`). API policy edit → impact preview → save (BDD-CDP-APIPOL-001/002 **ready**). **Sole active CDP E2E slice** (T08 stays **Done**; T09–T13 Not Started). Wave CD-2 remains **In Progress** (partial — T01–T08 Done; T07 active). Formal phase remains **None**. **Task Master #19 → in-progress**. Out of scope this slice: T09–T13 full delivery; audit-governance; LR-C5.
