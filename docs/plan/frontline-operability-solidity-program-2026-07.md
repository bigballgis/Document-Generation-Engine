...
| **Next queue head** | FOS **Leaf 15** `fos-word-foundation-honesty` / TM **#185** → **In Progress** (feat worktree) |
...
| **W15** | `fos-word-foundation-honesty` | Word foundation honesty | WF-1…WF-8 — typography / letterhead / nested render honesty; evidence [deep review](detail/fos-word-foundation-deep-review-2026-07.md) | [FOS-W15](detail/FOS-W15-word-foundation-honesty.md) | **In Progress** |
...
| Leaf 15 | **#185** | `fos-word-foundation-honesty` | **in-progress** | worktree `feat/fos-word-foundation-honesty` |
