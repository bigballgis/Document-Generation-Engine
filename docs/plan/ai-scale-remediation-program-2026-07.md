...
| **Created** | 2026-07-26 |
| **Status** | **In Progress** (Leaf 1 **Done**; Leaves 2–4 queued pending; **sole-active cleared**) |
| **Formal phase** | **None** (NON-CE agent/docs operability program — not a P-phase) |
| **Sole-active leaf** | **none** (cleared after Leaf 1) |
| **Leaf 1 (Done)** | TM **#166** · `ai-scale-remediation-g1` → **Done** (`c4f1b0d4`; worktree **REMOVED**) |
| **Leaf 2 (queued)** | TM **#167** · TemplateImport* peel → **pending** (next queue head — do **not** auto-activate) |
...
| **Next queue head** | TM **#167** (pending — not auto-activated) |
...
queued peels into closed Leaf 1. Do **not** auto-activate Leaf 2 after Leaf 1 Done.
...
| **AI-SCALE-L2** | **#167** | **pending** | TemplateImport* peel — next queue head; not activated |
| **AI-SCALE-L3** | **#168** | **pending** | i18n locale split — queued only |
| **AI-SCALE-L4** | **#169** | **pending** | Mega-test fixture split — queued only |

**Sole-active statement:** Host delivery sole-active = **cleared**. Umbrella **#53** stays
**in-progress** registry-only (not a delivery leaf). **#106** stays **pending**
registry-only. **#119** stays Blocked/pending.
