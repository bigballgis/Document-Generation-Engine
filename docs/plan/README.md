...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave B In Progress — #113 IBL-B1 sole-active; Wave A Done)** — TM **#106** registry-only pending + **#107–#112** **Done** (A6 tip `5cacff2a`) + **#113** **in-progress** + **#114–#134** pending; Wave **IBL-B** **In Progress**; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** claim IBL program Done |
