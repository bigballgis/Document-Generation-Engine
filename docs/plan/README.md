...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave B In Progress — #113–#117 B1–B5 Done; Wave A Done; sole-active cleared)** — TM **#106** registry-only pending + **#107–#117** **Done** (B5 `1666312b` / `d7459405`+`fbb40429`; B4 `610eb0fa` / `d6b389d1`+`d2e8a1c9`; B3 `3710811a` / `c81054b0`+`e0102ddb`; B2 `29d022b6` / `3dd1aa60`+`36a9821c`; B1 `a33da272` / `44237c99`; A6 tip `5cacff2a`) + **#118–#134** pending; Wave **IBL-B** **In Progress** (B1–B5 Done; B6 pending; B7 Blocked; next **#118** not activated); formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** claim IBL program Done |
