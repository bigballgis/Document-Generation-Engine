...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave E In Progress — #128 IBL-E1 sole-active; Wave D Done D1–D5; Wave C Done; Wave B residual In Progress B7 Blocked; Wave A Done)** — TM **#106** registry-only pending + **#107–#118/#120–#127** **Done** + **#128** **in-progress** + **#129–#134** pending (PD-unblocked, not activated) + **#119** Blocked; F23/F22/F21/F20 closed; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** invent confirmed NFR SLOs; do **not** claim Wave B / Wave E / IBL program Done |
