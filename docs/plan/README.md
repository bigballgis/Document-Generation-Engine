...
**In-flight work:**
- **CDP Wave CD-2 In Progress** (2026-07-11) — **partial** (CD-E2E-T01–T08 + T07 Done, merges `1930842` / `6821f45` / `895f16e` / `3aed175` / `c62b1a1` / `1eb230b`; T09–T12 + T13 Not Started); **CD-0 Done** — [program](./competitiveness-deepening-program.md); [detail](detail/CDP-e2e-full-chain-evidence.md); merges `1930842`, `6821f45`, `895f16e`, `3aed175`, `c62b1a1`, `1eb230b`
