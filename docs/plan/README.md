...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave B In Progress — #117 IBL-B5 sole-active; #113–#116 B1–B4 Done; Wave A Done)** — TM **#106** registry-only pending + **#107–#116** **Done** (B4 `610eb0fa` / `d6b389d1`+`d2e8a1c9`; B3 `3710811a` / `c81054b0`+`e0102ddb`; B2 `29d022b6` / `3dd1aa60`+`36a9821c`; B1 `a33da272` / `44237c99`; A6 tip `5cacff2a`) + **#117** **in-progress** (`ibl-b5-seal-geometry`) + **#118–#134** pending; Wave **IBL-B** **In Progress** (B1–B4 Done; B5 In Progress; B6 pending; B7 Blocked); formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** claim IBL program Done |
