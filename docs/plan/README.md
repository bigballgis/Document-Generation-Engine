...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave B In Progress — #113 IBL-B1 Done; Wave A Done)** — TM **#106** registry-only pending + **#107–#113** **Done** (B1 `a33da272` / `44237c99`; A6 tip `5cacff2a`) + **#114–#134** pending; Wave **IBL-B** **In Progress** (B1 Done); sole-active cleared; next **#114** not activated; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** claim IBL program Done |
