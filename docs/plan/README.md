...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave C Done — C1+C2+C3; sole-active cleared; next #123 note-only; Wave B residual In Progress B1–B6 Done / B7 Blocked; Wave A Done)** — TM **#106** registry-only pending + **#107–#118/#120–#122** **Done** + **#119/#123–#134** pending; F19 honesty SYNTHETIC; LO residual → D2/F21; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** claim Wave B / IBL program Done |
