...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Registered in Task Master / Not Started)** — TM **#106** + **#107–#134** (**28** leaves, pending); waves A–E not activated; formal phase **None**; deferred after PRR #105→#103→#104 |
