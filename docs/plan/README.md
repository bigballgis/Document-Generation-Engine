...
**Ad-hoc slice (2026-07-10):** **[MGMT-UI-DEFECTS](detail/MGMT-UI-defects.md)** — management UI acceptance defects — **Done** (layout fill, release read-only tabs, API policy home, login validation).
