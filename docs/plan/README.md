...
| Backlog | Lens |
| --- | --- |
| **[core-excellence-program-2026-07.md](./core-excellence-program-2026-07.md)** | **Core Excellence（CE-K/U/C/G/E/O, 2026-07-13）** — 四轮深度审查合并执行地图：信函内核正确性（发布钉扎/样式权威/变量 DSL/语义 diff/保真/金标）、核心链路易用性、运行时契约诚信、银行内控合规、环境晋级、归档输出；全部 `Not Started` |
