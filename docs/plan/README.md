...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave D In Progress — D1 #123 Done; D2–D5 Not Started; Wave C Done C1+C2+C3; Wave B residual In Progress B1–B6 Done / B7 Blocked; Wave A Done)** — TM **#106** registry-only pending + **#107–#118/#120–#123** **Done** + **#119/#124–#134** pending; sole-active cleared; next **#124** note-only not activated; F20 closed (opt-in TC+Flyway; default H2 retained); formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** claim Wave B / Wave D / IBL program Done |
