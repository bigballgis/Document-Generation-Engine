...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave A In Progress — A1 only)** — TM **#106** registry-only pending + **#107** **in-progress** (sole-active) + **#108–#134** pending; Wave **IBL-A** In Progress; formal phase **None**; slice `ibl-a1-variable-validation`; do **not** flip **#3b/#5a GO**; merge register `9fc2bc97` |
