...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave A In Progress — A1 Done / A2 In Progress)** — TM **#106** registry-only pending + **#107** **Done** (`f0a2b6fe` / `4bda5f2d`) + **#108** **in-progress** (sole-active) + **#109–#134** pending; Wave **IBL-A** In Progress (A3–A6 Not Started); formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** mark Wave A / program Done |
