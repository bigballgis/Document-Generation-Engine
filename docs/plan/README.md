...
**Delivery focus note (2026-07-10):** **LR-A5 Done** (`lrp-a5-adr-closeout`; ADR triad Proposed) — **Wave LR-A Done** (residuals deferred out of wave exit) — [LRP-A detail](detail/LRP-A-rendering-trust-hardening.md); [LRP program](launch-readiness-program.md). Formal phase remains **None**. **Sibling:** CDP Wave CD-2 **partial** (T01/T01b Done, merge `1930842`; T02–T12 Not Started) — [CDP program](competitiveness-deepening-program.md). **LRP:** LR-A1–A7 Done; do not start LR-C9 for deferred residuals.
