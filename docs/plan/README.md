...
**Delivery focus note (2026-07-10):** **LR-A6 In Progress** (`lrp-a6-ooxml-gate`; OOXML output validation gate; executes CD-HARD-T03) — [LRP-A detail](detail/LRP-A-rendering-trust-hardening.md); [LRP program](launch-readiness-program.md). Formal phase remains **None**. **Sibling:** CDP Wave CD-2 **partial** (T01/T01b Done, merge `1930842`; T02–T12 Not Started) — [CDP program](competitiveness-deepening-program.md). **LRP:** LR-A3/A4/A7 Done; Wave LR-A **In Progress** (A5 Partial; **A6 In Progress**).
...
- **LRP Wave LR-A In Progress** — **LR-A6 In Progress** (2026-07-10; `lrp-a6-ooxml-gate`; executes CD-HARD-T03); **LR-A7 Done** (Docker PDF corpus; Word delta residual); A1–A4 Done; A5 Partial — [program](./launch-readiness-program.md); [detail](detail/LRP-A-rendering-trust-hardening.md); [corpus](./pagination-delta-corpus.md)
