...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave C In Progress — C1+C2 Done / C3 In Progress; sole-active #122; next after leaf #123 note-only; Wave B residual In Progress B1–B6 Done / B7 Blocked; Wave A Done)** — TM **#106** registry-only pending + **#107–#118/#120/#121** **Done** + **#122** **in-progress** + **#119/#123–#134** pending; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** claim Wave B/C / IBL program Done |
