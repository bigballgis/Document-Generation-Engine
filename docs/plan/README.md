...
**Delivery focus note (2026-07-10):** **CDP Wave CD-2** — **CD-E2E-T02/T03/T04 → Done** (slice `cdp-e2e-cd2-t02`; merge `6821f45`); wave stays **In Progress** (partial; T01/T01b Done; T05–T13 Not Started). Formal phase remains **None**. **Next:** CD-E2E-T05 (publish). **Prior:** **LR-C9 → Done** (`lrp-c9-load-error-panel`; merge `0013615`) — no LRP slice currently `In Progress`; [LRP-C detail](detail/LRP-C-usability-deepening.md); [LRP program](launch-readiness-program.md). **Prior:** Wave LR-A **Done** (A1–A7; merge `cc9e5f6`; **ADR-0041 Accepted**; Word/XSD/LO24 residuals deferred). CDP program: [competitiveness-deepening-program.md](competitiveness-deepening-program.md).
...
**In-flight work:**
- **CDP Wave CD-2 In Progress** (2026-07-10) — **partial** (CD-E2E-T01/T01b + **T02/T03/T04 Done**, merge `6821f45`; T05–T12 Not Started); **CD-0 Done** — [program](./competitiveness-deepening-program.md); [detail](detail/CDP-e2e-full-chain-evidence.md); merges `1930842`, `6821f45`
