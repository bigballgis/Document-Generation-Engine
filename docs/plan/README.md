...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave A Done — A1–A6 Done)** — TM **#106** registry-only pending + **#107–#112** **Done** (A6 tip `5cacff2a`) + **#113–#134** pending; Wave **IBL-B** **Not Started**; sole-active cleared; next **#113** not activated; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** claim IBL program Done |
