...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave D Done — D1–D5 #123–#127 Done; Wave C Done C1+C2+C3; Wave B residual In Progress B1–B6 Done / B7 Blocked; Wave A Done)** — TM **#106** registry-only pending + **#107–#118/#120–#127** **Done** + **#119/#128–#134** pending; sole-active cleared; residual = B7 Blocked OR Wave E BLOCKED (not activated); F23 legalhold half closed; F22 closed (D3+D4); F21 closed; F20 closed; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** invent confirmed NFR SLOs; do **not** claim Wave B / IBL program Done |
