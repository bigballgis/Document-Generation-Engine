...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave C In Progress — C1 Done / C2–C3 pending; sole-active cleared; next #121 not activated; Wave B residual In Progress B1–B6 Done / B7 Blocked; Wave A Done)** — TM **#106** registry-only pending + **#107–#118/#120** **Done** + **#119/#121–#134** pending; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** claim Wave B/C / IBL program Done |
