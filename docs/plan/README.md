...
**Delivery focus note (2026-07-10):** **LR-A6 Done** (`lrp-a6-ooxml-gate`; merge `122d6d1`; OOXML fail-closed gate; CD-HARD-T03 executed-by-LR-A6) — [LRP-A detail](detail/LRP-A-rendering-trust-hardening.md); [LRP program](launch-readiness-program.md). Formal phase remains **None**. **Sibling:** CDP Wave CD-2 **partial** (T01/T01b Done, merge `1930842`; T02–T12 Not Started) — [CDP program](competitiveness-deepening-program.md). **LRP:** LR-A3/A4/A6/A7 Done; Wave LR-A **In Progress** (A5 Partial).
...
- **LRP Wave LR-A In Progress** — **LR-A6 Done** (2026-07-10; merge `122d6d1`; CD-HARD-T03 executed-by-LR-A6); **LR-A7 Done** (Docker PDF corpus; Word delta residual); A1–A4 Done; A5 Partial — [program](./launch-readiness-program.md); [detail](detail/LRP-A-rendering-trust-hardening.md); [corpus](./pagination-delta-corpus.md)
