...
| [launch-readiness-program.md](./launch-readiness-program.md) | Launch-readiness deep optimization — production pitfalls + usability deepening (LR-A…E; sibling program; **Wave LR-C Done**; **Wave LR-D In Progress** — **LR-D1+D2+D5+D6+D7 Done**; **D3/D4**/E Not Started; **no sole-active**) |
