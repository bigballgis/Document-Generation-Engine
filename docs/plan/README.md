...
| [launch-readiness-program.md](./launch-readiness-program.md) | Launch-readiness deep optimization — production pitfalls + usability deepening (LR-A…E; sibling program; LR-C1/C4/C9–C13 + **C2** + **C3** + **C5** + **C6** Done; **C7 In Progress** sole-active; C8 Not Started; Wave LR-C partial) |
