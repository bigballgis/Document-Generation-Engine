...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave E In Progress — #128 IBL-E1 Done `4c712b03`/`9decf19c` F24 closed; #129 IBL-E2 Done `81a1ca29`/`6a96e9ab` F25 closed; sole-active cleared; Wave D Done D1–D5; Wave C Done; Wave B residual In Progress B7 Blocked; Wave A Done)** — TM **#106** registry-only pending + **#107–#118/#120–#129** **Done** + **#130–#134** pending (PD-unblocked, not activated) + **#119** Blocked; F25/F24/F23/F22/F21/F20 closed; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** invent confirmed NFR SLOs; do **not** claim Wave B / Wave E / IBL program Done |
