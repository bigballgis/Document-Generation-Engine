...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (proposal, Not Started)** — international multinational bank financial-letter readiness (`IBL-*`; waves A–E; 2026-07-17 audit); formal phase **None**; awaiting user confirmation |
