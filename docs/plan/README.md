...
**Active formal phase: P21** (activated 2026-06-29; **sub-phase B cluster ② Done** — T07–T09b; next **P21-T10** cluster ③ Global admin). P12 remains the deferred-enhancements
...
| P21 | Role-journey frontend redesign & business-friendly terminology | [detail/P21-role-journey-frontend-redesign.md](detail/P21-role-journey-frontend-redesign.md) | In Progress (2026-06-29; cluster ② Done; next T10) |
...
(activated 2026-06-29; **sub-phase B cluster ② Done** — T07–T09b; next **P21-T10** — cluster ③ Global admin) — see
