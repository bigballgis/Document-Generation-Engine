...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave A In Progress — A1–A3 Done; A4 In Progress; A5–A6 Not Started)** — TM **#106** registry-only pending + **#107** **Done** (`f0a2b6fe` / `4bda5f2d`) + **#108** **Done** (`e3000479` / `89584242`) + **#109** **Done** (`779b1979` / `f09326ca`) + **#110** **in-progress** (sole-active) + **#111–#134** pending; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** mark Wave A / program Done |
