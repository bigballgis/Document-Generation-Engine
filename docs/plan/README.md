...
| [intl-bank-letter-readiness-program.md](./intl-bank-letter-readiness-program.md) | **IBL (Wave D In Progress — D1 #123 Done; D2 #124 Done; D3 #125 Done; D4 #126 Done; D5 Not Started; Wave C Done C1+C2+C3; Wave B residual In Progress B1–B6 Done / B7 Blocked; Wave A Done)** — TM **#106** registry-only pending + **#107–#118/#120–#126** **Done** + **#119/#127–#134** pending; sole-active cleared; next queue (not activated) **#127**; F22 closed (D3+D4); F21 closed; F20 closed; formal phase **None**; do **not** flip **#3b/#5a GO**; do **not** invent confirmed NFR SLOs; do **not** claim Wave B / Wave D / IBL program Done |
