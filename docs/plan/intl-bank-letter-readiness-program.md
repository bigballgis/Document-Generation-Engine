...
**Program ID:** `IBL`  
**Created:** 2026-07-17  
**Status:** **Wave IBL-C In Progress** (**#120** IBL-C1 **Done**; **#121** IBL-C2 **In Progress**; C3 **Not Started**) + **Wave IBL-B In Progress** (**#113** IBL-B1 **Done**; **#114** IBL-B2 **Done**; **#115** IBL-B3 **Done**; **#116** IBL-B4 **Done**; **#117** IBL-B5 **Done**; **#118** IBL-B6 **Done**; B7 **Blocked**). Wave **IBL-A** remains **Done** (A1–A6 **Done** — A6 closed **2026-07-19**, MAIN tip `5cacff2a`). Program remains **registered** (not program Done). Program registered **2026-07-18**; A1 closed **2026-07-18** (MAIN merge `f0a2b6fe`); A2 closed **2026-07-18** (MAIN merge `e3000479`); A3 closed **2026-07-18** (MAIN merge `779b1979`); A4 closed **2026-07-18** (MAIN merge `ddf6601c`); A5 closed **2026-07-18** (MAIN merge `e5217a80`); A6 closed **2026-07-19** (MAIN tip `5cacff2a` FF); B1 closed **2026-07-19** (MAIN merge `a33da272` / feature tip `44237c99`); B2 closed **2026-07-19** (MAIN merge `29d022b6` / feature tip `3dd1aa60` + `36a9821c`); B3 closed **2026-07-19** (MAIN merge `3710811a` / `c81054b0`+`e0102ddb`); B4 closed **2026-07-19** (MAIN merge `610eb0fa` / `d6b389d1`+`d2e8a1c9`); B5 closed **2026-07-19** (MAIN merge `1666312b` / `d7459405`+`fbb40429`); B6 closed **2026-07-19** (MAIN merge `8722f4f1` / includes `8e8c62e6`; also brought previously local `e2f0a505` B5 docs); C1 closed **2026-07-19** (MAIN merge `55909dd2` / includes `d2492fc4`+`5d89b606`; prior tip `c77418aa`). Checklist **#3b** is **CONDITIONAL** (PRR-C01 Path X; merge `3513ab92`) — do **not** flip **#3b GO** or claim go-live from IBL.  
...
**Task Master:** Umbrella **#106** (registry only, **`pending`**) + leaves **#107–#134** (28 tasks = A6+B7+C3+D5+E7). **#107–#118** IBL-A1–A6 + IBL-B1–B6 → **`done`**; **#120** IBL-C1 → **`done`**; **#121** IBL-C2 → **`in-progress`** (sole-active); **#119** + **#122–#134** remain **`pending`** (B7 + Wave E descriptions start with **BLOCKED**). **Sole-active:** **#121** IBL-C2 (`ibl-c2-rendered-compare-ui`). **Next after this leaf:** **#122** IBL-C3. See § Task Master ID map.  
...
| [execution-sync-ledger.md](./execution-sync-ledger.md) | **#121** IBL-C2 → **in-progress** (sole-active `ibl-c2-rendered-compare-ui`); Wave IBL-C → **In Progress** (C1 Done; C2 In Progress; C3 Not Started); Wave IBL-B → **In Progress** (B1–B6 Done; B7 Blocked residual); Wave IBL-A remains **Done**; prior **#120** Done (`55909dd2` / `d2492fc4`+`5d89b606`); next after this = **#122** C3 |
...
Registered **2026-07-18** under `.taskmaster/tasks/tasks.json`. Program status = **Wave IBL-C In Progress** (**#120** IBL-C1 **done**; **#121** IBL-C2 **in-progress**; C3 pending) + **Wave IBL-B In Progress** (**#113–#118** IBL-B1–B6 **done**; B7 Blocked); Wave **IBL-A** remains **Done** (A1–A6 **Done**). Sole-active = **#121**. TM status column below mirrors Task Master; plan-layer wave tables use `Not Started` / `In Progress` / `Blocked` / `Done` vocabulary.
...
| IBL-C1 | **120** | **done** |
| IBL-C2 | **121** | **in-progress** (sole-active) |
| IBL-C3 | **122** | pending |
| IBL-D1 | **123** | pending |
| IBL-D2 | **124** | pending |
| IBL-D3 | **125** | pending |
...
| **F18** | No side-by-side visual compare of two **rendered** outputs in UI | `PreviewComparisonService` (warnings); `ChangeDiffService` / `SemanticContentDiffEngine` (semantic); [ibl-c2-rendered-compare-ui.md](../behavior/ibl-c2-rendered-compare-ui.md) | **Medium** | **IBL-C2** (**In Progress** **#121**) |
...
3. Formal phase remains **None**. Task Master registration (#106–#134) is complete; **Wave IBL-A** → **Done** (A1–A6); Wave **IBL-B** → **In Progress** (**#113/#114/#115/#116/#117/#118** IBL-B1–B6 **Done**; B7 Blocked residual); Wave **IBL-C** → **In Progress** (**#120** IBL-C1 **Done**; **#121** IBL-C2 **In Progress**; C3 **Not Started**) — do not invent a P-phase here; do **not** claim full Wave B Done while B7 Blocked implies #3b path open; do **not** claim Wave C Done while C2/C3 pending.
4. Tasks marked **BDD: required** may not start implementation until `behavior-spec-author` publishes a `ready` spec.

**Current waves:** Wave **IBL-C** → **In Progress** (C1 **Done**; C2 **In Progress**; C3 **Not Started**) + Wave **IBL-B** → **In Progress** (B7 Blocked residual only). Wave **IBL-A** → **Done**. **Sole-active:** **#121** IBL-C2.

```text
Sole-active: #121 IBL-C2 (ibl-c2-rendered-compare-ui · feat/ibl-c2-rendered-compare-ui)
Wave C: In Progress (C1 Done; C2 In Progress; C3 Not Started — do not claim Wave C Done)
...
Next after this leaf: #122 IBL-C3
...
**Wave status:** **In Progress** (C1 **Done**; C2 **In Progress**; C3 **Not Started**)  
...
| IBL-C2 | frontend-engineer | Side-by-side **rendered** output compare UI | — | **required** (`ready` — frontend E2E **mandatory**) | F18 | **In Progress** |
...
| Date | Change |
| --- | --- |
| 2026-07-19 | **Activated IBL-C2 / #121** — Task Master **#121** → **in-progress** (sole-active NON-CE delivery leaf). Wave **IBL-C** stays **In Progress** (C1 **Done**; C2 **In Progress**; C3 **Not Started** — do **not** claim Wave C Done). Wave **IBL-B** stays **In Progress** (B1–B6 **Done**; B7 **Blocked** residual). Wave **IBL-A** remains **Done**. Slice `ibl-c2-rendered-compare-ui`; placement **ISOLATED**; worktree `D:/working/DGE-ibl-c2-rendered-compare-ui` · `feat/ibl-c2-rendered-compare-ui`. Batch recommendation **solo** (`member_task_ids: ["121"]`; `proposed_slice_id: ibl-c2-rendered-compare-ui`; vetoes_applied: **IBL-C3**, **IBL-B7-Word**, **umbrella-106**). BDD **ready** ([ibl-c2-rendered-compare-ui.md](../behavior/ibl-c2-rendered-compare-ui.md); **BDD-IBL-C2-001…007**); `frontend_ui_in_scope=true` (E2E/UIUX mandatory). Owner **frontend-engineer**. Scope: F18 — side-by-side **rendered** PDF compare UI (not only semantic/warning diff). **#106** stays registry-only **pending**. Formal phase **None**. Checklist **#3b** / **#5a** stay **CONDITIONAL** — do **not** flip **GO**. Do **not** claim go-live. Do **not** activate C3/B7/Wave E. Do **not** mark Wave B/C / IBL program Done. Next: **frontend-engineer** (stage 4; skip heavy doc-keeper). |
...
**Next action:** **Sole-active:** **#121** IBL-C2 (`ibl-c2-rendered-compare-ui` · `feat/ibl-c2-rendered-compare-ui`; ISOLATED). Wave **IBL-C** stays **In Progress** (C1 **Done**; C2 **In Progress**; C3 **Not Started** — do **not** claim Wave C Done). Wave **IBL-B** stays **In Progress** (B1–B6 **Done**; B7 **Blocked** residual — Word host; do **not** claim full Wave B Done). BDD **ready** (**BDD-IBL-C2-001…007**). Owner **frontend-engineer** (stage 4). **Next after this leaf:** **#122** IBL-C3 — **#119** IBL-B7 remains **Blocked**. Wave **IBL-A** remains **Done**. Do **not** invent a formal P-phase. Do **not** invent Word/pixel baselines. Do **not** flip checklist **#3b GO** / **#5a GO**. Do **not** claim go-live or IBL program Done. Do **not** activate C3/B7/Wave E.
