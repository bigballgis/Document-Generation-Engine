...
**Queue policy (critical):** Host serial delivery queue: PRR **#105 Done** (`50448016`); **#103 Done** (`3513ab92` / `6408c210`); **#104** PRR-D01a (**D01A**) → **Done** (`f1f79d14`; Wave D **SPLIT** leaf closed; **not** full Wave D bag). **Host sole-active:** **#135** PRR-D01b (`prod-ops-security-hardening` — actuator/nginx/ADR-0044 + IRC `FailedSyncInvocationErrorMapper`; dashboard FE vetoed). IBL stays deferred until **#135** / remaining Wave D residuals complete (or explicit user redirect). IBL tasks remain **pending / deferred**. Next IBL activation head after remaining PRR = **IBL-A1** (#107) or a Wave A batch per Batch Recommendation at that time. Umbrella **#106** is **registry only** — **not** a sole-active delivery leaf. Do **not** activate IBL while **#135** remains ahead.
...
**Queue note:** Do **not** reorder ahead of sole-active **#135** PRR-D01b (`prod-ops-security-hardening`; after **#104** D01A **Done** `f1f79d14`; bag OUT unfinished; **#103/#105** already **Done**). Do **not** treat #106 as sole-active. After **#135** / remaining Wave D residuals (or explicit user redirect), activate **IBL-A1** (#107) or Wave A batch via delivery-orchestrator Batch Recommendation — still one leaf at a time.
...
**Next action:** After sole-active **#135** PRR-D01b / remaining Wave D residuals (**#104** D01A **Done** `f1f79d14`; bag OUT unfinished; **#103/#105 Done**) — or on explicit user redirect — activate **IBL-A** via delivery-orchestrator (head **IBL-A1** / #107, or Wave A batch per Batch Recommendation). Do **not** mark any IBL wave In Progress while **#135** remains ahead. Do **not** invent a formal P-phase. Do **not** flip checklist **#3b GO**.
