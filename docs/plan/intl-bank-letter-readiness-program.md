...
**Queue policy (critical):** Host serial delivery queue: PRR **#105 Done** (`50448016`); **#103 Done** (`3513ab92` / `6408c210`); **#104** PRR-D01a (**D01A**) → **Done** (`f1f79d14`; Wave D **SPLIT** leaf closed); **#135** PRR-D01b → **Done** (`6e776232` / `1ada6b41`; Wave D residual **SPLIT** leaf closed — actuator/nginx/IRC/ADR-0044; **not** full Wave D bag). **Host sole-active cleared.** **Next PRR queue (not activated):** dashboard summary API (stop `fetchAllMasters`/`Templates` on first paint). IBL stays deferred until dashboard Wave D residual completes (or explicit user redirect). IBL tasks remain **pending / deferred**. Next IBL activation head after remaining PRR = **IBL-A1** (#107) or a Wave A batch per Batch Recommendation at that time. Umbrella **#106** is **registry only** — **not** a sole-active delivery leaf. Do **not** activate IBL while dashboard residual remains ahead.
...
**Queue note:** Do **not** reorder ahead of next PRR residual (dashboard summary API; after **#135** D01B **Done** `6e776232` / `1ada6b41` and **#104** D01A **Done** `f1f79d14`; **#103/#105** already **Done**). Do **not** treat #106 as sole-active. After dashboard residual (or explicit user redirect), activate **IBL-A1** (#107) or Wave A batch via delivery-orchestrator Batch Recommendation — still one leaf at a time.
...
**Next action:** After dashboard Wave D residual (**#135** D01B **Done** `6e776232` / `1ada6b41`; **#104** D01A **Done** `f1f79d14`; **#103/#105 Done**) — or on explicit user redirect — activate **IBL-A** via delivery-orchestrator (head **IBL-A1** / #107, or Wave A batch per Batch Recommendation). Do **not** mark any IBL wave In Progress while dashboard residual remains ahead. Do **not** invent a formal P-phase. Do **not** flip checklist **#3b GO**.
