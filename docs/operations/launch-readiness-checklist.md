...
| Blocking **NO-GO** items | **#3b** ADR-0042/0043+Word only (#5b paste↔binding → **GO** — merge `f1f00da`; #9 `JWT_SECRET` **GO** — merge `587cd9a`; #10 Kafka → **CONDITIONAL**; #5a AD Group → **CONDITIONAL** — not blocking NO-GOs) |
