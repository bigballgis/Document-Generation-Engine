...
| `GENERATION` | `VARIABLE_COMPUTE_FAILED` | `api.error.variable.computeFailed` | `false` | Whitelist compute expression evaluation failed (incl. invalid FORMAT_AMOUNT currency). |
