...
| [LibreOffice CI lane (optional skip vs mandatory + chaos)](libreoffice-ci-lane.md) | IBL-D2 / F21 **Done** (`21be3a99` / `4fd0c5da`) — optional skip vs `-Plibreoffice-ci`; IBL-D4 / F22 chaos **Done** (`94cc8eeb` / `94526674`) — `-Plo-pool-chaos` | Active baseline (2026-07-19) |
| [RTL / bidi spike (IBL-E7)](../plan/evidence/ibl-e7-rtl-bidi-spike/SPIKE-REPORT.md) | IBL-E7 / #134 / F15 spike — feasibility + LO/POI gaps; **DESCOPE** product RTL; [ADR-0068](../adr/rendering-authoring/0068-rtl-bidi-out-of-scope-until-market.md) **Accepted** (F15 closed by descope; leaf Done `37239d68` / `68abc7c3`) | Spike evidence (2026-07-20) |
| [k6 + NFR confirmation path](k6-nfr-confirmation-path.md) | IBL-D3 / F22 load half **Done** (`6b9b6487` / `0242084e`) — checked-in k6 suite + LR-D5 measured-input path (**no** invented confirmed SLOs); chaos closed by **IBL-D4** | Active baseline (2026-07-19) |
