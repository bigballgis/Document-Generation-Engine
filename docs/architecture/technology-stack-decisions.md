...
| Resilience and retry | Resilience4j — **implemented** (MinIO + PDF conversion; COR-P02 / OPT-F2) | ADR Accepted | ADR 0028, ADR 0037 | 2026-06-25 |
...
| Rate limiting | Bucket4j — **implemented** (process-local per credential; COR-B10 seam for multi-instance) | ADR Accepted | ADR 0034, ADR 0037 | 2026-06-25 |
