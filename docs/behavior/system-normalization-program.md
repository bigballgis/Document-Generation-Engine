...
| Field | Value |
| --- | --- |
| **文件状态** | Wave 0 charter **`ready`**（plan + ADR SoT）；Waves 1–8 实现 BDD = **stub / pending-wave** |
...
per_wave_impl_bdd: stubs / pending-wave (NOT ready for Waves 1–8 TDD Red)
open_questions:
...
| Per-wave runtime BDD (§8) | **Stub / pending-wave** | **Do not** invent ready Given/When/Then for Waves 1–8 here |
