 ...
 *
 * <p>LR-A4: also raised when an unsupported structured-content node type is
 * encountered — fail-closed instead of silently dropping content (CD-PIT-07).
 * CE-K06b/K06c added dedicated keys for {@code qrBarcodeRef} and
 * {@code attachmentListRef} payload failures.
 */
