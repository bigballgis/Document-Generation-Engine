-- Collection demo content modules — real foreign-bank-letter grade (v2)
BEGIN;
...
SELECT 'e2000001-0001-4000-8000-000000000001', cm.id, '2.0.0', 'APPROVED', 'ACTIVE',
       '{"blocks":[
       ...
       'Collection demo v2 real-bank import', '10000003', '10000007'
...
INSERT INTO content_module_version (id, module_id, semantic_version, review_state, lifecycle_state, content_structure_json, change_description, created_by, updated_by)
SELECT 'e2000001-0001-4000-8000-000000000002', cm.id, '2.0.0', 'APPROVED', 'ACTIVE',
       '{"blocks":[
