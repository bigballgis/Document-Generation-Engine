-- Wealth demo content modules — P23 bank-grade private wealth statement (v3)
BEGIN;

INSERT INTO content_module (id, module_code, group_code, name, description, shared_group_codes_json, created_by, updated_by)
SELECT '81000001-0001-4000-8000-000000000001', 'WEALTH-STATEMENT-STD', 'WEALTH', 'Wealth Statement Intro', 'Private wealth statement introductory clause and custody terms', '[]', '10000003', '10000003'
...
SELECT '82000001-0001-4000-8000-000000000003', cm.id, '3.0.0', 'APPROVED', 'ACTIVE',
       '{"blocks":[
...
INSERT INTO content_module (id, module_code, group_code, name, description, shared_group_codes_json, created_by, updated_by)
SELECT '81000001-0001-4000-8000-000000000002', 'WEALTH-REGULATORY-STD', 'WEALTH', 'Wealth Regulatory Notice', 'Private wealth regulatory disclaimer and tax notice', '[]', '10000003', '10000003'
WHERE NOT EXISTS (SELECT 1 FROM content_module WHERE module_code = 'WEALTH-REGULATORY-STD' AND deleted_at IS NULL);

INSERT INTO content_module_version (id, module_id, semantic_version, review_state, lifecycle_state, content_structure_json, change_description, created_by, updated_by)
SELECT '82000001-0001-4000-8000-000000000002', cm.id, '3.0.0', 'APPROVED', 'ACTIVE',
       '{"blocks":[
