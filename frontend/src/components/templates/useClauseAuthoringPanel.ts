...
export function useClauseAuthoringPanel(
  ...
  return {
    ...
    referenceKeyUserOverridden: referenceActions.referenceKeyUserOverridden,
    markReferenceKeyOverridden: referenceActions.markReferenceKeyOverridden,
    clearReferenceKeyOverride: referenceActions.clearReferenceKeyOverride,
