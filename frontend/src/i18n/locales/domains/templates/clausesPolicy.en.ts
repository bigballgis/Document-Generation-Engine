export const templatesClausesPolicyEn = {
  ...
  policy: {
      ...
      credentialRotationGraceEndsAt: 'Previous secret valid until',
      ...
      copyCredentialSecret: 'Copy secret',
      credentialSecretCopied: 'Secret copied.',
      credentialSecretCopyFailed: 'Unable to copy the secret.',
      ...
      confirmRotateMessage:
        'Rotating issues a new secret immediately. The previous secret remains usable for 28 days, then stops working. Continue?',
