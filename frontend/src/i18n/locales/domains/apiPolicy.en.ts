export const apiPolicyEn = {
    ...
    detail: {
      ...
      impact: {
        ...
        routeTargets: 'Default route targets',
        routeTargetChange: '{current} → {candidate}',
        routeTargetNone: 'none',
        rollbackTitle: 'Rollback to prior settings version',
        rollbackHint: 'Restore a previous policy version. Current version becomes the next snapshot.',
        rollbackVersion: 'Target version',
        rollbackAction: 'Rollback',
        rollbackSuccess: 'Access settings rolled back.',
