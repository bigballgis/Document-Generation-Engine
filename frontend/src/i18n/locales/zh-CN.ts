...
export default {
  ...
  templates: {
    ...
    policy: {
      ...
      recentInvocations: {
        ...
        comingSoonTitle: '调用摘要即将提供',
        comingSoonDescription: '管理端调用摘要将列出最近调用，不暴露变量明文。',
      },
  ...
  apiPolicy: {
    home: {
      ...
      alerts: {
        title: '待关注项',
        description: '跨包告警（如缺少 AD 组、接入账号即将过期）将在此展示。',
        comingSoonTitle: '聚合告警即将提供',
        comingSoonDescription: '包级监控将提示需要关注的模板，不再重复模板目录。',
      },
      packageLinks: {
        title: '已发布包',
