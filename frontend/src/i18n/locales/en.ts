...
export default {
  ...
  templates: {
    ...
    bindingGate: {
      ...
      issueMissingAnchor: '{count} missing anchor(s)',
    ...
    publishGate: {
      ...
      loadError: 'Unable to load publish gate checklist.',
    ...
    policy: {
      ...
      notConfiguredTitle: 'No API policy configured',
      notConfiguredDescription:
        'Runtime API access policy has not been configured for this template yet.',
    ...
    error: {
      ...
      loadPublishGate: 'Unable to load publish gate checklist.',
