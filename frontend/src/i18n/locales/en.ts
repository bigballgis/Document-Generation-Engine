...
export default {
  ...
  masters: {
    ...
    revisionLines: {
      ...
      addedAnchors: 'Added anchors:',
      removedAnchors: 'Removed anchors:',
      renamedAnchors: 'Renamed anchors:',
    },
    revision: {
      ...
      anchorOverviewHint:
        'Document-order anchor list with position highlight. Full DOCX rendering is not available here.',
    ...
    replaceFile: {
      ...
      confirmNoAnchorDelta: 'No anchor-set changes versus the previous revision.',
      confirmAdded: '{count} anchor(s) added',
      confirmRemoved: '{count} anchor(s) removed',
      confirmRenamed: '{count} anchor(s) renamed',
