...
export default {
  ...
  masters: {
    ...
    detail: {
      ...
      updatedAt: 'Last updated',
      revisionLinesTitle: 'Revision lines',
      revisionLinesHint:
  ...
  templates: {
    ...
    publishSummary: {
      ...
      bindingsReady: 'Anchor bindings passed validation.',
      bindingsPending: 'Anchor bindings still have blocking issues.',
      testCoverageNote: 'Test generation and coverage summaries are recorded in the audit trail.',
      changeDiffNote: 'Change difference details are available in lifecycle audit history.',
