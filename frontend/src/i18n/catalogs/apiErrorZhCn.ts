export const apiErrorZhCn = {
  ...
  template: {
    ...
    exportAssetBinaryMissing: "晋级导出失败：引用的资产二进制不可用。",
    ...
    dep: {
      ...
      masterWillMaterialize: "内嵌母版 DOCX 将物化为草稿母版（需在生产环境重新审批）。",
      ...
      assetWillMaterialize: "包内资产二进制将物化到资产库。",
      assetBinaryAbsent: "目标环境缺少该资产键，且包内未嵌入对应二进制。",
      clauseNestingOk: "目标环境已满足该条款嵌套边。",
      clauseNestingWillMaterialize: "该条款嵌套边将由物化条款快照覆盖。",
      clauseNestingMissing: "条款嵌套闭包不完整（缺少快照或目标模块）。",
