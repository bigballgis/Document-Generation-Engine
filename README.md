...
**Active phase:** **None** (P21 **Done** 2026-06-30 — role-journey frontend redesign & business-friendly terminology; T01–T11 + X01–X06 + X02; backend **553**, frontend **511** Vitest; **AUD-B10 partial** documented). Activate next phase via `plan-orchestrator`.
MVP P0–P11 complete;
