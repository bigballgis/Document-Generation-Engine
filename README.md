...
**Active formal phase:** **None** (2026-07-09+). **CORE-FORTRESS program Done** (F1–F8; 2026-07-09). **CODE-QUALITY Done** (2026-07-09). **P23 Done** (2026-07-08). **Delivery focus note (2026-07-10):** **Wave LR-A Done** (A1–A7; merge `cc9e5f6`); **LR-A5 Done** (**ADR-0041 Accepted**; 0042/0043 Proposed; Word/XSD/LO24 deferred) — see [docs/plan/detail/LRP-A-rendering-trust-hardening.md](docs/plan/detail/LRP-A-rendering-trust-hardening.md). CDP Wave CD-2 **In Progress** (**partial** — CD-E2E-T01/T01b **Done**; merge `1930842`). **In-flight programs (not formal phases):** **CDP** CD-2; **LRP** program remains In Progress (next open waves when scheduled — do not start LR-C9 for deferred residuals).
MVP P0–P11 complete;
